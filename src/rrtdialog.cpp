...
void RRTDialog::getTargetMove(std::vector<double> &target)
{
    target.clear();
...
void RRTDialog::setTargetMove(std::vector<double> &target)
{
...
void RRTDialog::getFinalArm(std::vector<double> &finalArm)
{
    finalArm.clear();
...
void RRTDialog::getFinalHand(std::vector<double> &finalHand)
{
    finalHand.clear();
...
void RRTDialog::setPlaneParameters(std::vector<double> &point1,std::vector<double> &point2,std::vector<double> &point3)
{
...
void RRTDialog::getPlaneParameters(std::vector<double> &params,
...
void RRTDialog::checkFinalPosture(int state)
{
    if(state==0){
        // unchecked
...
void RRTDialog::checkAddPlane(int state)
{
    if(state==0){
        //unchecked
...
bool RRTDialog::get_use_final_posture()
{
    return ui->checkBox_sel_final_posture->isChecked();
}

bool RRTDialog::get_add_plane()
{
