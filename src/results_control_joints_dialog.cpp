...
void ResultsCtrlJointsDialog::setDual(bool d)
{
    this->dual = d;
}

void ResultsCtrlJointsDialog::setRight(bool r)
{
    this->right = r;
}


void ResultsCtrlJointsDialog::setupPlots(vector<MatrixXd> &pos, vector<MatrixXd> &vel, vector<MatrixXd> &acc, vector<vector<double> > &timesteps)
{
...
void ResultsCtrlJointsDialog::setupPlots(vector<vector<MatrixXd> > &pos, vector<vector<MatrixXd> > &vel, vector<vector<MatrixXd> > &acc, vector<vector<vector<double> > > &timesteps)
{
