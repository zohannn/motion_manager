...
void ResultsCtrlJointsDialog::setupPlots(MatrixXd &positions, MatrixXd &velocities, vector<double> &max_limits, vector<double> &min_limits, vector<double> &time)
{
...
void ResultsCtrlJointsDialog::plotJoint(QCustomPlot *plot, QString title, QVector<double> &time, QVector<double> &pos, QVector<double> &vel, QVector<double> &max_pos, QVector<double> &min_pos)
{
    ...
    if(this->ui->checkBox_jlim->isChecked())
    {
        ...
        plot->addGraph(wideAxisRect->axis(QCPAxis::atBottom), wideAxisRect->axis(QCPAxis::atLeft));
        plot->graph(2)->setPen(QPen(Qt::darkGray));
        //plot->graph(2)->setName("[deg]");
        //plot->graph(2)->valueAxis()->setTickLabelColor(Qt::green);
        plot->graph(2)->keyAxis()->setLabel("time [s]");
        plot->graph(2)->setData(time, max_pos);
        plot->graph(2)->valueAxis()->setRange(*std::min_element(max_pos.begin(), max_pos.end()),
        ...
        plot->graph(3)->setData(time, min_pos);
        plot->graph(3)->valueAxis()->setRange(*std::min_element(min_pos.begin(), min_pos.end()),
...
void ResultsCtrlJointsDialog::on_pushButton_plot_clicked()
{
    ...
    QVector<double> pos_joint1, vel_joint1,max_limits_joint1,min_limits_joint1;
    QVector<double> pos_joint2, vel_joint2,max_limits_joint2,min_limits_joint2;
    QVector<double> pos_joint3, vel_joint3,max_limits_joint3,min_limits_joint3;
    QVector<double> pos_joint4, vel_joint4,max_limits_joint4,min_limits_joint4;
    QVector<double> pos_joint5, vel_joint5,max_limits_joint5,min_limits_joint5;
    QVector<double> pos_joint6, vel_joint6,max_limits_joint6,min_limits_joint6;
    QVector<double> pos_joint7, vel_joint7,max_limits_joint7,min_limits_joint7;
    QVector<double> pos_joint8, vel_joint8,max_limits_joint8,min_limits_joint8;
    QVector<double> pos_joint9, vel_joint9,max_limits_joint9,min_limits_joint9;
    QVector<double> pos_joint10, vel_joint10,max_limits_joint10,min_limits_joint10;
    QVector<double> pos_joint11, vel_joint11,max_limits_joint11,min_limits_joint11;
    ...
    plotJoint(ui->plot_joint_1,QString("Joint 1"),qtime,pos_joint1,vel_joint1,max_limits_joint1,min_limits_joint1); // plot joint 1
    plotJoint(ui->plot_joint_2,QString("Joint 2"),qtime,pos_joint2,vel_joint2,max_limits_joint2,min_limits_joint2); // plot joint 2
    plotJoint(ui->plot_joint_3,QString("Joint 3"),qtime,pos_joint3,vel_joint3,max_limits_joint3,min_limits_joint3); // plot joint 3
    plotJoint(ui->plot_joint_4,QString("Joint 4"),qtime,pos_joint4,vel_joint4,max_limits_joint4,min_limits_joint4); // plot joint 4
    plotJoint(ui->plot_joint_5,QString("Joint 5"),qtime,pos_joint5,vel_joint5,max_limits_joint5,min_limits_joint5); // plot joint 5
    plotJoint(ui->plot_joint_6,QString("Joint 6"),qtime,pos_joint6,vel_joint6,max_limits_joint6,min_limits_joint6); // plot joint 6
    plotJoint(ui->plot_joint_7,QString("Joint 7"),qtime,pos_joint7,vel_joint7,max_limits_joint7,min_limits_joint7); // plot joint 7
    plotJoint(ui->plot_joint_8,QString("Joint 8"),qtime,pos_joint8,vel_joint8,max_limits_joint8,min_limits_joint8); // plot joint 8
    plotJoint(ui->plot_joint_9,QString("Joint 9"),qtime,pos_joint9,vel_joint9,max_limits_joint9,min_limits_joint9); // plot joint 9
    plotJoint(ui->plot_joint_10,QString("Joint 10"),qtime,pos_joint10,vel_joint10,max_limits_joint10,min_limits_joint10); // plot joint 10
    plotJoint(ui->plot_joint_11,QString("Joint 11"),qtime,pos_joint11,vel_joint11,max_limits_joint11,min_limits_joint11); // plot joint 11
