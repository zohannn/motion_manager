...
void ResultsCtrlJointsDialog::on_pushButton_plot_clicked()
{
    ...
    pos_joint1.clear(); vel_joint1.clear(); acc_joint1.clear(); max_limits_joint1.clear(); min_limits_joint1.clear();
    pos_joint2.clear(); vel_joint2.clear(); acc_joint2.clear(); max_limits_joint2.clear(); min_limits_joint2.clear();
    pos_joint3.clear(); vel_joint3.clear(); acc_joint3.clear(); max_limits_joint3.clear(); min_limits_joint3.clear();
    pos_joint4.clear(); vel_joint4.clear(); acc_joint4.clear(); max_limits_joint4.clear(); min_limits_joint4.clear();
    pos_joint5.clear(); vel_joint5.clear(); acc_joint5.clear(); max_limits_joint5.clear(); min_limits_joint5.clear();
    pos_joint6.clear(); vel_joint6.clear(); acc_joint6.clear(); max_limits_joint6.clear(); min_limits_joint6.clear();
    pos_joint7.clear(); vel_joint7.clear(); acc_joint7.clear(); max_limits_joint7.clear(); min_limits_joint7.clear();
    pos_joint8.clear(); vel_joint8.clear(); acc_joint8.clear(); max_limits_joint8.clear(); min_limits_joint8.clear();
    pos_joint9.clear(); vel_joint9.clear(); acc_joint9.clear(); max_limits_joint9.clear(); min_limits_joint9.clear();
    pos_joint10.clear(); vel_joint10.clear(); acc_joint10.clear(); max_limits_joint10.clear(); min_limits_joint10.clear();
    pos_joint11.clear(); vel_joint11.clear(); acc_joint11.clear(); max_limits_joint11.clear(); min_limits_joint11.clear();
...
void ResultsCtrlJointsDialog::on_pushButton_save_joints_plots_clicked()
{
    ...
    if(!this->pos_joint1.empty()){
        ...
        joint_stream << string("# position [deg], velocity [deg/s], acceleration [deg/s^2], max limit [deg], min limit [deg], time [s] \n");
