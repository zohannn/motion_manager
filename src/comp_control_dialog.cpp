...
void CompControlDialog::setupPlots(vector<vector<double>> &positions,vector<vector<double>> &orientations,vector<vector<double>> &linear_velocity,vector<vector<double>> &angular_velocity,vector<double> &time, int mod)
{
    ...
    switch(mod){
    case 0: // shoulder
        plotComp(ui->plot_shoulder_x,QString("Shoulder linear component x"),qtime,linear_pos_x,linear_vel_x,true);
        plotComp(ui->plot_shoulder_y,QString("Shoulder linear component y"),qtime,linear_pos_y,linear_vel_y,true);
        plotComp(ui->plot_shoulder_z,QString("Shoulder linear component z"),qtime,linear_pos_z,linear_vel_z,true);
        plotComp(ui->plot_shoulder_wx,QString("Shoulder angular component x"),qtime,angular_pos_x,angular_vel_x,false);
        plotComp(ui->plot_shoulder_wy,QString("Shoulder angular component y"),qtime,angular_pos_y,angular_vel_y,false);
        plotComp(ui->plot_shoulder_wz,QString("Shoulder angular component z"),qtime,angular_pos_z,angular_vel_z,false);
        break;
    case 1:// elbow
        plotComp(ui->plot_elbow_x,QString("Elbow linear component x"),qtime,linear_pos_x,linear_vel_x,true);
        plotComp(ui->plot_elbow_y,QString("Elbow linear component y"),qtime,linear_pos_y,linear_vel_y,true);
        plotComp(ui->plot_elbow_z,QString("Elbow linear component z"),qtime,linear_pos_z,linear_vel_z,true);
        plotComp(ui->plot_elbow_wx,QString("Elbow angular component x"),qtime,angular_pos_x,angular_vel_x,false);
        plotComp(ui->plot_elbow_wy,QString("Elbow angular component y"),qtime,angular_pos_y,angular_vel_y,false);
        plotComp(ui->plot_elbow_wz,QString("Elbow angular component z"),qtime,angular_pos_z,angular_vel_z,false);
        break;
    case 2: // wrist
        plotComp(ui->plot_wrist_x,QString("Wrist linear component x"),qtime,linear_pos_x,linear_vel_x,true);
        plotComp(ui->plot_wrist_y,QString("Wrist linear component y"),qtime,linear_pos_y,linear_vel_y,true);
        plotComp(ui->plot_wrist_z,QString("Wrist linear component z"),qtime,linear_pos_z,linear_vel_z,true);
        plotComp(ui->plot_wrist_wx,QString("Wrist angular component x"),qtime,angular_pos_x,angular_vel_x,false);
        plotComp(ui->plot_wrist_wy,QString("Wrist angular component y"),qtime,angular_pos_y,angular_vel_y,false);
        plotComp(ui->plot_wrist_wz,QString("Wrist angular component z"),qtime,angular_pos_z,angular_vel_z,false);
        break;
    case 3: default: // hand
        plotComp(ui->plot_hand_x,QString("Hand linear component x"),qtime,linear_pos_x,linear_vel_x,true);
        plotComp(ui->plot_hand_y,QString("Hand linear component y"),qtime,linear_pos_y,linear_vel_y,true);
        plotComp(ui->plot_hand_z,QString("Hand linear component z"),qtime,linear_pos_z,linear_vel_z,true);
        plotComp(ui->plot_hand_wx,QString("Hand angular component x"),qtime,angular_pos_x,angular_vel_x,false);
        plotComp(ui->plot_hand_wy,QString("Hand angular component y"),qtime,angular_pos_y,angular_vel_y,false);
        plotComp(ui->plot_hand_wz,QString("Hand angular component z"),qtime,angular_pos_z,angular_vel_z,false);
        break;        
    }
}


void CompControlDialog::plotComp(QCustomPlot *plot, QString title, QVector<double> &time, QVector<double> &var_pos, QVector<double> &var_vel,bool lin)
{
    ...
    QString name_pos; QString name_vel;
    if(lin){
        name_pos="[mm]";
        name_vel="[mm/s]";
    }else{
