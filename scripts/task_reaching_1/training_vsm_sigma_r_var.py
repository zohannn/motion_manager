...
vsm_model_unfit = VSMModel(X=X, Y=Y,n_D=dim_cold,weights_init=w_init,r_init=r_init,reg_w=reg_w)
vsm_model_opt = VSMModel(X=X, Y=Y,n_D=dim_cold,weights_init=w_init_opt,r_init=r_init_opt,reg_w=reg_w,tol=tol)
