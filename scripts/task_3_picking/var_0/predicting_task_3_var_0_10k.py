...
cols_x_f_approach_tot = [col for col in task_1_dataframe if col.startswith('xf_approach')]
...
cols_x_f_retreat_tot = [col for col in task_1_dataframe if col.startswith('xf_retreat')]
