...
train_zf_L_approach = False
train_zf_L_approach_class = False
dir_path_zf_L_approach = models_dir + "/zf_L_approach"

print_en_zf_U_approach = False
train_zf_U_approach = False
...
train_xf_retreat = False
train_xf_retreat_class = False
dir_path_xf_retreat = models_dir + "/xf_retreat"

print_en_zf_L_retreat = False
train_zf_L_retreat = False
train_zf_L_retreat_class = False
dir_path_zf_L_retreat = models_dir + "/zf_L_retreat"

print_en_zf_U_retreat = False
train_zf_U_retreat = False
train_zf_U_retreat_class = False
dir_path_zf_U_retreat = models_dir + "/zf_U_retreat"

print_en_dual_f_retreat = False
train_dual_f_retreat = False
train_dual_f_retreat_class = False
...
periods_xf_approach_class = 20
steps_xf_approach_class = 1000
batch_size_xf_approach_class = 100
units_xf_approach_class = [10,10,10]
# SVM
n_cv_xf_approach = 20
kernel_class_xf_approach = 'rbf'
kernel_xf_approach = 'rbf'
gamma_xf_approach = 'auto'
degree_xf_approach = 3
coeff_xf_approach = 1.0
epsilon_xf_approach = 0.001
# KNN
n_neighbors_class_xf_approach = 15
weights_class_xf_approach = 'distance'
algorithm_class_xf_approach = 'auto'
n_neighbors_xf_approach = 15
weights_xf_approach = 'distance'
algorithm_xf_approach = 'auto'
...
periods_zf_L_approach_class = 20
steps_zf_L_approach_class = 1000
batch_size_zf_L_approach_class = 100
units_zf_L_approach_class = [10,10,10]
# SVM
n_cv_zf_L_approach = 20
kernel_class_zf_L_approach = 'rbf'
kernel_zf_L_approach = 'rbf'
gamma_zf_L_approach = 'auto'
degree_zf_L_approach = 3
coeff_zf_L_approach = 1.0
epsilon_zf_L_approach = 0.001
# KNN
n_neighbors_class_zf_L_approach = 15
weights_class_zf_L_approach = 'distance'
algorithm_class_zf_L_approach = 'auto'
n_neighbors_zf_L_approach = 15
weights_zf_L_approach = 'distance'
algorithm_zf_L_approach = 'auto'
...
periods_zf_U_approach_class = 20
steps_zf_U_approach_class = 1000
batch_size_zf_U_approach_class = 100
units_zf_U_approach_class = [10,10,10]
# SVM
n_cv_zf_U_approach = 20
kernel_class_zf_U_approach = 'rbf'
kernel_zf_U_approach = 'rbf'
gamma_zf_U_approach = 'auto'
degree_zf_U_approach = 3
coeff_zf_U_approach = 1.0
epsilon_zf_U_approach = 0.001
# KNN
n_neighbors_class_zf_U_approach = 15
weights_class_zf_U_approach = 'distance'
algorithm_class_zf_U_approach = 'auto'
n_neighbors_zf_U_approach = 15
weights_zf_U_approach = 'distance'
algorithm_zf_U_approach = 'auto'

n_clusters_dual_f_approach = 4
min_cluster_size_dual_f_approach = 10
th_dual_f_approach = 0.0001
# NN
periods_dual_f_approach = 10
steps_dual_f_approach = 1000
batch_size_dual_f_approach = 100
units_dual_f_approach = [10,10]
periods_dual_f_approach_class = 20
steps_dual_f_approach_class = 1000
batch_size_dual_f_approach_class = 100
units_dual_f_approach_class = [10,10,10]
# SVM
n_cv_dual_f_approach = 20
kernel_class_dual_f_approach = 'rbf'
kernel_dual_f_approach = 'rbf'
gamma_dual_f_approach = 'auto'
degree_dual_f_approach = 3
coeff_dual_f_approach = 1.0
epsilon_dual_f_approach = 0.001
# KNN
n_neighbors_class_dual_f_approach = 15
weights_class_dual_f_approach = 'distance'
algorithm_class_dual_f_approach = 'auto'
n_neighbors_dual_f_approach = 15
weights_dual_f_approach = 'distance'
algorithm_dual_f_approach = 'auto'
...
periods_xf_retreat_class = 20
steps_xf_retreat_class = 1000
batch_size_xf_retreat_class = 100
units_xf_retreat_class = [10,10,10]
# SVM
n_cv_xf_retreat = 20
kernel_class_xf_retreat = 'rbf'
kernel_xf_retreat = 'rbf'
gamma_xf_retreat = 'auto'
degree_xf_retreat = 3
coeff_xf_retreat = 1.0
epsilon_xf_retreat = 0.001
# KNN
n_neighbors_class_xf_retreat = 15
weights_class_xf_retreat = 'distance'
algorithm_class_xf_retreat = 'auto'
n_neighbors_xf_retreat = 15
weights_xf_retreat = 'distance'
algorithm_xf_retreat = 'auto'
...
periods_zf_L_retreat_class = 20
steps_zf_L_retreat_class = 1000
batch_size_zf_L_retreat_class = 100
units_zf_L_retreat_class = [10,10,10]
# SVM
n_cv_zf_L_retreat = 20
kernel_class_zf_L_retreat = 'rbf'
kernel_zf_L_retreat = 'rbf'
gamma_zf_L_retreat = 'auto'
degree_zf_L_retreat = 3
coeff_zf_L_retreat = 1.0
epsilon_zf_L_retreat = 0.001
# KNN
n_neighbors_class_zf_L_retreat = 15
weights_class_zf_L_retreat = 'distance'
algorithm_class_zf_L_retreat = 'auto'
n_neighbors_zf_L_retreat = 15
weights_zf_L_retreat = 'distance'
algorithm_zf_L_retreat = 'auto'
...
periods_zf_U_retreat_class = 20
steps_zf_U_retreat_class = 1000
batch_size_zf_U_retreat_class = 100
units_zf_U_retreat_class = [10,10,10]
# SVM
n_cv_zf_U_retreat = 20
kernel_class_zf_U_retreat = 'rbf'
kernel_zf_U_retreat = 'rbf'
gamma_zf_U_retreat = 'auto'
degree_zf_U_retreat = 3
coeff_zf_U_retreat = 1.0
epsilon_zf_U_retreat = 0.001
# KNN
n_neighbors_class_zf_U_retreat = 15
weights_class_zf_U_retreat = 'distance'
algorithm_class_zf_U_retreat = 'auto'
n_neighbors_zf_U_retreat = 15
weights_zf_U_retreat = 'distance'
algorithm_zf_U_retreat = 'auto'

n_clusters_dual_f_retreat = 4
min_cluster_size_dual_f_retreat = 10
th_dual_f_retreat = 0.0001
# NN
periods_dual_f_retreat = 10
steps_dual_f_retreat = 1000
batch_size_dual_f_retreat = 100
units_dual_f_retreat = [10,10]
periods_dual_f_retreat_class = 20
steps_dual_f_retreat_class = 1000
batch_size_dual_f_retreat_class = 100
units_dual_f_retreat_class = [10,10,10]
# SVM
n_cv_dual_f_retreat = 20
kernel_class_dual_f_retreat = 'rbf'
kernel_dual_f_retreat = 'rbf'
gamma_dual_f_retreat = 'auto'
degree_dual_f_retreat = 3
coeff_dual_f_retreat = 1.0
epsilon_dual_f_retreat = 0.001
# KNN
n_neighbors_class_dual_f_retreat = 15
weights_class_dual_f_retreat = 'distance'
algorithm_class_dual_f_retreat = 'auto'
n_neighbors_dual_f_retreat = 15
weights_dual_f_retreat = 'distance'
...
(inputs_dataframe,inputs_cols,null_features,id_null_cols) = preprocess_features(task_1_dataframe)
...
if not outputs_xf_approach_df.empty:
    # ------------------------- K-means clustering ---------------------------------------- #
    norm_outputs_xf_approach_df, outputs_xf_approach_df_max, outputs_xf_approach_df_min = normalize_linear_scale(outputs_xf_approach_df)

    if not os.path.exists(dir_path_xf_approach):
        os.mkdir(dir_path_xf_approach)
    outputs_xf_approach_df_max.to_csv(dir_path_xf_approach+"/xf_approach_max.csv",sep=',')
    outputs_xf_approach_df_min.to_csv(dir_path_xf_approach + "/xf_approach_min.csv", sep=',')

    xf_approach = norm_outputs_xf_approach_df.values

    kmeans = KMeans(n_clusters=n_clusters_xf_approach,init='k-means++',max_iter=100, n_init=5, verbose=0, random_state=3425)
    # Fitting with inputs
    kmeans_xf_approach = kmeans.fit(xf_approach)
    # Predicting the clusters
    labels_xf_approach = kmeans_xf_approach.predict(xf_approach)
    labels_xf_approach_df = pd.DataFrame(data=labels_xf_approach)

    # Getting the cluster centers
    C_xf_approach = kmeans_xf_approach.cluster_centers_
    if (print_en_xf_approach):
        fig = plt.figure()
        ax_xf_approach = Axes3D(fig)
        ax_xf_approach.scatter(xf_approach[:, 0], xf_approach[:, 1], xf_approach[:, 2], c=labels_xf_approach)
        #ax_xf_approach.scatter(C_xf_plan[:, 0], C_xf_plan[:, 1], C_xf_plan[:, 2], marker='*', c='#050505', s=1000)
        ax_xf_approach.set_xlabel('normalized xf_approach 1 [rad]')
        ax_xf_approach.set_ylabel('normalized xf_approach 2 [rad]')
        ax_xf_approach.set_zlabel('normalized xf_approach 3 [rad]')
        ax_xf_approach.set_title('Clusters of the xf_approach')
        plt.savefig(dir_path_xf_approach + "/clusters.pdf")
        plt.clf()
        #plt.show()

    cl_0_inputs_list_xf_approach = []
    cl_0_inputs_test_list_xf_approach = []
    cl_0_list_xf_approach = []
    cl_0_test_list_xf_approach = []

    cl_1_inputs_list_xf_approach = []
    cl_1_inputs_test_list_xf_approach = []
    cl_1_list_xf_approach = []
    cl_1_test_list_xf_approach = []

    cl_2_inputs_list_xf_approach = []
    cl_2_inputs_test_list_xf_approach = []
    cl_2_list_xf_approach = []
    cl_2_test_list_xf_approach = []

    cl_3_inputs_list_xf_approach = []
    cl_3_inputs_test_list_xf_approach = []
    cl_3_list_xf_approach = []
    cl_3_test_list_xf_approach = []

    cl_4_inputs_list_xf_approach = []
    cl_4_inputs_test_list_xf_approach = []
    cl_4_list_xf_approach = []
    cl_4_test_list_xf_approach = []

    cl_5_inputs_list_xf_approach = []
    cl_5_inputs_test_list_xf_approach = []
    cl_5_list_xf_approach = []
    cl_5_test_list_xf_approach = []

    for i in range(len(labels_xf_approach)):
        cl = labels_xf_approach[i]
        if cl == 0:
            cl_0_list_xf_approach.append(norm_outputs_xf_approach_df.iloc[i])
            cl_0_inputs_list_xf_approach.append(normalized_inputs.iloc[i])
        elif cl == 1:
            cl_1_list_xf_approach.append(norm_outputs_xf_approach_df.iloc[i])
            cl_1_inputs_list_xf_approach.append(normalized_inputs.iloc[i])
        elif cl == 2:
            cl_2_list_xf_approach.append(norm_outputs_xf_approach_df.iloc[i])
            cl_2_inputs_list_xf_approach.append(normalized_inputs.iloc[i])
        elif cl == 3:
            cl_3_list_xf_approach.append(norm_outputs_xf_approach_df.iloc[i])
            cl_3_inputs_list_xf_approach.append(normalized_inputs.iloc[i])
        elif cl == 4:
            cl_4_list_xf_approach.append(norm_outputs_xf_approach_df.iloc[i])
            cl_4_inputs_list_xf_approach.append(normalized_inputs.iloc[i])
        elif cl == 5:
            cl_5_list_xf_approach.append(norm_outputs_xf_approach_df.iloc[i])
            cl_5_inputs_list_xf_approach.append(normalized_inputs.iloc[i])

    cl_0_inputs_xf_approach_df = pd.DataFrame(cl_0_inputs_list_xf_approach, columns=inputs_cols)
    cl_0_xf_approach_df = pd.DataFrame(cl_0_list_xf_approach, columns=cols_x_f_approach)
    cl_1_inputs_xf_approach_df = pd.DataFrame(cl_1_inputs_list_xf_approach, columns=inputs_cols)
    cl_1_xf_approach_df = pd.DataFrame(cl_1_list_xf_approach, columns=cols_x_f_approach)
    cl_2_inputs_xf_approach_df = pd.DataFrame(cl_2_inputs_list_xf_approach, columns=inputs_cols)
    cl_2_xf_approach_df = pd.DataFrame(cl_2_list_xf_approach, columns=cols_x_f_approach)
    cl_3_inputs_xf_approach_df = pd.DataFrame(cl_3_inputs_list_xf_approach, columns=inputs_cols)
    cl_3_xf_approach_df = pd.DataFrame(cl_3_list_xf_approach, columns=cols_x_f_approach)
    cl_4_inputs_xf_approach_df = pd.DataFrame(cl_4_inputs_list_xf_approach, columns=inputs_cols)
    cl_4_xf_approach_df = pd.DataFrame(cl_4_list_xf_approach, columns=cols_x_f_approach)
    cl_5_inputs_xf_approach_df = pd.DataFrame(cl_5_inputs_list_xf_approach, columns=inputs_cols)
    cl_5_xf_approach_df = pd.DataFrame(cl_5_list_xf_approach, columns=cols_x_f_approach)

    clusters_inputs_xf_approach = [cl_0_inputs_xf_approach_df,cl_1_inputs_xf_approach_df,cl_2_inputs_xf_approach_df,cl_3_inputs_xf_approach_df,cl_4_inputs_xf_approach_df,cl_5_inputs_xf_approach_df]
    clusters_outputs_xf_approach = [cl_0_xf_approach_df,cl_1_xf_approach_df,cl_2_xf_approach_df,cl_3_xf_approach_df,cl_4_xf_approach_df,cl_5_xf_approach_df]

    # save the dataframes of each cluster
    # cluster 0
    if not os.path.exists(dir_path_xf_approach+"/cluster0"):
        os.mkdir(dir_path_xf_approach+"/cluster0")
    cl_0_inputs_xf_approach_df.to_csv(dir_path_xf_approach+"/cluster0/inputs.csv",sep=',',index=False)
    cl_0_xf_approach_df.to_csv(dir_path_xf_approach + "/cluster0/outputs.csv", sep=',',index=False)
    # cluster 1
    if not os.path.exists(dir_path_xf_approach+"/cluster1"):
        os.mkdir(dir_path_xf_approach+"/cluster1")
    cl_1_inputs_xf_approach_df.to_csv(dir_path_xf_approach+"/cluster1/inputs.csv",sep=',',index=False)
    cl_1_xf_approach_df.to_csv(dir_path_xf_approach + "/cluster1/outputs.csv", sep=',',index=False)
    # cluster 2
    if not os.path.exists(dir_path_xf_approach+"/cluster2"):
        os.mkdir(dir_path_xf_approach+"/cluster2")
    cl_2_inputs_xf_approach_df.to_csv(dir_path_xf_approach+"/cluster2/inputs.csv",sep=',',index=False)
    cl_2_xf_approach_df.to_csv(dir_path_xf_approach + "/cluster2/outputs.csv", sep=',',index=False)
    # cluster 3
    if not os.path.exists(dir_path_xf_approach+"/cluster3"):
        os.mkdir(dir_path_xf_approach+"/cluster3")
    cl_3_inputs_xf_approach_df.to_csv(dir_path_xf_approach+"/cluster3/inputs.csv",sep=',',index=False)
    cl_3_xf_approach_df.to_csv(dir_path_xf_approach + "/cluster3/outputs.csv", sep=',',index=False)
    # cluster 4
    if not os.path.exists(dir_path_xf_approach+"/cluster4"):
        os.mkdir(dir_path_xf_approach+"/cluster4")
    cl_4_inputs_xf_approach_df.to_csv(dir_path_xf_approach+"/cluster4/inputs.csv",sep=',',index=False)
    cl_4_xf_approach_df.to_csv(dir_path_xf_approach + "/cluster4/outputs.csv", sep=',',index=False)
    # cluster 5
    if not os.path.exists(dir_path_xf_approach+"/cluster5"):
        os.mkdir(dir_path_xf_approach+"/cluster5")
    cl_5_inputs_xf_approach_df.to_csv(dir_path_xf_approach+"/cluster5/inputs.csv",sep=',',index=False)
    cl_5_xf_approach_df.to_csv(dir_path_xf_approach + "/cluster5/outputs.csv", sep=',',index=False)

    if (print_en_xf_approach):
        print("Cluster 0:")
        print(cl_0_inputs_xf_approach_df.describe())
        print(cl_0_xf_approach_df.describe())
        print("Cluster 1:")
        print(cl_1_inputs_xf_approach_df.describe())
        print(cl_1_xf_approach_df.describe())
        print("Cluster 2:")
        print(cl_2_inputs_xf_approach_df.describe())
        print(cl_2_xf_approach_df.describe())
        print("Cluster 3:")
        print(cl_3_inputs_xf_approach_df.describe())
        print(cl_3_xf_approach_df.describe())
        print("Cluster 4:")
        print(cl_4_inputs_xf_approach_df.describe())
        print(cl_4_xf_approach_df.describe())
        print("Cluster 5:")
        print(cl_5_inputs_xf_approach_df.describe())
        print(cl_5_xf_approach_df.describe())

    # ---------------------------------- Classifier training ------------------------------------------------------------#
    if (train_xf_approach_class):

        if not os.path.exists(dir_path_xf_approach + "/classification"):
            os.mkdir(dir_path_xf_approach + "/classification")
        if not os.path.exists(dir_path_xf_approach + "/classification/nn"):
            os.mkdir(dir_path_xf_approach + "/classification/nn")
        if not os.path.exists(dir_path_xf_approach + "/classification/svm"):
            os.mkdir(dir_path_xf_approach + "/classification/svm")
        if not os.path.exists(dir_path_xf_approach + "/classification/knn"):
            os.mkdir(dir_path_xf_approach + "/classification/knn")
        ...
        # Choose the first 70% examples for training.
        training_examples_class = normalized_inputs.iloc[:train, :]
        training_targets_class = labels_xf_approach_df.iloc[:train, :]

        # Choose the last 20%  examples for validation.
        validation_examples_class = normalized_inputs.iloc[train:val, :]
        validation_targets_class = labels_xf_approach_df.iloc[train:val, :]

        # Choose the examples for test. 10%
        test_examples_class = normalized_inputs.iloc[val:, :]
        test_targets_class = labels_xf_approach_df.iloc[val:, :]
        ...
        (nn_classifier, training_log_losses, validation_log_losses) = train_nn_classifier_model(
                                        ...
                                        periods=periods_xf_approach_class,
                                        steps=steps_xf_approach_class,
                                        batch_size=batch_size_xf_approach_class,
        ...
        res_file = open(dir_path_xf_approach + "/classification/nn/results.txt", "a")
        res_file.write("LogLoss (on test data): %0.3f\n" % test_log_loss)
        res_file.write("Average loss on the test set: %0.3f\n" % evaluation_metrics['average_loss'])
        res_file.write("Accuracy on the test set: %0.3f\n" % evaluation_metrics['accuracy'])
        res_file.close()
        ...
        # ---------- Support Vector Machine ---------- #
        (svm_classifier, scores) = train_svm_classifier_model(kernel = kernel_class_xf_approach,
                                                          cv = n_cv_xf_approach,
                                                          training_examples_class_list = training_examples_class_list,
                                                          training_targets_class_list = training_targets_class_list,
                                                          model_dir = dir_path_xf_approach + "/classification/svm")


        test_targets_class_pred = svm_classifier.predict(test_examples_class_list)
        report = classification_report(test_targets_class_list, test_targets_class_pred)
        #print(report)
        classification_report_csv(report = report,model_dir = dir_path_xf_approach + "/classification/svm")
        acc_test = accuracy_score(test_targets_class_list, test_targets_class_pred, normalize=True, sample_weight=None)
        print("Accuracy on the test set: %0.3f " % acc_test)

        res_file = open(dir_path_xf_approach + "/classification/svm/results.txt", "a")
        res_file.write("Accuracy on the test set: %0.3f \n" % acc_test)
        res_file.close()

        # ---------- K-Nearest Neighbors ---------- #
        (knn_classifier, scores) = train_knn_classifier_model(n_neighbors = n_neighbors_class_xf_approach,
                                                          cv = n_cv_xf_approach,
                                                          weights = weights_class_xf_approach ,
                                                          algorithm = algorithm_class_xf_approach,
                                                          training_examples_class_list = training_examples_class_list,
                                                          training_targets_class_list = training_targets_class_list,
                                                          model_dir = dir_path_xf_approach + "/classification/knn")


        test_targets_class_pred = knn_classifier.predict(test_examples_class_list)
        report = classification_report(test_targets_class_list, test_targets_class_pred)
        #print(report)
        classification_report_csv(report = report,model_dir = dir_path_xf_approach + "/classification/knn")
        acc_test = accuracy_score(test_targets_class_list, test_targets_class_pred, normalize=True, sample_weight=None)
        print("Accuracy on the test set: %0.3f " % acc_test)

        res_file = open(dir_path_xf_approach + "/classification/knn/results.txt", "a")
        res_file.write("Accuracy on the test set: %0.3f \n" % acc_test)
        res_file.close()


    if (train_xf_approach):
        # ----------------------------------------------- PCA  and regression on each cluster --------------------------------------- #
        for i in range(0,n_clusters_xf_approach):
            cl_in_xf_approach_df = clusters_inputs_xf_approach[i]
            cl_out_xf_approach_df = clusters_outputs_xf_approach[i]
            if (len(cl_out_xf_approach_df.index) > min_cluster_size_xf_approach):
                n_comps = 7  # at least 95% of the information with 3 components
                X_f_approach = cl_out_xf_approach_df.values
                pca_xf_approach = decomposition.PCA(n_components=n_comps)
                pc = pca_xf_approach.fit_transform(X_f_approach)
                pc_df = pd.DataFrame(data=pc, columns=cols_x_f_approach[0:n_comps])
                if (print_en_xf_approach):
                    print(pca_xf_approach.n_components_)
                    print(pca_xf_approach.components_)
                    print(pc_df.describe())
                    print(pca_xf_approach.explained_variance_ratio_)
                    print(pca_xf_approach.explained_variance_ratio_.sum())
                    df = pd.DataFrame({'var': pca_xf_approach.explained_variance_ratio_, 'PC': cols_x_f_approach[0:n_comps]})

                    pc_file = open(dir_path_xf_approach+"/cluster"+repr(i)+"/p_comps.csv", "w")
                    pc_file.write("### Principal components ###\n")
                    pc_file.write(df.iloc[0, 0]+", ")
                    pc_file.write(df.iloc[1, 0] + ", ")
                    pc_file.write(df.iloc[2, 0] + ", ")
                    ...
                    sns_plot = sns.barplot(x='PC', y="var", data=df, color="c")
                    fig_pc = sns_plot.get_figure()
                    fig_pc.savefig(dir_path_xf_approach+"/cluster"+repr(i)+"/p_comps.pdf")
                    threedee_train = plt.figure().gca(projection='3d')
                    threedee_train.scatter(cl_in_xf_approach_df["target_x_mm"], cl_in_xf_approach_df["target_y_mm"], pc_df['xf_approach_1_rad'])
                    plt.clf()
                    #plt.show()

                # ---------------------------- regression --------------------------------- #
                size = len(cl_out_xf_approach_df.index)
                inputs_df, inputs_df_max, inputs_df_min = normalize_linear_scale(cl_in_xf_approach_df)
                outputs_df = pc_df

                if not os.path.exists(dir_path_xf_approach + "/cluster"+repr(i)):
                    os.mkdir(dir_path_xf_approach + "/cluster"+repr(i))
                if not os.path.exists(dir_path_xf_approach + "/cluster"+repr(i)+"/nn"):
                    os.mkdir(dir_path_xf_approach + "/cluster"+repr(i)+"/nn")
                if not os.path.exists(dir_path_xf_approach + "/cluster"+repr(i)+"/svm"):
                    os.mkdir(dir_path_xf_approach + "/cluster"+repr(i)+"/svm")
                if not os.path.exists(dir_path_xf_approach + "/cluster"+repr(i)+"/knn"):
                    os.mkdir(dir_path_xf_approach + "/cluster"+repr(i)+"/knn")
                ...
                test_examples = inputs_df.iloc[val:, :]
                # test_targets = outputs_df_0.iloc[val:, tar:tar_end]
                test_targets = cl_out_xf_approach_df.iloc[val:, :]
                ...
                for j in range(0, dim):
                    if (math.sqrt(math.pow((training_targets.iloc[0:, j].quantile(0.25) - training_targets.iloc[0:, j].quantile(0.75)),2)) <= th_xf_approach):
                        if (test_predictions_1.size == 0):
                            test_predictions_1 = np.full((test_targets.shape[0], 1),training_targets.iloc[0:, j].mean())
                        else:
                            test_predictions_1 = np.concatenate([test_predictions_1, np.full((test_targets.shape[0], 1),training_targets.iloc[0:,j].mean())], axis=1)
                ...
                if (ldim != 0):
                    ...
                    nn_regressor, training_rmses, validation_rmses = train_nn_regressor_model(
                                                                        my_optimizer=tf.train.AdamOptimizer(learning_rate=learning_rate),
                                                                        dimensions=ldim,
                                                                        periods=periods_xf_approach,
                                                                        steps=steps_xf_approach,
                                                                        batch_size=batch_size_xf_approach,
                                                                        hidden_units=units_xf_approach,
                                                                        training_examples=training_examples,
                                                                        training_targets=training_targets[train_col_names_1],
                                                                        validation_examples=validation_examples,
                                                                        validation_targets=validation_targets[train_col_names_1],
                                                                        model_dir=dir_path_xf_approach+"/cluster"+repr(i)+"/nn")
                ...
                denorm_test_targets = denormalize_linear_scale(test_targets, outputs_xf_approach_df_max, outputs_xf_approach_df_min)
                ...
                res_file = open(dir_path_xf_approach+"/cluster"+repr(i)+"/nn/results.txt", "a")
                res_file.write("RMSE (on test data):   %0.3f\n" % test_root_mean_squared_error_proj)
                res_file.write("R^2 score (on projected test data): %0.3f\n" % r2score)
                res_file.close()
                ...
                fig = plt.figure()
                ax1 = fig.add_subplot(111)
                ax1.scatter(denorm_test_targets["xf_approach_1_rad"], denorm_test_targets["xf_approach_2_rad"], s=10, c='b', marker="s", label='test_targets')
                ax1.scatter(denorm_test_predictions_df["xf_approach_1_rad"], denorm_test_predictions_df["xf_approach_2_rad"], s=10, c='r', marker="o", label='test_predictions')
                plt.xlabel("xf_approach_1_rad")
                plt.ylabel("xf_approach_2_rad")
                plt.legend(loc='upper right')
                plt.savefig(dir_path_xf_approach+"/cluster"+repr(i)+"/nn/xf_pred.pdf")
                plt.clf()
                #plt.show()
                ...
                if(ldim!=0):
                    # ---------- Support Vector Machine ---------------- #
                    (svm_regressor, r2) = train_svm_regressor_model(kernel=kernel_xf_approach,
                                                                gamma=gamma_xf_approach,
                                                                coeff=coeff_xf_approach,
                                                                degree=degree_xf_approach,
                                                                epsilon=epsilon_xf_approach,
                                                                training_examples=training_examples,
                                                                training_targets=training_targets.iloc[:,0:ldim],
                                                                model_dir=dir_path_xf_approach + "/cluster"+repr(i)+"/svm")
                ...
                res_file = open(dir_path_xf_approach + "/cluster"+repr(i)+"/svm/results.txt", "a")
                res_file.write("Final RMSE (on projected test data): %0.3f\n" % test_root_mean_squared_error_proj)
                res_file.write("R^2 score (on projected test data): %0.3f\n" % r2score)
                res_file.close()
                ...
                plt.ylabel("xf_approach_2_rad")
                plt.legend(loc='upper right')
                plt.savefig(dir_path_xf_approach+"/cluster"+repr(i)+"/svm/xf_pred.pdf")
                plt.clf()
                #plt.show()
                ...
                if(ldim!=0):
                    # ---------- K-Nearest Neighbors ---------------- #
                    (knn_regressor, r2) = train_knn_regressor_model(n_neighbors = n_neighbors_xf_approach,
                                                                weights = weights_xf_approach,
                                                                algorithm = algorithm_xf_approach,
                                                                training_examples=training_examples,
                                                                training_targets=training_targets.iloc[:,0:ldim],
                                                                model_dir=dir_path_xf_approach + "/cluster"+repr(i)+"/knn")
                ...
                res_file = open(dir_path_xf_approach + "/cluster"+repr(i)+"/knn/results.txt", "a")
                res_file.write("Final RMSE (on projected test data): %0.3f\n" % test_root_mean_squared_error_proj)
                res_file.write("R^2 score (on projected test data): %0.3f\n" % r2score)
                res_file.close()
                ...
                plt.ylabel("xf_approach_2_rad")
                plt.legend(loc='upper right')
                plt.savefig(dir_path_xf_approach+"/cluster"+repr(i)+"/knn/xf_pred.pdf")
                plt.clf()
                #plt.show()
...
if not outputs_zf_L_approach_df.empty:
    # ------------------------- K-means clustering ---------------------------------------- #
    norm_outputs_zf_L_approach_df, outputs_zf_L_approach_df_max, outputs_zf_L_approach_df_min = normalize_linear_scale(outputs_zf_L_approach_df)

    if not os.path.exists(dir_path_zf_L_approach):
        os.mkdir(dir_path_zf_L_approach)
    outputs_zf_L_approach_df_max.to_csv(dir_path_zf_L_approach+"/zf_L_approach_max.csv",sep=',')
    outputs_zf_L_approach_df_min.to_csv(dir_path_zf_L_approach +"/zf_L_approach_min.csv",sep=',')

    zf_L_approach = norm_outputs_zf_L_approach_df.values

    kmeans = KMeans(n_clusters=n_clusters_zf_L_approach, init='k-means++', max_iter=100, n_init=5, verbose=0, random_state=3425)
    # Fitting with inputs
    kmeans_zf_L_approach = kmeans.fit(zf_L_approach)
    # Predicting the clusters
    labels_zf_L_approach = kmeans_zf_L_approach.predict(zf_L_approach)
    labels_zf_L_approach_df = pd.DataFrame(data=labels_zf_L_approach)

    # Getting the cluster centers
    C_zf_L_approach = kmeans_zf_L_approach.cluster_centers_
    if (print_en_zf_L_approach):
        fig = plt.figure()
        ax_zf_L_approach = fig.add_subplot(111)
        ax_zf_L_approach.scatter(normalized_inputs["target_x_mm"],zf_L_approach, s=10, c=labels_zf_L_approach, marker="s")
        ax_zf_L_approach.set_xlabel("target_x_mm")
        ax_zf_L_approach.set_ylabel("zf_L_approach_4")
        plt.savefig(dir_path_zf_L_approach + "/clusters.pdf")
        plt.clf()
        #plt.show()

    cl_0_inputs_list_zf_L_approach = []
    cl_0_inputs_test_list_zf_L_approach = []
    cl_0_list_zf_L_approach = []
    cl_0_test_list_zf_L_approach = []

    cl_1_inputs_list_zf_L_approach = []
    cl_1_inputs_test_list_zf_L_approach = []
    cl_1_list_zf_L_approach = []
    cl_1_test_list_zf_L_approach = []

    cl_2_inputs_list_zf_L_approach = []
    cl_2_inputs_test_list_zf_L_approach = []
    cl_2_list_zf_L_approach = []
    cl_2_test_list_zf_L_approach = []

    cl_3_inputs_list_zf_L_approach = []
    cl_3_inputs_test_list_zf_L_approach = []
    cl_3_list_zf_L_approach = []
    cl_3_test_list_zf_L_approach = []

    cl_4_inputs_list_zf_L_approach = []
    cl_4_inputs_test_list_zf_L_approach = []
    cl_4_list_zf_L_approach = []
    cl_4_test_list_zf_L_approach = []

    cl_5_inputs_list_zf_L_approach = []
    cl_5_inputs_test_list_zf_L_approach = []
    cl_5_list_zf_L_approach = []
    cl_5_test_list_zf_L_approach = []

    for i in range(len(labels_zf_L_approach)):
        cl = labels_zf_L_approach[i]
        if cl == 0:
            cl_0_list_zf_L_approach.append(norm_outputs_zf_L_approach_df.iloc[i])
            cl_0_inputs_list_zf_L_approach.append(normalized_inputs.iloc[i])
        elif cl == 1:
            cl_1_list_zf_L_approach.append(norm_outputs_zf_L_approach_df.iloc[i])
            cl_1_inputs_list_zf_L_approach.append(normalized_inputs.iloc[i])
        elif cl == 2:
            cl_2_list_zf_L_approach.append(norm_outputs_zf_L_approach_df.iloc[i])
            cl_2_inputs_list_zf_L_approach.append(normalized_inputs.iloc[i])
        elif cl == 3:
            cl_3_list_zf_L_approach.append(norm_outputs_zf_L_approach_df.iloc[i])
            cl_3_inputs_list_zf_L_approach.append(normalized_inputs.iloc[i])
        elif cl == 4:
            cl_4_list_zf_L_approach.append(norm_outputs_zf_L_approach_df.iloc[i])
            cl_4_inputs_list_zf_L_approach.append(normalized_inputs.iloc[i])
        elif cl == 5:
            cl_5_list_zf_L_approach.append(norm_outputs_zf_L_approach_df.iloc[i])
            cl_5_inputs_list_zf_L_approach.append(normalized_inputs.iloc[i])

    cl_0_inputs_zf_L_approach_df = pd.DataFrame(cl_0_inputs_list_zf_L_approach, columns=inputs_cols)
    cl_0_zf_L_approach_df = pd.DataFrame(cl_0_list_zf_L_approach, columns=cols_zf_L_approach)
    cl_1_inputs_zf_L_approach_df = pd.DataFrame(cl_1_inputs_list_zf_L_approach, columns=inputs_cols)
    cl_1_zf_L_approach_df = pd.DataFrame(cl_1_list_zf_L_approach, columns=cols_zf_L_approach)
    cl_2_inputs_zf_L_approach_df = pd.DataFrame(cl_2_inputs_list_zf_L_approach, columns=inputs_cols)
    cl_2_zf_L_approach_df = pd.DataFrame(cl_2_list_zf_L_approach, columns=cols_zf_L_approach)
    cl_3_inputs_zf_L_approach_df = pd.DataFrame(cl_3_inputs_list_zf_L_approach, columns=inputs_cols)
    cl_3_zf_L_approach_df = pd.DataFrame(cl_3_list_zf_L_approach, columns=cols_zf_L_approach)
    cl_4_inputs_zf_L_approach_df = pd.DataFrame(cl_4_inputs_list_zf_L_approach, columns=inputs_cols)
    cl_4_zf_L_approach_df = pd.DataFrame(cl_4_list_zf_L_approach, columns=cols_zf_L_approach)
    cl_5_inputs_zf_L_approach_df = pd.DataFrame(cl_5_inputs_list_zf_L_approach, columns=inputs_cols)
    cl_5_zf_L_approach_df = pd.DataFrame(cl_5_list_zf_L_approach, columns=cols_zf_L_approach)

    clusters_inputs_zf_L_approach = [cl_0_inputs_zf_L_approach_df,cl_1_inputs_zf_L_approach_df,cl_2_inputs_zf_L_approach_df,cl_3_inputs_zf_L_approach_df,cl_4_inputs_zf_L_approach_df,cl_5_inputs_zf_L_approach_df]
    clusters_outputs_zf_L_approach = [cl_0_zf_L_approach_df,cl_1_zf_L_approach_df,cl_2_zf_L_approach_df,cl_3_zf_L_approach_df,cl_4_zf_L_approach_df,cl_5_zf_L_approach_df]

    # save the dataframes of each cluster
    # cluster 0
    if not os.path.exists(dir_path_zf_L_approach + "/cluster0"):
        os.mkdir(dir_path_zf_L_approach + "/cluster0")
    cl_0_inputs_zf_L_approach_df.to_csv(dir_path_zf_L_approach + "/cluster0/inputs.csv", sep=',', index=False)
    cl_0_zf_L_approach_df.to_csv(dir_path_zf_L_approach + "/cluster0/outputs.csv", sep=',', index=False)
    # cluster 1
    if not os.path.exists(dir_path_zf_L_approach + "/cluster1"):
        os.mkdir(dir_path_zf_L_approach + "/cluster1")
    cl_1_inputs_zf_L_approach_df.to_csv(dir_path_zf_L_approach + "/cluster1/inputs.csv", sep=',', index=False)
    cl_1_zf_L_approach_df.to_csv(dir_path_zf_L_approach + "/cluster1/outputs.csv", sep=',', index=False)
    # cluster 2
    if not os.path.exists(dir_path_zf_L_approach + "/cluster2"):
        os.mkdir(dir_path_zf_L_approach + "/cluster2")
    cl_2_inputs_zf_L_approach_df.to_csv(dir_path_zf_L_approach + "/cluster2/inputs.csv", sep=',', index=False)
    cl_2_zf_L_approach_df.to_csv(dir_path_zf_L_approach + "/cluster2/outputs.csv", sep=',', index=False)
    # cluster 3
    if not os.path.exists(dir_path_zf_L_approach + "/cluster3"):
        os.mkdir(dir_path_zf_L_approach + "/cluster3")
    cl_3_inputs_zf_L_approach_df.to_csv(dir_path_zf_L_approach + "/cluster3/inputs.csv", sep=',', index=False)
    cl_3_zf_L_approach_df.to_csv(dir_path_zf_L_approach + "/cluster3/outputs.csv", sep=',', index=False)
    # cluster 4
    if not os.path.exists(dir_path_zf_L_approach + "/cluster4"):
        os.mkdir(dir_path_zf_L_approach + "/cluster4")
    cl_4_inputs_zf_L_approach_df.to_csv(dir_path_zf_L_approach + "/cluster4/inputs.csv", sep=',', index=False)
    cl_4_zf_L_approach_df.to_csv(dir_path_zf_L_approach + "/cluster4/outputs.csv", sep=',', index=False)
    # cluster 5
    if not os.path.exists(dir_path_zf_L_approach + "/cluster5"):
        os.mkdir(dir_path_zf_L_approach + "/cluster5")
    cl_5_inputs_zf_L_approach_df.to_csv(dir_path_zf_L_approach + "/cluster5/inputs.csv", sep=',', index=False)
    cl_5_zf_L_approach_df.to_csv(dir_path_zf_L_approach + "/cluster5/outputs.csv", sep=',', index=False)

    if (print_en_zf_L_approach):
        print("Cluster 0:")
        print(cl_0_inputs_zf_L_approach_df.describe())
        print(cl_0_zf_L_approach_df.describe())
        print("Cluster 1:")
        print(cl_1_inputs_zf_L_approach_df.describe())
        print(cl_1_zf_L_approach_df.describe())
        print("Cluster 2:")
        print(cl_2_inputs_zf_L_approach_df.describe())
        print(cl_2_zf_L_approach_df.describe())
        print("Cluster 3:")
        print(cl_3_inputs_zf_L_approach_df.describe())
        print(cl_3_zf_L_approach_df.describe())
        print("Cluster 4:")
        print(cl_4_inputs_zf_L_approach_df.describe())
        print(cl_4_zf_L_approach_df.describe())
        print("Cluster 5:")
        print(cl_5_inputs_zf_L_approach_df.describe())
        print(cl_5_zf_L_approach_df.describe())

    # ---------------------------------- Classifier training ------------------------------------------------------------#
    if (train_zf_L_approach_class):

        if not os.path.exists(dir_path_zf_L_approach + "/classification"):
            os.mkdir(dir_path_zf_L_approach + "/classification")
        if not os.path.exists(dir_path_zf_L_approach + "/classification/nn"):
            os.mkdir(dir_path_zf_L_approach + "/classification/nn")
        if not os.path.exists(dir_path_zf_L_approach + "/classification/svm"):
            os.mkdir(dir_path_zf_L_approach + "/classification/svm")
        if not os.path.exists(dir_path_zf_L_approach + "/classification/knn"):
            os.mkdir(dir_path_zf_L_approach + "/classification/knn")
        ...
        # Choose the first 70% examples for training.
        training_examples_class = normalized_inputs.iloc[:train, :]
        training_targets_class = labels_zf_L_approach_df.iloc[:train, :]

        # Choose the last 20%  examples for validation.
        validation_examples_class = normalized_inputs.iloc[train:val, :]
        validation_targets_class = labels_zf_L_approach_df.iloc[train:val, :]

        # Choose the examples for test. 10%
        test_examples_class = normalized_inputs.iloc[val:, :]
        test_targets_class = labels_zf_L_approach_df.iloc[val:, :]
        ...
        (nn_classifier, training_log_losses, validation_log_losses) = train_nn_classifier_model(
                                        ...
                                        periods=periods_zf_L_approach_class,
                                        steps=steps_zf_L_approach_class,
                                        batch_size=batch_size_zf_L_approach_class,
        ...
        res_file = open(dir_path_zf_L_approach + "/classification/nn/results.txt", "a")
        res_file.write("LogLoss (on test data): %0.3f\n" % test_log_loss)
        res_file.write("Average loss on the test set: %0.3f\n" % evaluation_metrics['average_loss'])
        res_file.write("Accuracy on the test set: %0.3f\n" % evaluation_metrics['accuracy'])
        res_file.close()
        ...
        # ---------- Support Vector Machine ---------- #
        (svm_classifier, scores) = train_svm_classifier_model(kernel = kernel_class_zf_L_approach,
                                                              cv = n_cv_zf_L_approach,
                                                              training_examples_class_list = training_examples_class_list,
                                                              training_targets_class_list = training_targets_class_list,
                                                              model_dir = dir_path_zf_L_approach + "/classification/svm")


        test_targets_class_pred = svm_classifier.predict(test_examples_class_list)
        report = classification_report(test_targets_class_list, test_targets_class_pred)
        #print(report)
        classification_report_csv(report = report,model_dir = dir_path_zf_L_approach + "/classification/svm")
        acc_test = accuracy_score(test_targets_class_list, test_targets_class_pred, normalize=True, sample_weight=None)
        print("Accuracy on the test set: %0.3f " % acc_test)

        res_file = open(dir_path_zf_L_approach + "/classification/svm/results.txt", "a")
        res_file.write("Accuracy on the test set: %0.3f \n" % acc_test)
        res_file.close()

        # ---------- K-Nearest Neighbors ---------- #
        (knn_classifier, scores) = train_knn_classifier_model(n_neighbors = n_neighbors_class_zf_L_approach,
                                                              cv = n_cv_zf_L_approach,
                                                              weights = weights_class_zf_L_approach ,
                                                              algorithm = algorithm_class_zf_L_approach,
                                                              training_examples_class_list = training_examples_class_list,
                                                              training_targets_class_list = training_targets_class_list,
                                                              model_dir = dir_path_zf_L_approach + "/classification/knn")


        test_targets_class_pred = knn_classifier.predict(test_examples_class_list)
        report = classification_report(test_targets_class_list, test_targets_class_pred)
        #print(report)
        classification_report_csv(report = report,model_dir = dir_path_zf_L_approach + "/classification/knn")
        acc_test = accuracy_score(test_targets_class_list, test_targets_class_pred, normalize=True, sample_weight=None)
        print("Accuracy on the test set: %0.3f " % acc_test)

        res_file = open(dir_path_zf_L_approach + "/classification/knn/results.txt", "a")
        res_file.write("Accuracy on the test set: %0.3f \n" % acc_test)
        res_file.close()

    if (train_zf_L_approach):
        # ----------------------------------------------- PCA  and regression on each cluster --------------------------------------- #
        for i in range(0,n_clusters_zf_L_approach):
            cl_in_zf_L_approach_df = clusters_inputs_zf_L_approach[i]
            cl_out_zf_L_approach_df = clusters_outputs_zf_L_approach[i]
            if (len(cl_out_zf_L_approach_df.index) > min_cluster_size_zf_L_approach):
                if (len(cl_out_zf_L_approach_df.columns) > 4):
                    n_comps = 4  # at least 95% of the information with 3 components
                    Z_f_L_approach = cl_out_zf_L_approach_df.values
                    pca_zf_L_approach = decomposition.PCA(n_components=n_comps)
                    pc = pca_zf_L_approach.fit_transform(Z_f_L_approach)
                    pc_df = pd.DataFrame(data=pc, columns=cols_zf_L_approach[0:n_comps])
                    if (print_en_zf_L_approach):
                        print(pca_zf_L_approach.n_components_)
                        print(pca_zf_L_approach.components_)
                        print(pc_df.describe())
                        print(pca_zf_L_approach.explained_variance_ratio_)
                        print(pca_zf_L_approach.explained_variance_ratio_.sum())
                        df = pd.DataFrame({'var': pca_zf_L_approach.explained_variance_ratio_, 'PC': cols_zf_L_approach[0:n_comps]})

                        pc_file = open(dir_path_zf_L_approach+"/cluster"+repr(i)+"/p_comps.csv", "w")
                        pc_file.write("### Principal components ###\n")
                        pc_file.write(df.iloc[0, 0]+", ")
                        pc_file.write(df.iloc[1, 0] + ", ")
                        pc_file.write(df.iloc[2, 0] + ", ")
                        ...
                        sns_plot = sns.barplot(x='PC', y="var", data=df, color="c")
                        fig_pc = sns_plot.get_figure()
                        fig_pc.savefig(dir_path_zf_L_approach+"/cluster"+repr(i)+"/p_comps.pdf")
                        threedee_train = plt.figure().gca(projection='3d')
                        threedee_train.scatter(cl_in_zf_L_approach_df["target_x_mm"], cl_in_zf_L_approach_df["target_y_mm"], pc_df['zf_L_approach_2'])
                        plt.clf()
                        #plt.show()
                else:
                    pc_df = cl_out_zf_L_approach_df
                    n_comps = len(cl_out_zf_L_approach_df.columns)

                # ---------------------------- regression --------------------------------- #
                size = len(cl_out_zf_L_approach_df.index)
                inputs_df, inputs_df_max, inputs_df_min = normalize_linear_scale(cl_in_zf_L_approach_df)
                outputs_df = pc_df

                if not os.path.exists(dir_path_zf_L_approach + "/cluster"+repr(i)):
                    os.mkdir(dir_path_zf_L_approach + "/cluster"+repr(i))
                if not os.path.exists(dir_path_zf_L_approach + "/cluster"+repr(i)+"/nn"):
                    os.mkdir(dir_path_zf_L_approach + "/cluster"+repr(i)+"/nn")
                if not os.path.exists(dir_path_zf_L_approach + "/cluster"+repr(i)+"/svm"):
                    os.mkdir(dir_path_zf_L_approach + "/cluster"+repr(i)+"/svm")
                if not os.path.exists(dir_path_zf_L_approach + "/cluster"+repr(i)+"/knn"):
                    os.mkdir(dir_path_zf_L_approach + "/cluster"+repr(i)+"/knn")
                ...
                test_examples = inputs_df.iloc[val:, :]
                # test_targets = outputs_df_0.iloc[val:, tar:tar_end]
                test_targets = cl_out_zf_L_approach_df.iloc[val:, :]
                ...
                for j in range(0, dim):
                    if (math.sqrt(math.pow((training_targets.iloc[0:, j].quantile(0.25) - training_targets.iloc[0:, j].quantile(0.75)),2)) <= th_zf_L_approach):
                        if (test_predictions_1.size == 0):
                            test_predictions_1 = np.full((test_targets.shape[0], 1),training_targets.iloc[0:, j].mean())
                        else:
                            test_predictions_1 = np.concatenate([test_predictions_1, np.full((test_targets.shape[0], 1),training_targets.iloc[0:,j].mean())], axis=1)
                ...
                if (ldim != 0):
                    ...
                    nn_regressor, training_rmses, validation_rmses = train_nn_regressor_model(
                                            my_optimizer=tf.train.AdamOptimizer(learning_rate=learning_rate),
                                            dimensions=ldim,
                                            periods=periods_zf_L_approach,
                                            steps=steps_zf_L_approach,
                                            batch_size=batch_size_zf_L_approach,
                                            hidden_units=units_zf_L_approach,
                                            training_examples=training_examples,
                                            training_targets=training_targets[train_col_names_1],
                                            validation_examples=validation_examples,
                                            validation_targets=validation_targets[train_col_names_1],
                                            model_dir=dir_path_zf_L_approach+"/cluster"+repr(i)+"/nn")
                ...
                if (len(cl_out_zf_L_approach_df.columns) > 4):
                    # test_predictions_df = denormalize_linear_scale(test_predictions_df, outputs_df_0_max,outputs_df_0_min)
                    test_predictions = test_predictions_df.values
                    test_predictions_proj = pca_zf_L_approach.inverse_transform(test_predictions)
                    test_proj_df = pd.DataFrame(data=test_predictions_proj, columns=cols_zf_L_approach)
                    denorm_test_predictions_df = denormalize_linear_scale(test_proj_df, outputs_zf_L_approach_df_max, outputs_zf_L_approach_df_min)
                else:
                ...
                denorm_test_targets = denormalize_linear_scale(test_targets, outputs_zf_L_approach_df_max, outputs_zf_L_approach_df_min)
                test_root_mean_squared_error_proj = math.sqrt(metrics.mean_squared_error(denorm_test_predictions_df, denorm_test_targets))
                print("Cluster "+repr(i)+". Final RMSE (on projected test data): %0.3f" % test_root_mean_squared_error_proj)
                r2score = r2_score(denorm_test_targets, denorm_test_predictions_df)
                print("Cluster " + repr(i) + ". R^2 score (on projected test data): %0.3f" % r2score)

                res_file = open(dir_path_zf_L_approach+"/cluster"+repr(i)+"/nn/results.txt", "a")
                res_file.write("Final RMSE (on test data):   %0.3f\n" % test_root_mean_squared_error_proj)
                res_file.write("R^2 score (on projected test data): %0.3f\n" % r2score)
                res_file.close()
                ...
                fig = plt.figure()
                ax1 = fig.add_subplot(111)
                ax1.scatter(test_examples["target_x_mm"], denorm_test_targets["zf_L_approach_2"], s=10, c='b', marker="s",label='test_targets')
                ax1.scatter(test_examples["target_x_mm"], denorm_test_predictions_df["zf_L_approach_2"], s=10, c='r', marker="o", label='test_predictions')
                plt.xlabel("normalized target_x [mm]")
                plt.ylabel("zf_L_approach_2")
                plt.legend(loc='upper right')
                #plt.title()
                plt.savefig(dir_path_zf_L_approach+"/cluster"+repr(i)+"/nn/zf_L_pred.pdf")
                plt.clf()
                #plt.show()
                ...
                if(ldim!=0):
                    # ---------- Support Vector Machine ---------------- #
                    (svm_regressor, r2) = train_svm_regressor_model(kernel=kernel_zf_L_approach,
                                                                gamma=gamma_zf_L_approach,
                                                                coeff=coeff_zf_L_approach,
                                                                degree=degree_zf_L_approach,
                                                                epsilon=epsilon_zf_L_approach,
                                                                training_examples=training_examples,
                                                                training_targets=training_targets.iloc[:,0:ldim],
                                                                model_dir=dir_path_zf_L_approach + "/cluster"+repr(i)+"/svm")
                ...
                res_file = open(dir_path_zf_L_approach + "/cluster"+repr(i)+"/svm/results.txt", "a")
                res_file.write("Final RMSE (on projected test data): %0.3f\n" % test_root_mean_squared_error_proj)
                res_file.write("R^2 score (on projected test data): %0.3f\n" % r2score)
                res_file.close()
                ...
                plt.legend(loc='upper right')
                #plt.title()
                plt.savefig(dir_path_zf_L_approach+"/cluster"+repr(i)+"/svm/zf_L_pred.pdf")
                plt.clf()
                #plt.show()
                ...
                if (ldim!=0):
                    # ---------- K-Nearest Neighbors ---------------- #
                    (knn_regressor, r2) = train_knn_regressor_model(n_neighbors = n_neighbors_zf_L_approach,
                                                                weights = weights_zf_L_approach,
                                                                algorithm = algorithm_zf_L_approach,
                                                                training_examples=training_examples,
                                                                training_targets=training_targets.iloc[:,0:ldim],
                                                                model_dir=dir_path_zf_L_approach + "/cluster"+repr(i)+"/knn")
                ...
                res_file = open(dir_path_zf_L_approach + "/cluster"+repr(i)+"/knn/results.txt", "a")
                res_file.write("Final RMSE (on projected test data): %0.3f\n" % test_root_mean_squared_error_proj)
                res_file.write("R^2 score (on projected test data): %0.3f\n" % r2score)
                res_file.close()
                ...
                plt.legend(loc='upper right')
                #plt.title()
                plt.savefig(dir_path_zf_L_approach+"/cluster"+repr(i)+"/knn/zf_L_pred.pdf")
                plt.clf()
                #plt.show()
...
if not outputs_zf_U_approach_df.empty:
    # ------------------------- K-means clustering ---------------------------------------- #
    norm_outputs_zf_U_approach_df, outputs_zf_U_approach_df_max, outputs_zf_U_approach_df_min = normalize_linear_scale(outputs_zf_U_approach_df)

    if not os.path.exists(dir_path_zf_U_approach):
        os.mkdir(dir_path_zf_U_approach)
    outputs_zf_U_approach_df_max.to_csv(dir_path_zf_U_approach+"/zf_U_approach_max.csv",sep=',')
    outputs_zf_U_approach_df_min.to_csv(dir_path_zf_U_approach +"/zf_U_approach_min.csv",sep=',')

    zf_U_approach = norm_outputs_zf_U_approach_df.values

    kmeans = KMeans(n_clusters=n_clusters_zf_U_approach, init='k-means++', max_iter=100, n_init=5, verbose=0, random_state=3425)
    # Fitting with inputs
    kmeans_zf_U_approach = kmeans.fit(zf_U_approach)
    # Predicting the clusters
    labels_zf_U_approach = kmeans_zf_U_approach.predict(zf_U_approach)
    labels_zf_U_approach_df = pd.DataFrame(data=labels_zf_U_approach)

    # Getting the cluster centers
    C_zf_U_approach = kmeans_zf_U_approach.cluster_centers_
    if (print_en_zf_U_approach):
        fig = plt.figure()
        ax_zf_U_approach = fig.add_subplot(111)
        ax_zf_U_approach.scatter(zf_U_approach[:,0],zf_U_approach[:,1], s=10, c=labels_zf_U_approach, marker="s")
        ax_zf_U_approach.set_xlabel('normalized zf_U_approach 1')
        ax_zf_U_approach.set_ylabel('normalized zf_U_approach 2')
        ax_zf_U_approach.set_title('Clusters of the zf_U_approach')
        plt.savefig(dir_path_zf_U_approach + "/clusters.pdf")
        plt.clf()
        #plt.show()

    cl_0_inputs_list_zf_U_approach = []
    cl_0_inputs_test_list_zf_U_approach = []
    cl_0_list_zf_U_approach = []
    cl_0_test_list_zf_U_approach = []

    cl_1_inputs_list_zf_U_approach = []
    cl_1_inputs_test_list_zf_U_approach = []
    cl_1_list_zf_U_approach = []
    cl_1_test_list_zf_U_approach = []

    cl_2_inputs_list_zf_U_approach = []
    cl_2_inputs_test_list_zf_U_approach = []
    cl_2_list_zf_U_approach = []
    cl_2_test_list_zf_U_approach = []

    cl_3_inputs_list_zf_U_approach = []
    cl_3_inputs_test_list_zf_U_approach = []
    cl_3_list_zf_U_approach = []
    cl_3_test_list_zf_U_approach = []

    cl_4_inputs_list_zf_U_approach = []
    cl_4_inputs_test_list_zf_U_approach = []
    cl_4_list_zf_U_approach = []
    cl_4_test_list_zf_U_approach = []

    cl_5_inputs_list_zf_U_approach = []
    cl_5_inputs_test_list_zf_U_approach = []
    cl_5_list_zf_U_approach = []
    cl_5_test_list_zf_U_approach = []

    for i in range(len(labels_zf_U_approach)):
        cl = labels_zf_U_approach[i]
        if cl == 0:
            cl_0_list_zf_U_approach.append(norm_outputs_zf_U_approach_df.iloc[i])
            cl_0_inputs_list_zf_U_approach.append(normalized_inputs.iloc[i])
        elif cl == 1:
            cl_1_list_zf_U_approach.append(norm_outputs_zf_U_approach_df.iloc[i])
            cl_1_inputs_list_zf_U_approach.append(normalized_inputs.iloc[i])
        elif cl == 2:
            cl_2_list_zf_U_approach.append(norm_outputs_zf_U_approach_df.iloc[i])
            cl_2_inputs_list_zf_U_approach.append(normalized_inputs.iloc[i])
        elif cl == 3:
            cl_3_list_zf_U_approach.append(norm_outputs_zf_U_approach_df.iloc[i])
            cl_3_inputs_list_zf_U_approach.append(normalized_inputs.iloc[i])
        elif cl == 4:
            cl_4_list_zf_U_approach.append(norm_outputs_zf_U_approach_df.iloc[i])
            cl_4_inputs_list_zf_U_approach.append(normalized_inputs.iloc[i])
        elif cl == 5:
            cl_5_list_zf_U_approach.append(norm_outputs_zf_U_approach_df.iloc[i])
            cl_5_inputs_list_zf_U_approach.append(normalized_inputs.iloc[i])

    cl_0_inputs_zf_U_approach_df = pd.DataFrame(cl_0_inputs_list_zf_U_approach, columns=inputs_cols)
    cl_0_zf_U_approach_df = pd.DataFrame(cl_0_list_zf_U_approach, columns=cols_zf_U_approach)
    cl_1_inputs_zf_U_approach_df = pd.DataFrame(cl_1_inputs_list_zf_U_approach, columns=inputs_cols)
    cl_1_zf_U_approach_df = pd.DataFrame(cl_1_list_zf_U_approach, columns=cols_zf_U_approach)
    cl_2_inputs_zf_U_approach_df = pd.DataFrame(cl_2_inputs_list_zf_U_approach, columns=inputs_cols)
    cl_2_zf_U_approach_df = pd.DataFrame(cl_2_list_zf_U_approach, columns=cols_zf_U_approach)
    cl_3_inputs_zf_U_approach_df = pd.DataFrame(cl_3_inputs_list_zf_U_approach, columns=inputs_cols)
    cl_3_zf_U_approach_df = pd.DataFrame(cl_3_list_zf_U_approach, columns=cols_zf_U_approach)
    cl_4_inputs_zf_U_approach_df = pd.DataFrame(cl_4_inputs_list_zf_U_approach, columns=inputs_cols)
    cl_4_zf_U_approach_df = pd.DataFrame(cl_4_list_zf_U_approach, columns=cols_zf_U_approach)
    cl_5_inputs_zf_U_approach_df = pd.DataFrame(cl_5_inputs_list_zf_U_approach, columns=inputs_cols)
    cl_5_zf_U_approach_df = pd.DataFrame(cl_5_list_zf_U_approach, columns=cols_zf_U_approach)

    clusters_inputs_zf_U_approach = [cl_0_inputs_zf_U_approach_df,cl_1_inputs_zf_U_approach_df,cl_2_inputs_zf_U_approach_df,cl_3_inputs_zf_U_approach_df,cl_4_inputs_zf_U_approach_df,cl_5_inputs_zf_U_approach_df]
    clusters_outputs_zf_U_approach = [cl_0_zf_U_approach_df,cl_1_zf_U_approach_df,cl_2_zf_U_approach_df,cl_3_zf_U_approach_df,cl_4_zf_U_approach_df,cl_5_zf_U_approach_df]

    # save the dataframes of each cluster
    # cluster 0
    if not os.path.exists(dir_path_zf_U_approach + "/cluster0"):
        os.mkdir(dir_path_zf_U_approach + "/cluster0")
    cl_0_inputs_zf_U_approach_df.to_csv(dir_path_zf_U_approach + "/cluster0/inputs.csv", sep=',', index=False)
    cl_0_zf_U_approach_df.to_csv(dir_path_zf_U_approach + "/cluster0/outputs.csv", sep=',', index=False)
    # cluster 1
    if not os.path.exists(dir_path_zf_U_approach + "/cluster1"):
        os.mkdir(dir_path_zf_U_approach + "/cluster1")
    cl_1_inputs_zf_U_approach_df.to_csv(dir_path_zf_U_approach + "/cluster1/inputs.csv", sep=',', index=False)
    cl_1_zf_U_approach_df.to_csv(dir_path_zf_U_approach + "/cluster1/outputs.csv", sep=',', index=False)
    # cluster 2
    if not os.path.exists(dir_path_zf_U_approach + "/cluster2"):
        os.mkdir(dir_path_zf_U_approach + "/cluster2")
    cl_2_inputs_zf_U_approach_df.to_csv(dir_path_zf_U_approach + "/cluster2/inputs.csv", sep=',', index=False)
    cl_2_zf_U_approach_df.to_csv(dir_path_zf_U_approach + "/cluster2/outputs.csv", sep=',', index=False)
    # cluster 3
    if not os.path.exists(dir_path_zf_U_approach + "/cluster3"):
        os.mkdir(dir_path_zf_U_approach + "/cluster3")
    cl_3_inputs_zf_U_approach_df.to_csv(dir_path_zf_U_approach + "/cluster3/inputs.csv", sep=',', index=False)
    cl_3_zf_U_approach_df.to_csv(dir_path_zf_U_approach + "/cluster3/outputs.csv", sep=',', index=False)
    # cluster 4
    if not os.path.exists(dir_path_zf_U_approach + "/cluster4"):
        os.mkdir(dir_path_zf_U_approach + "/cluster4")
    cl_4_inputs_zf_U_approach_df.to_csv(dir_path_zf_U_approach + "/cluster4/inputs.csv", sep=',', index=False)
    cl_4_zf_U_approach_df.to_csv(dir_path_zf_U_approach + "/cluster4/outputs.csv", sep=',', index=False)
    # cluster 5
    if not os.path.exists(dir_path_zf_U_approach + "/cluster5"):
        os.mkdir(dir_path_zf_U_approach + "/cluster5")
    cl_5_inputs_zf_U_approach_df.to_csv(dir_path_zf_U_approach + "/cluster5/inputs.csv", sep=',', index=False)
    cl_5_zf_U_approach_df.to_csv(dir_path_zf_U_approach + "/cluster5/outputs.csv", sep=',', index=False)

    if (print_en_zf_U_approach):
        print("Cluster 0:")
        print(cl_0_inputs_zf_U_approach_df.describe())
        print(cl_0_zf_U_approach_df.describe())
        print("Cluster 1:")
        print(cl_1_inputs_zf_U_approach_df.describe())
        print(cl_1_zf_U_approach_df.describe())
        print("Cluster 2:")
        print(cl_2_inputs_zf_U_approach_df.describe())
        print(cl_2_zf_U_approach_df.describe())
        print("Cluster 3:")
        print(cl_3_inputs_zf_U_approach_df.describe())
        print(cl_3_zf_U_approach_df.describe())
        print("Cluster 4:")
        print(cl_4_inputs_zf_U_approach_df.describe())
        print(cl_4_zf_U_approach_df.describe())
        print("Cluster 5:")
        print(cl_5_inputs_zf_U_approach_df.describe())
        print(cl_5_zf_U_approach_df.describe())

    # ---------------------------------- Classifier training ------------------------------------------------------------#
    if (train_zf_U_approach_class):

        if not os.path.exists(dir_path_zf_U_approach + "/classification"):
            os.mkdir(dir_path_zf_U_approach + "/classification")
        if not os.path.exists(dir_path_zf_U_approach + "/classification/nn"):
            os.mkdir(dir_path_zf_U_approach + "/classification/nn")
        if not os.path.exists(dir_path_zf_U_approach + "/classification/svm"):
            os.mkdir(dir_path_zf_U_approach + "/classification/svm")
        if not os.path.exists(dir_path_zf_U_approach + "/classification/knn"):
            os.mkdir(dir_path_zf_U_approach + "/classification/knn")
        ...
        # Choose the first 70% examples for training.
        training_examples_class = normalized_inputs.iloc[:train, :]
        training_targets_class = labels_zf_U_approach_df.iloc[:train, :]

        # Choose the last 20%  examples for validation.
        validation_examples_class = normalized_inputs.iloc[train:val, :]
        validation_targets_class = labels_zf_U_approach_df.iloc[train:val, :]

        # Choose the examples for test. 10%
        test_examples_class = normalized_inputs.iloc[val:, :]
        test_targets_class = labels_zf_U_approach_df.iloc[val:, :]
        ...
        (nn_classifier, training_log_losses, validation_log_losses) = train_nn_classifier_model(
                                                                        ...
                                                                        periods=periods_zf_U_approach_class,
                                                                        steps=steps_zf_U_approach_class,
                                                                        batch_size=batch_size_zf_U_approach_class,
        ...
        res_file = open(dir_path_zf_U_approach + "/classification/nn/results.txt", "a")
        res_file.write("LogLoss (on test data): %0.3f\n" % test_log_loss)
        res_file.write("Average loss on the test set: %0.3f\n" % evaluation_metrics['average_loss'])
        res_file.write("Accuracy on the test set: %0.3f\n" % evaluation_metrics['accuracy'])
        res_file.close()
        ...
        # ---------- Support Vector Machine ---------- #
        (svm_classifier, scores) = train_svm_classifier_model(kernel = kernel_class_zf_U_approach,
                                                              cv = n_cv_zf_U_approach,
                                                              training_examples_class_list = training_examples_class_list,
                                                              training_targets_class_list = training_targets_class_list,
                                                              model_dir = dir_path_zf_U_approach + "/classification/svm")

        test_targets_class_pred = svm_classifier.predict(test_examples_class_list)
        report = classification_report(test_targets_class_list, test_targets_class_pred)
        #print(report)
        classification_report_csv(report = report,model_dir = dir_path_zf_U_approach + "/classification/svm")
        acc_test = accuracy_score(test_targets_class_list, test_targets_class_pred, normalize=True, sample_weight=None)
        print("Accuracy on the test set: %0.3f " % acc_test)

        res_file = open(dir_path_zf_U_approach + "/classification/svm/results.txt", "a")
        res_file.write("Accuracy on the test set: %0.3f \n" % acc_test)
        res_file.close()

        # ---------- K-Nearest Neighbors ---------- #
        (knn_classifier, scores) = train_knn_classifier_model(n_neighbors = n_neighbors_class_zf_U_approach,
                                                              cv = n_cv_zf_U_approach,
                                                              weights = weights_class_zf_U_approach ,
                                                              algorithm = algorithm_class_zf_U_approach,
                                                              training_examples_class_list = training_examples_class_list,
                                                              training_targets_class_list = training_targets_class_list,
                                                              model_dir = dir_path_zf_U_approach + "/classification/knn")


        test_targets_class_pred = knn_classifier.predict(test_examples_class_list)
        report = classification_report(test_targets_class_list, test_targets_class_pred)
        #print(report)
        classification_report_csv(report = report,model_dir = dir_path_zf_U_approach + "/classification/knn")
        acc_test = accuracy_score(test_targets_class_list, test_targets_class_pred, normalize=True, sample_weight=None)
        print("Accuracy on the test set: %0.3f " % acc_test)

        res_file = open(dir_path_zf_U_approach + "/classification/knn/results.txt", "a")
        res_file.write("Accuracy on the test set: %0.3f \n" % acc_test)
        res_file.close()

    if (train_zf_U_approach):
        # ----------------------------------------------- PCA  and regression on each cluster --------------------------------------- #
        for i in range(0,n_clusters_zf_U_approach):
            cl_in_zf_U_approach_df = clusters_inputs_zf_U_approach[i]
            cl_out_zf_U_approach_df = clusters_outputs_zf_U_approach[i]
            if (len(cl_out_zf_U_approach_df.index) > min_cluster_size_zf_U_approach):
                if (len(cl_out_zf_U_approach_df.columns) > 4):
                    n_comps = 4  # at least 95% of the information with 3 components
                    Z_f_U_approach = cl_out_zf_U_approach_df.values
                    pca_zf_U_approach = decomposition.PCA(n_components=n_comps)
                    pc = pca_zf_U_approach.fit_transform(Z_f_U_approach)
                    pc_df = pd.DataFrame(data=pc, columns=cols_zf_U_approach[0:n_comps])
                    if (print_en_zf_U_approach):
                        print(pca_zf_U_approach.n_components_)
                        print(pca_zf_U_approach.components_)
                        print(pc_df.describe())
                        print(pca_zf_U_approach.explained_variance_ratio_)
                        print(pca_zf_U_approach.explained_variance_ratio_.sum())
                        df = pd.DataFrame({'var': pca_zf_U_approach.explained_variance_ratio_, 'PC': cols_zf_U_approach[0:n_comps]})


                        pc_file = open(dir_path_zf_U_approach+"/cluster"+repr(i)+"/p_comps.csv", "w")
                        pc_file.write("### Principal components ###\n")
                        pc_file.write(df.iloc[0, 0]+", ")
                        pc_file.write(df.iloc[1, 0] + ", ")
                        pc_file.write(df.iloc[2, 0] + ", ")
                        ...
                        fig_pc.savefig(dir_path_xf_approach+"/cluster"+repr(i)+"/p_comps.pdf")
                        threedee_train = plt.figure().gca(projection='3d')
                        threedee_train.scatter(cl_in_zf_U_approach_df["target_x_mm"], cl_in_zf_U_approach_df["target_y_mm"], pc_df['zf_U_approach_3'])
                        plt.clf()
                        #plt.show()
                else:
                    pc_df = cl_out_zf_U_approach_df
                    n_comps = len(cl_out_zf_U_approach_df.columns)

                # ---------------------------- regression --------------------------------- #
                size = len(cl_out_zf_U_approach_df.index)
                inputs_df, inputs_df_max, inputs_df_min = normalize_linear_scale(cl_in_zf_U_approach_df)
                outputs_df = pc_df

                if not os.path.exists(dir_path_zf_U_approach + "/cluster"+repr(i)):
                    os.mkdir(dir_path_zf_U_approach + "/cluster"+repr(i))
                if not os.path.exists(dir_path_zf_U_approach + "/cluster"+repr(i)+"/nn"):
                    os.mkdir(dir_path_zf_U_approach + "/cluster"+repr(i)+"/nn")
                if not os.path.exists(dir_path_zf_U_approach + "/cluster"+repr(i)+"/svm"):
                    os.mkdir(dir_path_zf_U_approach + "/cluster"+repr(i)+"/svm")
                if not os.path.exists(dir_path_zf_U_approach + "/cluster"+repr(i)+"/knn"):
                    os.mkdir(dir_path_zf_U_approach + "/cluster"+repr(i)+"/knn")
                ...
                test_examples = inputs_df.iloc[val:, :]
                # test_targets = outputs_df_0.iloc[val:, tar:tar_end]
                test_targets = cl_out_zf_U_approach_df.iloc[val:, :]
                ...
                for j in range(0, dim):
                    if (math.sqrt(math.pow((training_targets.iloc[0:, j].quantile(0.25) - training_targets.iloc[0:, j].quantile(0.75)),2)) <= th_zf_U_approach):
                        if (test_predictions_1.size == 0):
                            test_predictions_1 = np.full((test_targets.shape[0], 1),training_targets.iloc[0:, j].mean())
                        else:
                            test_predictions_1 = np.concatenate([test_predictions_1, np.full((test_targets.shape[0], 1),training_targets.iloc[0:,j].mean())], axis=1)
                ...
                if (ldim != 0):
                    ...
                    nn_regressor, training_losses, validation_losses = train_nn_regressor_model(
                                                                            my_optimizer=tf.train.AdamOptimizer(learning_rate=learning_rate),
                                                                            dimensions=ldim,
                                                                            periods=periods_zf_U_approach,
                                                                            steps=steps_zf_U_approach,
                                                                            batch_size=batch_size_zf_U_approach,
                                                                            hidden_units=units_zf_U_approach,
                                                                            training_examples=training_examples,
                                                                            training_targets=training_targets[train_col_names_1],
                                                                            validation_examples=validation_examples,
                                                                            validation_targets=validation_targets[train_col_names_1],
                                                                            model_dir=dir_path_zf_U_approach+"/cluster"+repr(i)+"/nn")
                ...
                if (len(cl_out_zf_U_approach_df.columns) > 4):
                    # test_predictions_df = denormalize_linear_scale(test_predictions_df, outputs_df_0_max,outputs_df_0_min)
                    test_predictions = test_predictions_df.values
                    test_predictions_proj = pca_zf_U_approach.inverse_transform(test_predictions)
                    test_proj_df = pd.DataFrame(data=test_predictions_proj, columns=cols_zf_U_approach)
                    denorm_test_predictions_df = denormalize_linear_scale(test_proj_df, outputs_zf_U_approach_df_max, outputs_zf_U_approach_df_min)
                else:
                ...
                denorm_test_targets = denormalize_linear_scale(test_targets, outputs_zf_U_approach_df_max, outputs_zf_U_approach_df_min)
                ...
                res_file = open(dir_path_zf_U_approach+"/cluster"+repr(i)+"/nn/results.txt", "a")
                res_file.write("RMSE (on test data):   %0.3f\n" % test_root_mean_squared_error_proj)
                res_file.write("R^2 score (on projected test data): %0.3f\n" % r2score)
                res_file.close()
                ...
                fig = plt.figure()
                ax1 = fig.add_subplot(111)
                ax1.scatter(denorm_test_targets["zf_U_approach_3"], denorm_test_targets["zf_U_approach_5"], s=10, c='b', marker="s",label='test_targets')
                ax1.scatter(denorm_test_predictions_df["zf_U_approach_3"], denorm_test_predictions_df["zf_U_approach_5"], s=10, c='r', marker="o", label='test_predictions')
                plt.xlabel("zf_U_approach_3")
                plt.ylabel("zf_U_approach_5")
                plt.legend(loc='upper right')
                plt.savefig(dir_path_zf_U_approach+"/cluster"+repr(i)+"/nn/zf_U_pred.pdf")
                plt.clf()
                #plt.show()
                ...
                if (ldim!=0):
                    # ---------- Support Vector Machine ---------------- #
                    (svm_regressor, r2) = train_svm_regressor_model(kernel=kernel_zf_U_approach,
                                                                gamma=gamma_zf_U_approach,
                                                                coeff=coeff_zf_U_approach,
                                                                degree=degree_zf_U_approach,
                                                                epsilon=epsilon_zf_U_approach,
                                                                training_examples=training_examples,
                                                                training_targets=training_targets.iloc[:,0:ldim],
                                                                model_dir=dir_path_zf_U_approach + "/cluster"+repr(i)+"/svm")
                ...
                res_file = open(dir_path_zf_U_approach + "/cluster"+repr(i)+"/svm/results.txt", "a")
                res_file.write("Final RMSE (on projected test data): %0.3f\n" % test_root_mean_squared_error_proj)
                res_file.write("R^2 score (on projected test data): %0.3f\n" % r2score)
                res_file.close()
                ...
                plt.ylabel("zf_U_approach_5")
                plt.legend(loc='upper right')
                plt.savefig(dir_path_zf_U_approach+"/cluster"+repr(i)+"/svm/zf_U_pred.pdf")
                plt.clf()
                #plt.show()
                ...
                if (ldim!=0):
                    # ---------- K-Nearest Neighbors ---------------- #
                    (knn_regressor, r2) = train_knn_regressor_model(n_neighbors = n_neighbors_zf_U_approach,
                                                                weights = weights_zf_U_approach,
                                                                algorithm = algorithm_zf_U_approach,
                                                                training_examples=training_examples,
                                                                training_targets=training_targets.iloc[:,0:ldim],
                                                                model_dir=dir_path_zf_U_approach + "/cluster"+repr(i)+"/knn")
                ...
                res_file = open(dir_path_zf_U_approach + "/cluster"+repr(i)+"/knn/results.txt", "a")
                res_file.write("Final RMSE (on projected test data): %0.3f\n" % test_root_mean_squared_error_proj)
                res_file.write("R^2 score (on projected test data): %0.3f\n" % r2score)
                res_file.close()
                ...
                plt.ylabel("zf_U_approach_5")
                plt.legend(loc='upper right')
                plt.savefig(dir_path_zf_U_approach+"/cluster"+repr(i)+"/knn/zf_U_pred.pdf")
                plt.clf()
                #plt.show()
...
if not outputs_dual_f_approach_df.empty:
    # ------------------------- K-means clustering ---------------------------------------- #
    norm_outputs_dual_f_approach_df, outputs_dual_f_approach_df_max, outputs_dual_f_approach_df_min = normalize_linear_scale(outputs_dual_f_approach_df)

    if not os.path.exists(dir_path_dual_f_approach):
        os.mkdir(dir_path_dual_f_approach)
    outputs_dual_f_approach_df_max.to_csv(dir_path_dual_f_approach+"/dual_f_approach_max.csv",sep=',')
    outputs_dual_f_approach_df_min.to_csv(dir_path_dual_f_approach +"/dual_f_approach_min.csv",sep=',')

    dual_f_approach = norm_outputs_dual_f_approach_df.values

    kmeans = KMeans(n_clusters=n_clusters_dual_f_approach, init='k-means++', max_iter=100, n_init=5, verbose=0, random_state=3425)
    # Fitting with inputs
    kmeans_dual_f_approach = kmeans.fit(dual_f_approach)
    # Predicting the clusters
    labels_dual_f_approach = kmeans_dual_f_approach.predict(dual_f_approach)
    labels_dual_f_approach_df = pd.DataFrame(data=labels_dual_f_approach)

    # Getting the cluster centers
    C_dual_f_approach = kmeans_dual_f_approach.cluster_centers_
    if (print_en_dual_f_approach):
        fig = plt.figure()
        ax_dual_f_approach = fig.add_subplot(111)
        ax_dual_f_approach.scatter(normalized_inputs['target_x_mm'],dual_f_approach[:,0], s=10, c=labels_dual_f_approach, marker="s")
        ax_dual_f_approach.set_title('Clusters of the dual_f_approach')
        ax_dual_f_approach.set_xlabel('target_x_mm')
        ax_dual_f_approach.set_ylabel('dual_f_approach_1')
        plt.savefig(dir_path_dual_f_approach + "/clusters.pdf")
        plt.clf()
        #plt.show()

    cl_0_inputs_list_dual_f_approach = []
    cl_0_inputs_test_list_dual_f_approach = []
    cl_0_list_dual_f_approach = []
    cl_0_test_list_dual_f_approach = []

    cl_1_inputs_list_dual_f_approach = []
    cl_1_inputs_test_list_dual_f_approach = []
    cl_1_list_dual_f_approach = []
    cl_1_test_list_dual_f_approach = []

    cl_2_inputs_list_dual_f_approach = []
    cl_2_inputs_test_list_dual_f_approach = []
    cl_2_list_dual_f_approach = []
    cl_2_test_list_dual_f_approach = []

    cl_3_inputs_list_dual_f_approach = []
    cl_3_inputs_test_list_dual_f_approach = []
    cl_3_list_dual_f_approach = []
    cl_3_test_list_dual_f_approach = []

    cl_4_inputs_list_dual_f_approach = []
    cl_4_inputs_test_list_dual_f_approach = []
    cl_4_list_dual_f_approach = []
    cl_4_test_list_dual_f_approach = []

    cl_5_inputs_list_dual_f_approach = []
    cl_5_inputs_test_list_dual_f_approach = []
    cl_5_list_dual_f_approach = []
    cl_5_test_list_dual_f_approach = []

    for i in range(len(labels_dual_f_approach)):
        cl = labels_dual_f_approach[i]
        if cl == 0:
            cl_0_list_dual_f_approach.append(norm_outputs_dual_f_approach_df.iloc[i])
            cl_0_inputs_list_dual_f_approach.append(normalized_inputs.iloc[i])
        elif cl == 1:
            cl_1_list_dual_f_approach.append(norm_outputs_dual_f_approach_df.iloc[i])
            cl_1_inputs_list_dual_f_approach.append(normalized_inputs.iloc[i])
        elif cl == 2:
            cl_2_list_dual_f_approach.append(norm_outputs_dual_f_approach_df.iloc[i])
            cl_2_inputs_list_dual_f_approach.append(normalized_inputs.iloc[i])
        elif cl == 3:
            cl_3_list_dual_f_approach.append(norm_outputs_dual_f_approach_df.iloc[i])
            cl_3_inputs_list_dual_f_approach.append(normalized_inputs.iloc[i])
        elif cl == 4:
            cl_4_list_dual_f_approach.append(norm_outputs_dual_f_approach_df.iloc[i])
            cl_4_inputs_list_dual_f_approach.append(normalized_inputs.iloc[i])
        elif cl == 5:
            cl_5_list_dual_f_approach.append(norm_outputs_dual_f_approach_df.iloc[i])
            cl_5_inputs_list_dual_f_approach.append(normalized_inputs.iloc[i])

    cl_0_inputs_dual_f_approach_df = pd.DataFrame(cl_0_inputs_list_dual_f_approach, columns=inputs_cols)
    cl_0_dual_f_approach_df = pd.DataFrame(cl_0_list_dual_f_approach, columns=cols_dual_f_approach)
    cl_1_inputs_dual_f_approach_df = pd.DataFrame(cl_1_inputs_list_dual_f_approach, columns=inputs_cols)
    cl_1_dual_f_approach_df = pd.DataFrame(cl_1_list_dual_f_approach, columns=cols_dual_f_approach)
    cl_2_inputs_dual_f_approach_df = pd.DataFrame(cl_2_inputs_list_dual_f_approach, columns=inputs_cols)
    cl_2_dual_f_approach_df = pd.DataFrame(cl_2_list_dual_f_approach, columns=cols_dual_f_approach)
    cl_3_inputs_dual_f_approach_df = pd.DataFrame(cl_3_inputs_list_dual_f_approach, columns=inputs_cols)
    cl_3_dual_f_approach_df = pd.DataFrame(cl_3_list_dual_f_approach, columns=cols_dual_f_approach)
    cl_4_inputs_dual_f_approach_df = pd.DataFrame(cl_4_inputs_list_dual_f_approach, columns=inputs_cols)
    cl_4_dual_f_approach_df = pd.DataFrame(cl_4_list_dual_f_approach, columns=cols_dual_f_approach)
    cl_5_inputs_dual_f_approach_df = pd.DataFrame(cl_5_inputs_list_dual_f_approach, columns=inputs_cols)
    cl_5_dual_f_approach_df = pd.DataFrame(cl_5_list_dual_f_approach, columns=cols_dual_f_approach)

    clusters_inputs_dual_f_approach = [cl_0_inputs_dual_f_approach_df,cl_1_inputs_dual_f_approach_df,cl_2_inputs_dual_f_approach_df,cl_3_inputs_dual_f_approach_df,cl_4_inputs_dual_f_approach_df,cl_5_inputs_dual_f_approach_df]
    clusters_outputs_dual_f_approach = [cl_0_dual_f_approach_df,cl_1_dual_f_approach_df,cl_2_dual_f_approach_df,cl_3_dual_f_approach_df,cl_4_dual_f_approach_df,cl_5_dual_f_approach_df]

    # save the dataframes of each cluster
    # cluster 0
    if not os.path.exists(dir_path_dual_f_approach + "/cluster0"):
        os.mkdir(dir_path_dual_f_approach + "/cluster0")
    cl_0_inputs_dual_f_approach_df.to_csv(dir_path_dual_f_approach + "/cluster0/inputs.csv", sep=',', index=False)
    cl_0_dual_f_approach_df.to_csv(dir_path_dual_f_approach + "/cluster0/outputs.csv", sep=',', index=False)
    # cluster 1
    if not os.path.exists(dir_path_dual_f_approach + "/cluster1"):
        os.mkdir(dir_path_dual_f_approach + "/cluster1")
    cl_1_inputs_dual_f_approach_df.to_csv(dir_path_dual_f_approach + "/cluster1/inputs.csv", sep=',', index=False)
    cl_1_dual_f_approach_df.to_csv(dir_path_dual_f_approach + "/cluster1/outputs.csv", sep=',', index=False)
    # cluster 2
    if not os.path.exists(dir_path_dual_f_approach + "/cluster2"):
        os.mkdir(dir_path_dual_f_approach + "/cluster2")
    cl_2_inputs_dual_f_approach_df.to_csv(dir_path_dual_f_approach + "/cluster2/inputs.csv", sep=',', index=False)
    cl_2_dual_f_approach_df.to_csv(dir_path_dual_f_approach + "/cluster2/outputs.csv", sep=',', index=False)
    # cluster 3
    if not os.path.exists(dir_path_dual_f_approach + "/cluster3"):
        os.mkdir(dir_path_dual_f_approach + "/cluster3")
    cl_3_inputs_dual_f_approach_df.to_csv(dir_path_dual_f_approach + "/cluster3/inputs.csv", sep=',', index=False)
    cl_3_dual_f_approach_df.to_csv(dir_path_dual_f_approach + "/cluster3/outputs.csv", sep=',', index=False)
    # cluster 4
    if not os.path.exists(dir_path_dual_f_approach + "/cluster4"):
        os.mkdir(dir_path_dual_f_approach + "/cluster4")
    cl_4_inputs_dual_f_approach_df.to_csv(dir_path_dual_f_approach + "/cluster4/inputs.csv", sep=',', index=False)
    cl_4_dual_f_approach_df.to_csv(dir_path_dual_f_approach + "/cluster4/outputs.csv", sep=',', index=False)
    # cluster 5
    if not os.path.exists(dir_path_dual_f_approach + "/cluster5"):
        os.mkdir(dir_path_dual_f_approach + "/cluster5")
    cl_5_inputs_dual_f_approach_df.to_csv(dir_path_dual_f_approach + "/cluster5/inputs.csv", sep=',', index=False)
    cl_5_dual_f_approach_df.to_csv(dir_path_dual_f_approach + "/cluster5/outputs.csv", sep=',', index=False)

    if (print_en_dual_f_approach):
        print("Cluster 0:")
        print(cl_0_inputs_dual_f_approach_df.describe())
        print(cl_0_dual_f_approach_df.describe())
        print("Cluster 1:")
        print(cl_1_inputs_dual_f_approach_df.describe())
        print(cl_1_dual_f_approach_df.describe())
        print("Cluster 2:")
        print(cl_2_inputs_dual_f_approach_df.describe())
        print(cl_2_dual_f_approach_df.describe())
        print("Cluster 3:")
        print(cl_3_inputs_dual_f_approach_df.describe())
        print(cl_3_dual_f_approach_df.describe())
        print("Cluster 4:")
        print(cl_4_inputs_dual_f_approach_df.describe())
        print(cl_4_dual_f_approach_df.describe())
        print("Cluster 5:")
        print(cl_5_inputs_dual_f_approach_df.describe())
        print(cl_5_dual_f_approach_df.describe())

    # ---------------------------------- Classifier training ------------------------------------------------------------#
    if (train_dual_f_approach_class):

        if not os.path.exists(dir_path_dual_f_approach + "/classification"):
            os.mkdir(dir_path_dual_f_approach + "/classification")
        if not os.path.exists(dir_path_dual_f_approach + "/classification/nn"):
            os.mkdir(dir_path_dual_f_approach + "/classification/nn")
        if not os.path.exists(dir_path_dual_f_approach + "/classification/svm"):
            os.mkdir(dir_path_dual_f_approach + "/classification/svm")
        if not os.path.exists(dir_path_dual_f_approach + "/classification/knn"):
            os.mkdir(dir_path_dual_f_approach + "/classification/knn")
        ...
        # Choose the first 70% examples for training.
        training_examples_class = normalized_inputs.iloc[:train, :]
        training_targets_class = labels_dual_f_approach_df.iloc[:train, :]

        # Choose the last 20%  examples for validation.
        validation_examples_class = normalized_inputs.iloc[train:val, :]
        validation_targets_class = labels_dual_f_approach_df.iloc[train:val, :]

        # Choose the examples for test. 10%
        test_examples_class = normalized_inputs.iloc[val:, :]
        test_targets_class = labels_dual_f_approach_df.iloc[val:, :]
        ...
        (nn_classifier, training_log_losses, validation_log_losses) = train_nn_classifier_model(
                                                        ...
                                                        periods=periods_dual_f_approach_class,
                                                        steps=steps_dual_f_approach_class,
                                                        batch_size=batch_size_dual_f_approach_class,
        ...
        res_file = open(dir_path_dual_f_approach + "/classification/nn/results.txt", "a")
        res_file.write("LogLoss (on test data): %0.3f\n" % test_log_loss)
        res_file.write("Average loss on the test set: %0.3f\n" % evaluation_metrics['average_loss'])
        res_file.write("Accuracy on the test set: %0.3f\n" % evaluation_metrics['accuracy'])
        res_file.close()
        ...
        # ---------- Support Vector Machine ---------- #
        (svm_classifier, scores) = train_svm_classifier_model(kernel = kernel_class_dual_f_approach,
                                                              cv = n_cv_dual_f_approach,
                                                              training_examples_class_list = training_examples_class_list,
                                                              training_targets_class_list = training_targets_class_list,
                                                              model_dir = dir_path_dual_f_approach + "/classification/svm")

        test_targets_class_pred = svm_classifier.predict(test_examples_class_list)
        report = classification_report(test_targets_class_list, test_targets_class_pred)
        #print(report)
        classification_report_csv(report = report,model_dir = dir_path_dual_f_approach + "/classification/svm")
        acc_test = accuracy_score(test_targets_class_list, test_targets_class_pred, normalize=True, sample_weight=None)
        print("Accuracy on the test set: %0.3f " % acc_test)

        res_file = open(dir_path_dual_f_approach + "/classification/svm/results.txt", "a")
        res_file.write("Accuracy on the test set: %0.3f \n" % acc_test)
        res_file.close()

        # ---------- K-Nearest Neighbors ---------- #
        (knn_classifier, scores) = train_knn_classifier_model(n_neighbors = n_neighbors_class_dual_f_approach,
                                                              cv = n_cv_dual_f_approach,
                                                              weights = weights_class_dual_f_approach ,
                                                              algorithm = algorithm_class_dual_f_approach,
                                                              training_examples_class_list = training_examples_class_list,
                                                              training_targets_class_list = training_targets_class_list,
                                                              model_dir = dir_path_dual_f_approach + "/classification/knn")

        test_targets_class_pred = knn_classifier.predict(test_examples_class_list)
        report = classification_report(test_targets_class_list, test_targets_class_pred)
        #print(report)
        classification_report_csv(report = report,model_dir = dir_path_dual_f_approach + "/classification/knn")
        acc_test = accuracy_score(test_targets_class_list, test_targets_class_pred, normalize=True, sample_weight=None)
        print("Accuracy on the test set: %0.3f " % acc_test)

        res_file = open(dir_path_dual_f_approach + "/classification/knn/results.txt", "a")
        res_file.write("Accuracy on the test set: %0.3f \n" % acc_test)
        res_file.close()

    if (train_dual_f_approach):
        # ----------------------------------------------- PCA  and regression on each cluster --------------------------------------- #
        for i in range(0,n_clusters_dual_f_approach):
            cl_in_dual_f_approach_df = clusters_inputs_dual_f_approach[i]
            cl_out_dual_f_approach_df = clusters_outputs_dual_f_approach[i]
            if (len(cl_out_dual_f_approach_df.index) > min_cluster_size_dual_f_approach):
                if (len(cl_out_dual_f_approach_df.columns) > 10):
                    n_comps = 10  # at least 95% of the information with 3 components
                    Dual_f_approach = cl_out_dual_f_approach_df.values
                    pca_dual_f_approach = decomposition.PCA(n_components=n_comps)
                    pc = pca_dual_f_approach.fit_transform(Dual_f_approach)
                    pc_df = pd.DataFrame(data=pc, columns=cols_dual_f_approach[0:n_comps])
                    if (print_en_dual_f_approach):
                        print(pca_dual_f_approach.n_components_)
                        print(pca_dual_f_approach.components_)
                        print(pc_df.describe())
                        print(pca_dual_f_approach.explained_variance_ratio_)
                        print(pca_dual_f_approach.explained_variance_ratio_.sum())
                        df = pd.DataFrame({'var': pca_dual_f_approach.explained_variance_ratio_, 'PC': cols_dual_f_approach[0:n_comps]})

                        pc_file = open(dir_path_dual_f_approach+"/cluster"+repr(i)+"/p_comps.csv", "w")
                        pc_file.write("### Principal components ###\n")
                        pc_file.write(df.iloc[0, 0]+", ")
                        pc_file.write(df.iloc[1, 0] + ", ")
                        pc_file.write(df.iloc[2, 0] + ", ")
                        ...
                        sns_plot = sns.barplot(x='PC', y="var", data=df, color="c")
                        fig_pc = sns_plot.get_figure()
                        fig_pc.savefig(dir_path_dual_f_approach+"/cluster"+repr(i)+"/p_comps.pdf")
                        threedee_train = plt.figure().gca(projection='3d')
                        threedee_train.scatter(cl_in_dual_f_approach_df["target_x_mm"], cl_in_dual_f_approach_df["target_y_mm"], pc_df['dual_f_approach_1'])
                        plt.clf()
                        #plt.show()
                else:
                    pc_df = cl_out_dual_f_approach_df
                    n_comps = len(cl_out_dual_f_approach_df.columns)

                # ---------------------------- regression --------------------------------- #

                size = len(cl_out_dual_f_approach_df.index)
                inputs_df, inputs_df_max, inputs_df_min = normalize_linear_scale(cl_in_dual_f_approach_df)
                outputs_df = pc_df

                if not os.path.exists(dir_path_dual_f_approach + "/cluster"+repr(i)):
                    os.mkdir(dir_path_dual_f_approach + "/cluster"+repr(i))
                if not os.path.exists(dir_path_dual_f_approach + "/cluster"+repr(i)+"/nn"):
                    os.mkdir(dir_path_dual_f_approach + "/cluster"+repr(i)+"/nn")
                if not os.path.exists(dir_path_dual_f_approach + "/cluster"+repr(i)+"/svm"):
                    os.mkdir(dir_path_dual_f_approach + "/cluster"+repr(i)+"/svm")
                if not os.path.exists(dir_path_dual_f_approach + "/cluster"+repr(i)+"/knn"):
                    os.mkdir(dir_path_dual_f_approach + "/cluster"+repr(i)+"/knn")
                ...
                test_examples = inputs_df.iloc[val:, :]
                # test_targets = outputs_df_0.iloc[val:, tar:tar_end]
                test_targets = cl_out_dual_f_approach_df.iloc[val:, :]
                ...
                for j in range(0, dim):
                    if (math.sqrt(math.pow((training_targets.iloc[0:, j].quantile(0.25) - training_targets.iloc[0:, j].quantile(0.75)),2)) <= th_dual_f_approach):
                        if (test_predictions_1.size == 0):
                            test_predictions_1 = np.full((test_targets.shape[0], 1),training_targets.iloc[0:, j].mean())
                        else:
                            test_predictions_1 = np.concatenate([test_predictions_1, np.full((test_targets.shape[0], 1),training_targets.iloc[0:,j].mean())], axis=1)
                ...
                if (ldim != 0):
                    ...
                    nn_regressor, training_losses, validation_losses = train_nn_regressor_model(
                                                                            my_optimizer=tf.train.AdamOptimizer(learning_rate=learning_rate),
                                                                            dimensions=ldim,
                                                                            periods=periods_dual_f_approach,
                                                                            steps=steps_dual_f_approach,
                                                                            batch_size=batch_size_dual_f_approach,
                                                                            hidden_units=units_dual_f_approach,
                                                                            training_examples=training_examples,
                                                                            training_targets=training_targets[train_col_names_1],
                                                                            validation_examples=validation_examples,
                                                                            validation_targets=validation_targets[train_col_names_1],
                                                                            model_dir=dir_path_dual_f_approach+"/cluster"+repr(i)+"/nn")
                ...
                if (len(cl_out_dual_f_approach_df.columns) > 10):
                    ...
                    denorm_test_predictions_df = denormalize_linear_scale(test_proj_df, outputs_dual_f_approach_df_max, outputs_dual_f_approach_df_min)
                else:
                ...
                denorm_test_targets = denormalize_linear_scale(test_targets, outputs_dual_f_approach_df_max, outputs_dual_f_approach_df_min)
                ...
                res_file = open(dir_path_dual_f_approach+"/cluster"+repr(i)+"/nn/results.txt", "a")
                res_file.write("RMSE (on test data):   %0.3f\n" % test_root_mean_squared_error_proj)
                res_file.write("R^2 score (on projected test data): %0.3f\n" % r2score)
                res_file.close()
                ...
                fig = plt.figure()
                ax1 = fig.add_subplot(111)
                ax1.scatter(test_examples["target_x_mm"], denorm_test_targets["dual_f_approach_1"], s=10, c='b', marker="s",label='test_targets')
                ax1.scatter(test_examples["target_x_mm"], denorm_test_predictions_df["dual_f_approach_1"], s=10, c='r', marker="o", label='test_predictions')
                plt.xlabel("target_x_mm")
                plt.ylabel("dual_f_approach_1")
                plt.legend(loc='upper right')
                plt.savefig(dir_path_dual_f_approach+"/cluster"+repr(i)+"/nn/dual_f_approach_pred.pdf")
                plt.clf()
                #plt.show()
                ...
                if (ldim!=0):
                    # ---------- Support Vector Machine ---------------- #
                    (svm_regressor, r2) = train_svm_regressor_model(kernel=kernel_dual_f_approach,
                                                                    gamma=gamma_dual_f_approach,
                                                                    coeff=coeff_dual_f_approach,
                                                                    degree=degree_dual_f_approach,
                                                                    epsilon=epsilon_dual_f_approach,
                                                                    training_examples=training_examples,
                                                                    training_targets=training_targets.iloc[:,0:ldim],
                                                                    model_dir=dir_path_dual_f_approach + "/cluster"+repr(i)+"/svm")
                ...
                res_file = open(dir_path_dual_f_approach + "/cluster"+repr(i)+"/svm/results.txt", "a")
                res_file.write("Final RMSE (on projected test data): %0.3f\n" % test_root_mean_squared_error_proj)
                res_file.write("R^2 score (on projected test data): %0.3f\n" % r2score)
                res_file.close()
                ...
                plt.ylabel("dual_f_approach_1")
                plt.legend(loc='upper right')
                plt.savefig(dir_path_dual_f_approach+"/cluster"+repr(i)+"/svm/dual_f_approach_pred.pdf")
                plt.clf()
                #plt.show()
                ...
                if (ldim!=0):
                    # ---------- K-Nearest Neighbors ---------------- #
                    (knn_regressor, r2) = train_knn_regressor_model(n_neighbors = n_neighbors_dual_f_approach,
                                                                weights = weights_dual_f_approach,
                                                                algorithm = algorithm_dual_f_approach,
                                                                training_examples=training_examples,
                                                                training_targets=training_targets.iloc[:,0:ldim],
                                                                model_dir=dir_path_dual_f_approach + "/cluster"+repr(i)+"/knn")
                ...
                res_file = open(dir_path_dual_f_approach + "/cluster"+repr(i)+"/knn/results.txt", "a")
                res_file.write("Final RMSE (on projected test data): %0.3f\n" % test_root_mean_squared_error_proj)
                res_file.write("R^2 score (on projected test data): %0.3f\n" % r2score)
                res_file.close()
                ...
                plt.ylabel("dual_f_approach_1")
                plt.legend(loc='upper right')
                plt.savefig(dir_path_dual_f_approach+"/cluster"+repr(i)+"/knn/dual_f_approach_pred.pdf")
                plt.clf()
                #plt.show()
...
if not outputs_xf_retreat_df.empty:
    # ------------------------- K-means clustering ---------------------------------------- #
    norm_outputs_xf_retreat_df, outputs_xf_retreat_df_max, outputs_xf_retreat_df_min = normalize_linear_scale(outputs_xf_retreat_df)

    if not os.path.exists(dir_path_xf_retreat):
        os.mkdir(dir_path_xf_retreat)
    outputs_xf_retreat_df_max.to_csv(dir_path_xf_retreat+"/xf_retreat_max.csv",sep=',')
    outputs_xf_retreat_df_min.to_csv(dir_path_xf_retreat + "/xf_retreat_min.csv", sep=',')

    xf_retreat = norm_outputs_xf_retreat_df.values

    kmeans = KMeans(n_clusters=n_clusters_xf_retreat,init='k-means++',max_iter=100, n_init=5, verbose=0, random_state=3425)
    # Fitting with inputs
    kmeans_xf_retreat = kmeans.fit(xf_retreat)
    # Predicting the clusters
    labels_xf_retreat = kmeans_xf_retreat.predict(xf_retreat)
    labels_xf_retreat_df = pd.DataFrame(data=labels_xf_retreat)

    # Getting the cluster centers
    C_xf_retreat = kmeans_xf_retreat.cluster_centers_
    if (print_en_xf_retreat):
        fig = plt.figure()
        ax_xf_retreat = Axes3D(fig)
        ax_xf_retreat.scatter(xf_retreat[:, 0], xf_retreat[:, 1], xf_retreat[:, 2], c=labels_xf_retreat)
        #ax_xf_retreat.scatter(C_xf_plan[:, 0], C_xf_plan[:, 1], C_xf_plan[:, 2], marker='*', c='#050505', s=1000)
        ax_xf_retreat.set_xlabel('normalized xf_retreat 1 [rad]')
        ax_xf_retreat.set_ylabel('normalized xf_retreat 2 [rad]')
        ax_xf_retreat.set_zlabel('normalized xf_retreat 3 [rad]')
        ax_xf_retreat.set_title('Clusters of the xf_retreat')
        plt.savefig(dir_path_xf_retreat + "/clusters.pdf")
        plt.clf()
        #plt.show()

    cl_0_inputs_list_xf_retreat = []
    cl_0_inputs_test_list_xf_retreat = []
    cl_0_list_xf_retreat = []
    cl_0_test_list_xf_retreat = []

    cl_1_inputs_list_xf_retreat = []
    cl_1_inputs_test_list_xf_retreat = []
    cl_1_list_xf_retreat = []
    cl_1_test_list_xf_retreat = []

    cl_2_inputs_list_xf_retreat = []
    cl_2_inputs_test_list_xf_retreat = []
    cl_2_list_xf_retreat = []
    cl_2_test_list_xf_retreat = []

    cl_3_inputs_list_xf_retreat = []
    cl_3_inputs_test_list_xf_retreat = []
    cl_3_list_xf_retreat = []
    cl_3_test_list_xf_retreat = []

    cl_4_inputs_list_xf_retreat = []
    cl_4_inputs_test_list_xf_retreat = []
    cl_4_list_xf_retreat = []
    cl_4_test_list_xf_retreat = []

    cl_5_inputs_list_xf_retreat = []
    cl_5_inputs_test_list_xf_retreat = []
    cl_5_list_xf_retreat = []
    cl_5_test_list_xf_retreat = []

    for i in range(len(labels_xf_retreat)):
        cl = labels_xf_retreat[i]
        if cl == 0:
            cl_0_list_xf_retreat.append(norm_outputs_xf_retreat_df.iloc[i])
            cl_0_inputs_list_xf_retreat.append(normalized_inputs.iloc[i])
        elif cl == 1:
            cl_1_list_xf_retreat.append(norm_outputs_xf_retreat_df.iloc[i])
            cl_1_inputs_list_xf_retreat.append(normalized_inputs.iloc[i])
        elif cl == 2:
            cl_2_list_xf_retreat.append(norm_outputs_xf_retreat_df.iloc[i])
            cl_2_inputs_list_xf_retreat.append(normalized_inputs.iloc[i])
        elif cl == 3:
            cl_3_list_xf_retreat.append(norm_outputs_xf_retreat_df.iloc[i])
            cl_3_inputs_list_xf_retreat.append(normalized_inputs.iloc[i])
        elif cl == 4:
            cl_4_list_xf_retreat.append(norm_outputs_xf_retreat_df.iloc[i])
            cl_4_inputs_list_xf_retreat.append(normalized_inputs.iloc[i])
        elif cl == 5:
            cl_5_list_xf_retreat.append(norm_outputs_xf_retreat_df.iloc[i])
            cl_5_inputs_list_xf_retreat.append(normalized_inputs.iloc[i])

    cl_0_inputs_xf_retreat_df = pd.DataFrame(cl_0_inputs_list_xf_retreat, columns=inputs_cols)
    cl_0_xf_retreat_df = pd.DataFrame(cl_0_list_xf_retreat, columns=cols_x_f_retreat)
    cl_1_inputs_xf_retreat_df = pd.DataFrame(cl_1_inputs_list_xf_retreat, columns=inputs_cols)
    cl_1_xf_retreat_df = pd.DataFrame(cl_1_list_xf_retreat, columns=cols_x_f_retreat)
    cl_2_inputs_xf_retreat_df = pd.DataFrame(cl_2_inputs_list_xf_retreat, columns=inputs_cols)
    cl_2_xf_retreat_df = pd.DataFrame(cl_2_list_xf_retreat, columns=cols_x_f_retreat)
    cl_3_inputs_xf_retreat_df = pd.DataFrame(cl_3_inputs_list_xf_retreat, columns=inputs_cols)
    cl_3_xf_retreat_df = pd.DataFrame(cl_3_list_xf_retreat, columns=cols_x_f_retreat)
    cl_4_inputs_xf_retreat_df = pd.DataFrame(cl_4_inputs_list_xf_retreat, columns=inputs_cols)
    cl_4_xf_retreat_df = pd.DataFrame(cl_4_list_xf_retreat, columns=cols_x_f_retreat)
    cl_5_inputs_xf_retreat_df = pd.DataFrame(cl_5_inputs_list_xf_retreat, columns=inputs_cols)
    cl_5_xf_retreat_df = pd.DataFrame(cl_5_list_xf_retreat, columns=cols_x_f_retreat)

    clusters_inputs_xf_retreat = [cl_0_inputs_xf_retreat_df,cl_1_inputs_xf_retreat_df,cl_2_inputs_xf_retreat_df,cl_3_inputs_xf_retreat_df,cl_4_inputs_xf_retreat_df,cl_5_inputs_xf_retreat_df]
    clusters_outputs_xf_retreat = [cl_0_xf_retreat_df,cl_1_xf_retreat_df,cl_2_xf_retreat_df,cl_3_xf_retreat_df,cl_4_xf_retreat_df,cl_5_xf_retreat_df]

    # save the dataframes of each cluster
    # cluster 0
    if not os.path.exists(dir_path_xf_retreat+"/cluster0"):
        os.mkdir(dir_path_xf_retreat+"/cluster0")
    cl_0_inputs_xf_retreat_df.to_csv(dir_path_xf_retreat+"/cluster0/inputs.csv",sep=',',index=False)
    cl_0_xf_retreat_df.to_csv(dir_path_xf_retreat + "/cluster0/outputs.csv", sep=',',index=False)
    # cluster 1
    if not os.path.exists(dir_path_xf_retreat+"/cluster1"):
        os.mkdir(dir_path_xf_retreat+"/cluster1")
    cl_1_inputs_xf_retreat_df.to_csv(dir_path_xf_retreat+"/cluster1/inputs.csv",sep=',',index=False)
    cl_1_xf_retreat_df.to_csv(dir_path_xf_retreat + "/cluster1/outputs.csv", sep=',',index=False)
    # cluster 2
    if not os.path.exists(dir_path_xf_retreat+"/cluster2"):
        os.mkdir(dir_path_xf_retreat+"/cluster2")
    cl_2_inputs_xf_retreat_df.to_csv(dir_path_xf_retreat+"/cluster2/inputs.csv",sep=',',index=False)
    cl_2_xf_retreat_df.to_csv(dir_path_xf_retreat + "/cluster2/outputs.csv", sep=',',index=False)
    # cluster 3
    if not os.path.exists(dir_path_xf_retreat+"/cluster3"):
        os.mkdir(dir_path_xf_retreat+"/cluster3")
    cl_3_inputs_xf_retreat_df.to_csv(dir_path_xf_retreat+"/cluster3/inputs.csv",sep=',',index=False)
    cl_3_xf_retreat_df.to_csv(dir_path_xf_retreat + "/cluster3/outputs.csv", sep=',',index=False)
    # cluster 4
    if not os.path.exists(dir_path_xf_retreat+"/cluster4"):
        os.mkdir(dir_path_xf_retreat+"/cluster4")
    cl_4_inputs_xf_retreat_df.to_csv(dir_path_xf_retreat+"/cluster4/inputs.csv",sep=',',index=False)
    cl_4_xf_retreat_df.to_csv(dir_path_xf_retreat + "/cluster4/outputs.csv", sep=',',index=False)
    # cluster 5
    if not os.path.exists(dir_path_xf_retreat+"/cluster5"):
        os.mkdir(dir_path_xf_retreat+"/cluster5")
    cl_5_inputs_xf_retreat_df.to_csv(dir_path_xf_retreat+"/cluster5/inputs.csv",sep=',',index=False)
    cl_5_xf_retreat_df.to_csv(dir_path_xf_retreat + "/cluster5/outputs.csv", sep=',',index=False)

    if (print_en_xf_retreat):
        print("Cluster 0:")
        print(cl_0_inputs_xf_retreat_df.describe())
        print(cl_0_xf_retreat_df.describe())
        print("Cluster 1:")
        print(cl_1_inputs_xf_retreat_df.describe())
        print(cl_1_xf_retreat_df.describe())
        print("Cluster 2:")
        print(cl_2_inputs_xf_retreat_df.describe())
        print(cl_2_xf_retreat_df.describe())
        print("Cluster 3:")
        print(cl_3_inputs_xf_retreat_df.describe())
        print(cl_3_xf_retreat_df.describe())
        print("Cluster 4:")
        print(cl_4_inputs_xf_retreat_df.describe())
        print(cl_4_xf_retreat_df.describe())
        print("Cluster 5:")
        print(cl_5_inputs_xf_retreat_df.describe())
        print(cl_5_xf_retreat_df.describe())

    # ---------------------------------- Classifier training ------------------------------------------------------------#
    if (train_xf_retreat_class):

        if not os.path.exists(dir_path_xf_retreat + "/classification"):
            os.mkdir(dir_path_xf_retreat + "/classification")
        if not os.path.exists(dir_path_xf_retreat + "/classification/nn"):
            os.mkdir(dir_path_xf_retreat + "/classification/nn")
        if not os.path.exists(dir_path_xf_retreat + "/classification/svm"):
            os.mkdir(dir_path_xf_retreat + "/classification/svm")
        if not os.path.exists(dir_path_xf_retreat + "/classification/knn"):
            os.mkdir(dir_path_xf_retreat + "/classification/knn")
        ...
        # Choose the first 70% examples for training.
        training_examples_class = normalized_inputs.iloc[:train, :]
        training_targets_class = labels_xf_retreat_df.iloc[:train, :]

        # Choose the last 20%  examples for validation.
        validation_examples_class = normalized_inputs.iloc[train:val, :]
        validation_targets_class = labels_xf_retreat_df.iloc[train:val, :]

        # Choose the examples for test. 10%
        test_examples_class = normalized_inputs.iloc[val:, :]
        test_targets_class = labels_xf_retreat_df.iloc[val:, :]
        ...
        (nn_classifier, training_log_losses, validation_log_losses) = train_nn_classifier_model(
                                        ...
                                        periods=periods_xf_retreat_class,
                                        steps=steps_xf_retreat_class,
                                        batch_size=batch_size_xf_retreat_class,
        ...
        res_file = open(dir_path_xf_retreat + "/classification/nn/results.txt", "a")
        res_file.write("LogLoss (on test data): %0.3f\n" % test_log_loss)
        res_file.write("Average loss on the test set: %0.3f\n" % evaluation_metrics['average_loss'])
        res_file.write("Accuracy on the test set: %0.3f\n" % evaluation_metrics['accuracy'])
        res_file.close()
        ...
        # ---------- Support Vector Machine ---------- #
        (svm_classifier, scores) = train_svm_classifier_model(kernel = kernel_class_xf_retreat,
                                                          cv = n_cv_xf_retreat,
                                                          training_examples_class_list = training_examples_class_list,
                                                          training_targets_class_list = training_targets_class_list,
                                                          model_dir = dir_path_xf_retreat + "/classification/svm")


        test_targets_class_pred = svm_classifier.predict(test_examples_class_list)
        report = classification_report(test_targets_class_list, test_targets_class_pred)
        #print(report)
        classification_report_csv(report = report,model_dir = dir_path_xf_retreat + "/classification/svm")
        acc_test = accuracy_score(test_targets_class_list, test_targets_class_pred, normalize=True, sample_weight=None)
        print("Accuracy on the test set: %0.3f " % acc_test)

        res_file = open(dir_path_xf_retreat + "/classification/svm/results.txt", "a")
        res_file.write("Accuracy on the test set: %0.3f \n" % acc_test)
        res_file.close()

        # ---------- K-Nearest Neighbors ---------- #
        (knn_classifier, scores) = train_knn_classifier_model(n_neighbors = n_neighbors_class_xf_retreat,
                                                          cv = n_cv_xf_retreat,
                                                          weights = weights_class_xf_retreat ,
                                                          algorithm = algorithm_class_xf_retreat,
                                                          training_examples_class_list = training_examples_class_list,
                                                          training_targets_class_list = training_targets_class_list,
                                                          model_dir = dir_path_xf_retreat + "/classification/knn")


        test_targets_class_pred = knn_classifier.predict(test_examples_class_list)
        report = classification_report(test_targets_class_list, test_targets_class_pred)
        #print(report)
        classification_report_csv(report = report,model_dir = dir_path_xf_retreat + "/classification/knn")
        acc_test = accuracy_score(test_targets_class_list, test_targets_class_pred, normalize=True, sample_weight=None)
        print("Accuracy on the test set: %0.3f " % acc_test)

        res_file = open(dir_path_xf_retreat + "/classification/knn/results.txt", "a")
        res_file.write("Accuracy on the test set: %0.3f \n" % acc_test)
        res_file.close()
    ...
    if (train_xf_retreat):
        # ----------------------------------------------- PCA  and regression on each cluster --------------------------------------- #
        for i in range(0,n_clusters_xf_retreat):
            cl_in_xf_retreat_df = clusters_inputs_xf_retreat[i]
            cl_out_xf_retreat_df = clusters_outputs_xf_retreat[i]
            if (len(cl_out_xf_retreat_df.index) > min_cluster_size_xf_retreat):
                n_comps = 7  # at least 95% of the information with 3 components
                X_f_retreat = cl_out_xf_retreat_df.values
                pca_xf_retreat = decomposition.PCA(n_components=n_comps)
                pc = pca_xf_retreat.fit_transform(X_f_retreat)
                pc_df = pd.DataFrame(data=pc, columns=cols_x_f_retreat[0:n_comps])
                if (print_en_xf_retreat):
                    print(pca_xf_retreat.n_components_)
                    print(pca_xf_retreat.components_)
                    print(pc_df.describe())
                    print(pca_xf_retreat.explained_variance_ratio_)
                    print(pca_xf_retreat.explained_variance_ratio_.sum())
                    df = pd.DataFrame({'var': pca_xf_retreat.explained_variance_ratio_, 'PC': cols_x_f_retreat[0:n_comps]})

                    pc_file = open(dir_path_xf_retreat+"/cluster"+repr(i)+"/p_comps.csv", "w")
                    pc_file.write("### Principal components ###\n")
                    pc_file.write(df.iloc[0, 0]+", ")
                    pc_file.write(df.iloc[1, 0] + ", ")
                    pc_file.write(df.iloc[2, 0] + ", ")
                    ...
                    sns_plot = sns.barplot(x='PC', y="var", data=df, color="c")
                    fig_pc = sns_plot.get_figure()
                    fig_pc.savefig(dir_path_xf_retreat+"/cluster"+repr(i)+"/p_comps.pdf")
                    threedee_train = plt.figure().gca(projection='3d')
                    threedee_train.scatter(cl_in_xf_retreat_df["target_x_mm"], cl_in_xf_retreat_df["target_y_mm"], pc_df['xf_retreat_1_rad'])
                    plt.clf()
                    #plt.show()

                # ---------------------------- regression --------------------------------- #
                size = len(cl_out_xf_retreat_df.index)
                inputs_df, inputs_df_max, inputs_df_min = normalize_linear_scale(cl_in_xf_retreat_df)
                outputs_df = pc_df

                if not os.path.exists(dir_path_xf_retreat + "/cluster"+repr(i)):
                    os.mkdir(dir_path_xf_retreat + "/cluster"+repr(i))
                if not os.path.exists(dir_path_xf_retreat + "/cluster"+repr(i)+"/nn"):
                    os.mkdir(dir_path_xf_retreat + "/cluster"+repr(i)+"/nn")
                if not os.path.exists(dir_path_xf_retreat + "/cluster"+repr(i)+"/svm"):
                    os.mkdir(dir_path_xf_retreat + "/cluster"+repr(i)+"/svm")
                if not os.path.exists(dir_path_xf_retreat + "/cluster"+repr(i)+"/knn"):
                    os.mkdir(dir_path_xf_retreat + "/cluster"+repr(i)+"/knn")
                ...
                test_examples = inputs_df.iloc[val:, :]
                # test_targets = outputs_df_0.iloc[val:, tar:tar_end]
                test_targets = cl_out_xf_retreat_df.iloc[val:, :]
                ...
                for j in range(0, dim):
                    if (math.sqrt(math.pow((training_targets.iloc[0:, j].quantile(0.25) - training_targets.iloc[0:, j].quantile(0.75)),2)) <= th_xf_retreat):
                        if (test_predictions_1.size == 0):
                            test_predictions_1 = np.full((test_targets.shape[0], 1),training_targets.iloc[0:, j].mean())
                        else:
                            test_predictions_1 = np.concatenate([test_predictions_1, np.full((test_targets.shape[0], 1),training_targets.iloc[0:,j].mean())], axis=1)
                ...
                if (ldim != 0):
                    ...
                    nn_regressor, training_rmses, validation_rmses = train_nn_regressor_model(
                                                                        my_optimizer=tf.train.AdamOptimizer(learning_rate=learning_rate),
                                                                        dimensions=ldim,
                                                                        periods=periods_xf_retreat,
                                                                        steps=steps_xf_retreat,
                                                                        batch_size=batch_size_xf_retreat,
                                                                        hidden_units=units_xf_retreat,
                                                                        training_examples=training_examples,
                                                                        training_targets=training_targets[train_col_names_1],
                                                                        validation_examples=validation_examples,
                                                                        validation_targets=validation_targets[train_col_names_1],
                                                                        model_dir=dir_path_xf_retreat+"/cluster"+repr(i)+"/nn")
                ...
                denorm_test_targets = denormalize_linear_scale(test_targets, outputs_xf_retreat_df_max, outputs_xf_retreat_df_min)
                ...
                res_file = open(dir_path_xf_retreat+"/cluster"+repr(i)+"/nn/results.txt", "a")
                res_file.write("RMSE (on test data):   %0.3f\n" % test_root_mean_squared_error_proj)
                res_file.write("R^2 score (on projected test data): %0.3f\n" % r2score)
                res_file.close()
                ...
                fig = plt.figure()
                ax1 = fig.add_subplot(111)
                ax1.scatter(denorm_test_targets["xf_retreat_1_rad"], denorm_test_targets["xf_retreat_2_rad"], s=10, c='b', marker="s", label='test_targets')
                ax1.scatter(denorm_test_predictions_df["xf_retreat_1_rad"], denorm_test_predictions_df["xf_retreat_2_rad"], s=10, c='r', marker="o", label='test_predictions')
                plt.xlabel("xf_retreat_1_rad")
                plt.ylabel("xf_retreat_2_rad")
                plt.legend(loc='upper right')
                plt.savefig(dir_path_xf_retreat+"/cluster"+repr(i)+"/nn/xf_pred.pdf")
                plt.clf()
                #plt.show()
                ...
                if(ldim!=0):
                    # ---------- Support Vector Machine ---------------- #
                    (svm_regressor, r2) = train_svm_regressor_model(kernel=kernel_xf_retreat,
                                                                gamma=gamma_xf_retreat,
                                                                coeff=coeff_xf_retreat,
                                                                degree=degree_xf_retreat,
                                                                epsilon=epsilon_xf_retreat,
                                                                training_examples=training_examples,
                                                                training_targets=training_targets.iloc[:,0:ldim],
                                                                model_dir=dir_path_xf_retreat + "/cluster"+repr(i)+"/svm")
                ...
                res_file = open(dir_path_xf_retreat + "/cluster"+repr(i)+"/svm/results.txt", "a")
                res_file.write("Final RMSE (on projected test data): %0.3f\n" % test_root_mean_squared_error_proj)
                res_file.write("R^2 score (on projected test data): %0.3f\n" % r2score)
                res_file.close()
                ...
                plt.ylabel("xf_retreat_2_rad")
                plt.legend(loc='upper right')
                plt.savefig(dir_path_xf_retreat+"/cluster"+repr(i)+"/svm/xf_pred.pdf")
                plt.clf()
                #plt.show()
                ...
                if(ldim!=0):
                    # ---------- K-Nearest Neighbors ---------------- #
                    (knn_regressor, r2) = train_knn_regressor_model(n_neighbors = n_neighbors_xf_retreat,
                                                                weights = weights_xf_retreat,
                                                                algorithm = algorithm_xf_retreat,
                                                                training_examples=training_examples,
                                                                training_targets=training_targets.iloc[:,0:ldim],
                                                                model_dir=dir_path_xf_retreat + "/cluster"+repr(i)+"/knn")
                ...
                res_file = open(dir_path_xf_retreat + "/cluster"+repr(i)+"/knn/results.txt", "a")
                res_file.write("Final RMSE (on projected test data): %0.3f\n" % test_root_mean_squared_error_proj)
                res_file.write("R^2 score (on projected test data): %0.3f\n" % r2score)
                res_file.close()
                ...
                plt.ylabel("xf_retreat_2_rad")
                plt.legend(loc='upper right')
                plt.savefig(dir_path_xf_retreat+"/cluster"+repr(i)+"/knn/xf_pred.pdf")
                plt.clf()
                #plt.show()
...
if not outputs_zf_L_retreat_df.empty:
    # ------------------------- K-means clustering ---------------------------------------- #
    norm_outputs_zf_L_retreat_df, outputs_zf_L_retreat_df_max, outputs_zf_L_retreat_df_min = normalize_linear_scale(outputs_zf_L_retreat_df)

    if not os.path.exists(dir_path_zf_L_retreat):
        os.mkdir(dir_path_zf_L_retreat)
    outputs_zf_L_retreat_df_max.to_csv(dir_path_zf_L_retreat+"/zf_L_retreat_max.csv",sep=',')
    outputs_zf_L_retreat_df_min.to_csv(dir_path_zf_L_retreat +"/zf_L_retreat_min.csv",sep=',')

    zf_L_retreat = norm_outputs_zf_L_retreat_df.values

    kmeans = KMeans(n_clusters=n_clusters_zf_L_retreat, init='k-means++', max_iter=100, n_init=5, verbose=0, random_state=3425)
    # Fitting with inputs
    kmeans_zf_L_retreat = kmeans.fit(zf_L_retreat)
    # Predicting the clusters
    labels_zf_L_retreat = kmeans_zf_L_retreat.predict(zf_L_retreat)
    labels_zf_L_retreat_df = pd.DataFrame(data=labels_zf_L_retreat)

    # Getting the cluster centers
    C_zf_L_retreat = kmeans_zf_L_retreat.cluster_centers_
    if (print_en_zf_L_retreat):
        fig = plt.figure()
        ax_zf_L_retreat = fig.add_subplot(111)
        ax_zf_L_retreat.scatter(normalized_inputs["target_x_mm"],zf_L_retreat, s=10, c=labels_zf_L_retreat, marker="s")
        ax_zf_L_retreat.set_xlabel("target_x_mm")
        ax_zf_L_retreat.set_ylabel("zf_L_retreat_4")
        plt.savefig(dir_path_zf_L_retreat + "/clusters.pdf")
        plt.clf()
        #plt.show()

    cl_0_inputs_list_zf_L_retreat = []
    cl_0_inputs_test_list_zf_L_retreat = []
    cl_0_list_zf_L_retreat = []
    cl_0_test_list_zf_L_retreat = []

    cl_1_inputs_list_zf_L_retreat = []
    cl_1_inputs_test_list_zf_L_retreat = []
    cl_1_list_zf_L_retreat = []
    cl_1_test_list_zf_L_retreat = []

    cl_2_inputs_list_zf_L_retreat = []
    cl_2_inputs_test_list_zf_L_retreat = []
    cl_2_list_zf_L_retreat = []
    cl_2_test_list_zf_L_retreat = []

    cl_3_inputs_list_zf_L_retreat = []
    cl_3_inputs_test_list_zf_L_retreat = []
    cl_3_list_zf_L_retreat = []
    cl_3_test_list_zf_L_retreat = []

    cl_4_inputs_list_zf_L_retreat = []
    cl_4_inputs_test_list_zf_L_retreat = []
    cl_4_list_zf_L_retreat = []
    cl_4_test_list_zf_L_retreat = []

    cl_5_inputs_list_zf_L_retreat = []
    cl_5_inputs_test_list_zf_L_retreat = []
    cl_5_list_zf_L_retreat = []
    cl_5_test_list_zf_L_retreat = []

    for i in range(len(labels_zf_L_retreat)):
        cl = labels_zf_L_retreat[i]
        if cl == 0:
            cl_0_list_zf_L_retreat.append(norm_outputs_zf_L_retreat_df.iloc[i])
            cl_0_inputs_list_zf_L_retreat.append(normalized_inputs.iloc[i])
        elif cl == 1:
            cl_1_list_zf_L_retreat.append(norm_outputs_zf_L_retreat_df.iloc[i])
            cl_1_inputs_list_zf_L_retreat.append(normalized_inputs.iloc[i])
        elif cl == 2:
            cl_2_list_zf_L_retreat.append(norm_outputs_zf_L_retreat_df.iloc[i])
            cl_2_inputs_list_zf_L_retreat.append(normalized_inputs.iloc[i])
        elif cl == 3:
            cl_3_list_zf_L_retreat.append(norm_outputs_zf_L_retreat_df.iloc[i])
            cl_3_inputs_list_zf_L_retreat.append(normalized_inputs.iloc[i])
        elif cl == 4:
            cl_4_list_zf_L_retreat.append(norm_outputs_zf_L_retreat_df.iloc[i])
            cl_4_inputs_list_zf_L_retreat.append(normalized_inputs.iloc[i])
        elif cl == 5:
            cl_5_list_zf_L_retreat.append(norm_outputs_zf_L_retreat_df.iloc[i])
            cl_5_inputs_list_zf_L_retreat.append(normalized_inputs.iloc[i])

    cl_0_inputs_zf_L_retreat_df = pd.DataFrame(cl_0_inputs_list_zf_L_retreat, columns=inputs_cols)
    cl_0_zf_L_retreat_df = pd.DataFrame(cl_0_list_zf_L_retreat, columns=cols_zf_L_retreat)
    cl_1_inputs_zf_L_retreat_df = pd.DataFrame(cl_1_inputs_list_zf_L_retreat, columns=inputs_cols)
    cl_1_zf_L_retreat_df = pd.DataFrame(cl_1_list_zf_L_retreat, columns=cols_zf_L_retreat)
    cl_2_inputs_zf_L_retreat_df = pd.DataFrame(cl_2_inputs_list_zf_L_retreat, columns=inputs_cols)
    cl_2_zf_L_retreat_df = pd.DataFrame(cl_2_list_zf_L_retreat, columns=cols_zf_L_retreat)
    cl_3_inputs_zf_L_retreat_df = pd.DataFrame(cl_3_inputs_list_zf_L_retreat, columns=inputs_cols)
    cl_3_zf_L_retreat_df = pd.DataFrame(cl_3_list_zf_L_retreat, columns=cols_zf_L_retreat)
    cl_4_inputs_zf_L_retreat_df = pd.DataFrame(cl_4_inputs_list_zf_L_retreat, columns=inputs_cols)
    cl_4_zf_L_retreat_df = pd.DataFrame(cl_4_list_zf_L_retreat, columns=cols_zf_L_retreat)
    cl_5_inputs_zf_L_retreat_df = pd.DataFrame(cl_5_inputs_list_zf_L_retreat, columns=inputs_cols)
    cl_5_zf_L_retreat_df = pd.DataFrame(cl_5_list_zf_L_retreat, columns=cols_zf_L_retreat)

    clusters_inputs_zf_L_retreat = [cl_0_inputs_zf_L_retreat_df,cl_1_inputs_zf_L_retreat_df,cl_2_inputs_zf_L_retreat_df,cl_3_inputs_zf_L_retreat_df,cl_4_inputs_zf_L_retreat_df,cl_5_inputs_zf_L_retreat_df]
    clusters_outputs_zf_L_retreat = [cl_0_zf_L_retreat_df,cl_1_zf_L_retreat_df,cl_2_zf_L_retreat_df,cl_3_zf_L_retreat_df,cl_4_zf_L_retreat_df,cl_5_zf_L_retreat_df]

    # save the dataframes of each cluster
    # cluster 0
    if not os.path.exists(dir_path_zf_L_retreat + "/cluster0"):
        os.mkdir(dir_path_zf_L_retreat + "/cluster0")
    cl_0_inputs_zf_L_retreat_df.to_csv(dir_path_zf_L_retreat + "/cluster0/inputs.csv", sep=',', index=False)
    cl_0_zf_L_retreat_df.to_csv(dir_path_zf_L_retreat + "/cluster0/outputs.csv", sep=',', index=False)
    # cluster 1
    if not os.path.exists(dir_path_zf_L_retreat + "/cluster1"):
        os.mkdir(dir_path_zf_L_retreat + "/cluster1")
    cl_1_inputs_zf_L_retreat_df.to_csv(dir_path_zf_L_retreat + "/cluster1/inputs.csv", sep=',', index=False)
    cl_1_zf_L_retreat_df.to_csv(dir_path_zf_L_retreat + "/cluster1/outputs.csv", sep=',', index=False)
    # cluster 2
    if not os.path.exists(dir_path_zf_L_retreat + "/cluster2"):
        os.mkdir(dir_path_zf_L_retreat + "/cluster2")
    cl_2_inputs_zf_L_retreat_df.to_csv(dir_path_zf_L_retreat + "/cluster2/inputs.csv", sep=',', index=False)
    cl_2_zf_L_retreat_df.to_csv(dir_path_zf_L_retreat + "/cluster2/outputs.csv", sep=',', index=False)
    # cluster 3
    if not os.path.exists(dir_path_zf_L_retreat + "/cluster3"):
        os.mkdir(dir_path_zf_L_retreat + "/cluster3")
    cl_3_inputs_zf_L_retreat_df.to_csv(dir_path_zf_L_retreat + "/cluster3/inputs.csv", sep=',', index=False)
    cl_3_zf_L_retreat_df.to_csv(dir_path_zf_L_retreat + "/cluster3/outputs.csv", sep=',', index=False)
    # cluster 4
    if not os.path.exists(dir_path_zf_L_retreat + "/cluster4"):
        os.mkdir(dir_path_zf_L_retreat + "/cluster4")
    cl_4_inputs_zf_L_retreat_df.to_csv(dir_path_zf_L_retreat + "/cluster4/inputs.csv", sep=',', index=False)
    cl_4_zf_L_retreat_df.to_csv(dir_path_zf_L_retreat + "/cluster4/outputs.csv", sep=',', index=False)
    # cluster 5
    if not os.path.exists(dir_path_zf_L_retreat + "/cluster5"):
        os.mkdir(dir_path_zf_L_retreat + "/cluster5")
    cl_5_inputs_zf_L_retreat_df.to_csv(dir_path_zf_L_retreat + "/cluster5/inputs.csv", sep=',', index=False)
    cl_5_zf_L_retreat_df.to_csv(dir_path_zf_L_retreat + "/cluster5/outputs.csv", sep=',', index=False)

    if (print_en_zf_L_retreat):
        print("Cluster 0:")
        print(cl_0_inputs_zf_L_retreat_df.describe())
        print(cl_0_zf_L_retreat_df.describe())
        print("Cluster 1:")
        print(cl_1_inputs_zf_L_retreat_df.describe())
        print(cl_1_zf_L_retreat_df.describe())
        print("Cluster 2:")
        print(cl_2_inputs_zf_L_retreat_df.describe())
        print(cl_2_zf_L_retreat_df.describe())
        print("Cluster 3:")
        print(cl_3_inputs_zf_L_retreat_df.describe())
        print(cl_3_zf_L_retreat_df.describe())
        print("Cluster 4:")
        print(cl_4_inputs_zf_L_retreat_df.describe())
        print(cl_4_zf_L_retreat_df.describe())
        print("Cluster 5:")
        print(cl_5_inputs_zf_L_retreat_df.describe())
        print(cl_5_zf_L_retreat_df.describe())

    # ---------------------------------- Classifier training ------------------------------------------------------------#
    if (train_zf_L_retreat_class):

        if not os.path.exists(dir_path_zf_L_retreat + "/classification"):
            os.mkdir(dir_path_zf_L_retreat + "/classification")
        if not os.path.exists(dir_path_zf_L_retreat + "/classification/nn"):
            os.mkdir(dir_path_zf_L_retreat + "/classification/nn")
        if not os.path.exists(dir_path_zf_L_retreat + "/classification/svm"):
            os.mkdir(dir_path_zf_L_retreat + "/classification/svm")
        if not os.path.exists(dir_path_zf_L_retreat + "/classification/knn"):
            os.mkdir(dir_path_zf_L_retreat + "/classification/knn")
        ...
        # Choose the first 70% examples for training.
        training_examples_class = normalized_inputs.iloc[:train, :]
        training_targets_class = labels_zf_L_retreat_df.iloc[:train, :]

        # Choose the last 20%  examples for validation.
        validation_examples_class = normalized_inputs.iloc[train:val, :]
        validation_targets_class = labels_zf_L_retreat_df.iloc[train:val, :]

        # Choose the examples for test. 10%
        test_examples_class = normalized_inputs.iloc[val:, :]
        test_targets_class = labels_zf_L_retreat_df.iloc[val:, :]
        ...
        (nn_classifier, training_log_losses, validation_log_losses) = train_nn_classifier_model(
                                        ...
                                        periods=periods_zf_L_retreat_class,
                                        steps=steps_zf_L_retreat_class,
                                        batch_size=batch_size_zf_L_retreat_class,
        ...
        res_file = open(dir_path_zf_L_retreat + "/classification/nn/results.txt", "a")
        res_file.write("LogLoss (on test data): %0.3f\n" % test_log_loss)
        res_file.write("Average loss on the test set: %0.3f\n" % evaluation_metrics['average_loss'])
        res_file.write("Accuracy on the test set: %0.3f\n" % evaluation_metrics['accuracy'])
        res_file.close()
        ...
        # ---------- Support Vector Machine ---------- #
        (svm_classifier, scores) = train_svm_classifier_model(kernel = kernel_class_zf_L_retreat,
                                                              cv = n_cv_zf_L_retreat,
                                                              training_examples_class_list = training_examples_class_list,
                                                              training_targets_class_list = training_targets_class_list,
                                                              model_dir = dir_path_zf_L_retreat + "/classification/svm")


        test_targets_class_pred = svm_classifier.predict(test_examples_class_list)
        report = classification_report(test_targets_class_list, test_targets_class_pred)
        #print(report)
        classification_report_csv(report = report,model_dir = dir_path_zf_L_retreat + "/classification/svm")
        acc_test = accuracy_score(test_targets_class_list, test_targets_class_pred, normalize=True, sample_weight=None)
        print("Accuracy on the test set: %0.3f " % acc_test)

        res_file = open(dir_path_zf_L_retreat + "/classification/svm/results.txt", "a")
        res_file.write("Accuracy on the test set: %0.3f \n" % acc_test)
        res_file.close()

        # ---------- K-Nearest Neighbors ---------- #
        (knn_classifier, scores) = train_knn_classifier_model(n_neighbors = n_neighbors_class_zf_L_retreat,
                                                              cv = n_cv_zf_L_retreat,
                                                              weights = weights_class_zf_L_retreat ,
                                                              algorithm = algorithm_class_zf_L_retreat,
                                                              training_examples_class_list = training_examples_class_list,
                                                              training_targets_class_list = training_targets_class_list,
                                                              model_dir = dir_path_zf_L_retreat + "/classification/knn")


        test_targets_class_pred = knn_classifier.predict(test_examples_class_list)
        report = classification_report(test_targets_class_list, test_targets_class_pred)
        #print(report)
        classification_report_csv(report = report,model_dir = dir_path_zf_L_retreat + "/classification/knn")
        acc_test = accuracy_score(test_targets_class_list, test_targets_class_pred, normalize=True, sample_weight=None)
        print("Accuracy on the test set: %0.3f " % acc_test)

        res_file = open(dir_path_zf_L_retreat + "/classification/knn/results.txt", "a")
        res_file.write("Accuracy on the test set: %0.3f \n" % acc_test)
        res_file.close()

    if (train_zf_L_retreat):
        # ----------------------------------------------- PCA  and regression on each cluster --------------------------------------- #
        for i in range(0,n_clusters_zf_L_retreat):
            cl_in_zf_L_retreat_df = clusters_inputs_zf_L_retreat[i]
            cl_out_zf_L_retreat_df = clusters_outputs_zf_L_retreat[i]
            if (len(cl_out_zf_L_retreat_df.index) > min_cluster_size_zf_L_retreat):
                if (len(cl_out_zf_L_retreat_df.columns) > 4):
                    n_comps = 4  # at least 95% of the information with 3 components
                    Z_f_L_retreat = cl_out_zf_L_retreat_df.values
                    pca_zf_L_retreat = decomposition.PCA(n_components=n_comps)
                    pc = pca_zf_L_retreat.fit_transform(Z_f_L_retreat)
                    pc_df = pd.DataFrame(data=pc, columns=cols_zf_L_retreat[0:n_comps])
                    if (print_en_zf_L_retreat):
                        print(pca_zf_L_retreat.n_components_)
                        print(pca_zf_L_retreat.components_)
                        print(pc_df.describe())
                        print(pca_zf_L_retreat.explained_variance_ratio_)
                        print(pca_zf_L_retreat.explained_variance_ratio_.sum())
                        df = pd.DataFrame({'var': pca_zf_L_retreat.explained_variance_ratio_, 'PC': cols_zf_L_retreat[0:n_comps]})

                        pc_file = open(dir_path_zf_L_retreat+"/cluster"+repr(i)+"/p_comps.csv", "w")
                        pc_file.write("### Principal components ###\n")
                        pc_file.write(df.iloc[0, 0]+", ")
                        pc_file.write(df.iloc[1, 0] + ", ")
                        pc_file.write(df.iloc[2, 0] + ", ")
                        ...
                        sns_plot = sns.barplot(x='PC', y="var", data=df, color="c")
                        fig_pc = sns_plot.get_figure()
                        fig_pc.savefig(dir_path_zf_L_retreat+"/cluster"+repr(i)+"/p_comps.pdf")
                        threedee_train = plt.figure().gca(projection='3d')
                        threedee_train.scatter(cl_in_zf_L_retreat_df["target_x_mm"], cl_in_zf_L_retreat_df["target_y_mm"], pc_df['zf_L_retreat_2'])
                        plt.clf()
                        #plt.show()
                else:
                    pc_df = cl_out_zf_L_retreat_df
                    n_comps = len(cl_out_zf_L_retreat_df.columns)

                # ---------------------------- regression --------------------------------- #
                size = len(cl_out_zf_L_retreat_df.index)
                inputs_df, inputs_df_max, inputs_df_min = normalize_linear_scale(cl_in_zf_L_retreat_df)
                outputs_df = pc_df

                if not os.path.exists(dir_path_zf_L_retreat + "/cluster"+repr(i)):
                    os.mkdir(dir_path_zf_L_retreat + "/cluster"+repr(i))
                if not os.path.exists(dir_path_zf_L_retreat + "/cluster"+repr(i)+"/nn"):
                    os.mkdir(dir_path_zf_L_retreat + "/cluster"+repr(i)+"/nn")
                if not os.path.exists(dir_path_zf_L_retreat + "/cluster"+repr(i)+"/svm"):
                    os.mkdir(dir_path_zf_L_retreat + "/cluster"+repr(i)+"/svm")
                if not os.path.exists(dir_path_zf_L_retreat + "/cluster"+repr(i)+"/knn"):
                    os.mkdir(dir_path_zf_L_retreat + "/cluster"+repr(i)+"/knn")
                ...
                test_examples = inputs_df.iloc[val:, :]
                # test_targets = outputs_df_0.iloc[val:, tar:tar_end]
                test_targets = cl_out_zf_L_retreat_df.iloc[val:, :]
                ...
                for j in range(0, dim):
                    if (math.sqrt(math.pow((training_targets.iloc[0:, j].quantile(0.25) - training_targets.iloc[0:, j].quantile(0.75)),2)) <= th_zf_L_retreat):
                        if (test_predictions_1.size == 0):
                            test_predictions_1 = np.full((test_targets.shape[0], 1),training_targets.iloc[0:, j].mean())
                        else:
                            test_predictions_1 = np.concatenate([test_predictions_1, np.full((test_targets.shape[0], 1),training_targets.iloc[0:,j].mean())], axis=1)
                ...
                if (ldim != 0):
                    ...
                    nn_regressor, training_rmses, validation_rmses = train_nn_regressor_model(
                                            my_optimizer=tf.train.AdamOptimizer(learning_rate=learning_rate),
                                            dimensions=ldim,
                                            periods=periods_zf_L_retreat,
                                            steps=steps_zf_L_retreat,
                                            batch_size=batch_size_zf_L_retreat,
                                            hidden_units=units_zf_L_retreat,
                                            training_examples=training_examples,
                                            training_targets=training_targets[train_col_names_1],
                                            validation_examples=validation_examples,
                                            validation_targets=validation_targets[train_col_names_1],
                                            model_dir=dir_path_zf_L_retreat+"/cluster"+repr(i)+"/nn")
                ...
                if (len(cl_out_zf_L_retreat_df.columns) > 4):
                    # test_predictions_df = denormalize_linear_scale(test_predictions_df, outputs_df_0_max,outputs_df_0_min)
                    test_predictions = test_predictions_df.values
                    test_predictions_proj = pca_zf_L_retreat.inverse_transform(test_predictions)
                    test_proj_df = pd.DataFrame(data=test_predictions_proj, columns=cols_zf_L_retreat)
                    denorm_test_predictions_df = denormalize_linear_scale(test_proj_df, outputs_zf_L_retreat_df_max, outputs_zf_L_retreat_df_min)
                else:
                ...
                denorm_test_targets = denormalize_linear_scale(test_targets, outputs_zf_L_retreat_df_max, outputs_zf_L_retreat_df_min)
                test_root_mean_squared_error_proj = math.sqrt(metrics.mean_squared_error(denorm_test_predictions_df, denorm_test_targets))
                print("Cluster "+repr(i)+". Final RMSE (on projected test data): %0.3f" % test_root_mean_squared_error_proj)
                r2score = r2_score(denorm_test_targets, denorm_test_predictions_df)
                print("Cluster " + repr(i) + ". R^2 score (on projected test data): %0.3f" % r2score)

                res_file = open(dir_path_zf_L_retreat+"/cluster"+repr(i)+"/nn/results.txt", "a")
                res_file.write("Final RMSE (on test data):   %0.3f\n" % test_root_mean_squared_error_proj)
                res_file.write("R^2 score (on projected test data): %0.3f\n" % r2score)
                res_file.close()
                ...
                fig = plt.figure()
                ax1 = fig.add_subplot(111)
                ax1.scatter(test_examples["target_x_mm"], denorm_test_targets["zf_L_retreat_2"], s=10, c='b', marker="s",label='test_targets')
                ax1.scatter(test_examples["target_x_mm"], denorm_test_predictions_df["zf_L_retreat_2"], s=10, c='r', marker="o", label='test_predictions')
                plt.xlabel("normalized target_x [mm]")
                plt.ylabel("zf_L_retreat_2")
                plt.legend(loc='upper right')
                #plt.title()
                plt.savefig(dir_path_zf_L_retreat+"/cluster"+repr(i)+"/nn/zf_L_pred.pdf")
                plt.clf()
                #plt.show()
                ...
                if(ldim!=0):
                    # ---------- Support Vector Machine ---------------- #
                    (svm_regressor, r2) = train_svm_regressor_model(kernel=kernel_zf_L_retreat,
                                                                gamma=gamma_zf_L_retreat,
                                                                coeff=coeff_zf_L_retreat,
                                                                degree=degree_zf_L_retreat,
                                                                epsilon=epsilon_zf_L_retreat,
                                                                training_examples=training_examples,
                                                                training_targets=training_targets.iloc[:,0:ldim],
                                                                model_dir=dir_path_zf_L_retreat + "/cluster"+repr(i)+"/svm")
                ...
                res_file = open(dir_path_zf_L_retreat + "/cluster"+repr(i)+"/svm/results.txt", "a")
                res_file.write("Final RMSE (on projected test data): %0.3f\n" % test_root_mean_squared_error_proj)
                res_file.write("R^2 score (on projected test data): %0.3f\n" % r2score)
                res_file.close()
                ...
                plt.legend(loc='upper right')
                #plt.title()
                plt.savefig(dir_path_zf_L_retreat+"/cluster"+repr(i)+"/svm/zf_L_pred.pdf")
                plt.clf()
                #plt.show()
                ...
                if (ldim!=0):
                    # ---------- K-Nearest Neighbors ---------------- #
                    (knn_regressor, r2) = train_knn_regressor_model(n_neighbors = n_neighbors_zf_L_retreat,
                                                                weights = weights_zf_L_retreat,
                                                                algorithm = algorithm_zf_L_retreat,
                                                                training_examples=training_examples,
                                                                training_targets=training_targets.iloc[:,0:ldim],
                                                                model_dir=dir_path_zf_L_retreat + "/cluster"+repr(i)+"/knn")
                ...
                res_file = open(dir_path_zf_L_retreat + "/cluster"+repr(i)+"/knn/results.txt", "a")
                res_file.write("Final RMSE (on projected test data): %0.3f\n" % test_root_mean_squared_error_proj)
                res_file.write("R^2 score (on projected test data): %0.3f\n" % r2score)
                res_file.close()
                ...
                plt.legend(loc='upper right')
                #plt.title()
                plt.savefig(dir_path_zf_L_retreat+"/cluster"+repr(i)+"/knn/zf_L_pred.pdf")
                plt.clf()
                #plt.show()
...
if not outputs_zf_U_retreat_df.empty:
    # ------------------------- K-means clustering ---------------------------------------- #
    norm_outputs_zf_U_retreat_df, outputs_zf_U_retreat_df_max, outputs_zf_U_retreat_df_min = normalize_linear_scale(outputs_zf_U_retreat_df)

    if not os.path.exists(dir_path_zf_U_retreat):
        os.mkdir(dir_path_zf_U_retreat)
    outputs_zf_U_retreat_df_max.to_csv(dir_path_zf_U_retreat+"/zf_U_retreat_max.csv",sep=',')
    outputs_zf_U_retreat_df_min.to_csv(dir_path_zf_U_retreat +"/zf_U_retreat_min.csv",sep=',')

    zf_U_retreat = norm_outputs_zf_U_retreat_df.values

    kmeans = KMeans(n_clusters=n_clusters_zf_U_retreat, init='k-means++', max_iter=100, n_init=5, verbose=0, random_state=3425)
    # Fitting with inputs
    kmeans_zf_U_retreat = kmeans.fit(zf_U_retreat)
    # Predicting the clusters
    labels_zf_U_retreat = kmeans_zf_U_retreat.predict(zf_U_retreat)
    labels_zf_U_retreat_df = pd.DataFrame(data=labels_zf_U_retreat)

    # Getting the cluster centers
    C_zf_U_retreat = kmeans_zf_U_retreat.cluster_centers_
    if (print_en_zf_U_retreat):
        fig = plt.figure()
        ax_zf_U_retreat = fig.add_subplot(111)
        ax_zf_U_retreat.scatter(zf_U_retreat[:,0],zf_U_retreat[:,1], s=10, c=labels_zf_U_retreat, marker="s")
        ax_zf_U_retreat.set_xlabel('normalized zf_U_retreat 1')
        ax_zf_U_retreat.set_ylabel('normalized zf_U_retreat 2')
        ax_zf_U_retreat.set_title('Clusters of the zf_U_retreat')
        plt.savefig(dir_path_zf_U_retreat + "/clusters.pdf")
        plt.clf()
        #plt.show()

    cl_0_inputs_list_zf_U_retreat = []
    cl_0_inputs_test_list_zf_U_retreat = []
    cl_0_list_zf_U_retreat = []
    cl_0_test_list_zf_U_retreat = []

    cl_1_inputs_list_zf_U_retreat = []
    cl_1_inputs_test_list_zf_U_retreat = []
    cl_1_list_zf_U_retreat = []
    cl_1_test_list_zf_U_retreat = []

    cl_2_inputs_list_zf_U_retreat = []
    cl_2_inputs_test_list_zf_U_retreat = []
    cl_2_list_zf_U_retreat = []
    cl_2_test_list_zf_U_retreat = []

    cl_3_inputs_list_zf_U_retreat = []
    cl_3_inputs_test_list_zf_U_retreat = []
    cl_3_list_zf_U_retreat = []
    cl_3_test_list_zf_U_retreat = []

    cl_4_inputs_list_zf_U_retreat = []
    cl_4_inputs_test_list_zf_U_retreat = []
    cl_4_list_zf_U_retreat = []
    cl_4_test_list_zf_U_retreat = []

    cl_5_inputs_list_zf_U_retreat = []
    cl_5_inputs_test_list_zf_U_retreat = []
    cl_5_list_zf_U_retreat = []
    cl_5_test_list_zf_U_retreat = []

    for i in range(len(labels_zf_U_retreat)):
        cl = labels_zf_U_retreat[i]
        if cl == 0:
            cl_0_list_zf_U_retreat.append(norm_outputs_zf_U_retreat_df.iloc[i])
            cl_0_inputs_list_zf_U_retreat.append(normalized_inputs.iloc[i])
        elif cl == 1:
            cl_1_list_zf_U_retreat.append(norm_outputs_zf_U_retreat_df.iloc[i])
            cl_1_inputs_list_zf_U_retreat.append(normalized_inputs.iloc[i])
        elif cl == 2:
            cl_2_list_zf_U_retreat.append(norm_outputs_zf_U_retreat_df.iloc[i])
            cl_2_inputs_list_zf_U_retreat.append(normalized_inputs.iloc[i])
        elif cl == 3:
            cl_3_list_zf_U_retreat.append(norm_outputs_zf_U_retreat_df.iloc[i])
            cl_3_inputs_list_zf_U_retreat.append(normalized_inputs.iloc[i])
        elif cl == 4:
            cl_4_list_zf_U_retreat.append(norm_outputs_zf_U_retreat_df.iloc[i])
            cl_4_inputs_list_zf_U_retreat.append(normalized_inputs.iloc[i])
        elif cl == 5:
            cl_5_list_zf_U_retreat.append(norm_outputs_zf_U_retreat_df.iloc[i])
            cl_5_inputs_list_zf_U_retreat.append(normalized_inputs.iloc[i])

    cl_0_inputs_zf_U_retreat_df = pd.DataFrame(cl_0_inputs_list_zf_U_retreat, columns=inputs_cols)
    cl_0_zf_U_retreat_df = pd.DataFrame(cl_0_list_zf_U_retreat, columns=cols_zf_U_retreat)
    cl_1_inputs_zf_U_retreat_df = pd.DataFrame(cl_1_inputs_list_zf_U_retreat, columns=inputs_cols)
    cl_1_zf_U_retreat_df = pd.DataFrame(cl_1_list_zf_U_retreat, columns=cols_zf_U_retreat)
    cl_2_inputs_zf_U_retreat_df = pd.DataFrame(cl_2_inputs_list_zf_U_retreat, columns=inputs_cols)
    cl_2_zf_U_retreat_df = pd.DataFrame(cl_2_list_zf_U_retreat, columns=cols_zf_U_retreat)
    cl_3_inputs_zf_U_retreat_df = pd.DataFrame(cl_3_inputs_list_zf_U_retreat, columns=inputs_cols)
    cl_3_zf_U_retreat_df = pd.DataFrame(cl_3_list_zf_U_retreat, columns=cols_zf_U_retreat)
    cl_4_inputs_zf_U_retreat_df = pd.DataFrame(cl_4_inputs_list_zf_U_retreat, columns=inputs_cols)
    cl_4_zf_U_retreat_df = pd.DataFrame(cl_4_list_zf_U_retreat, columns=cols_zf_U_retreat)
    cl_5_inputs_zf_U_retreat_df = pd.DataFrame(cl_5_inputs_list_zf_U_retreat, columns=inputs_cols)
    cl_5_zf_U_retreat_df = pd.DataFrame(cl_5_list_zf_U_retreat, columns=cols_zf_U_retreat)

    clusters_inputs_zf_U_retreat = [cl_0_inputs_zf_U_retreat_df,cl_1_inputs_zf_U_retreat_df,cl_2_inputs_zf_U_retreat_df,cl_3_inputs_zf_U_retreat_df,cl_4_inputs_zf_U_retreat_df,cl_5_inputs_zf_U_retreat_df]
    clusters_outputs_zf_U_retreat = [cl_0_zf_U_retreat_df,cl_1_zf_U_retreat_df,cl_2_zf_U_retreat_df,cl_3_zf_U_retreat_df,cl_4_zf_U_retreat_df,cl_5_zf_U_retreat_df]

    # save the dataframes of each cluster
    # cluster 0
    if not os.path.exists(dir_path_zf_U_retreat + "/cluster0"):
        os.mkdir(dir_path_zf_U_retreat + "/cluster0")
    cl_0_inputs_zf_U_retreat_df.to_csv(dir_path_zf_U_retreat + "/cluster0/inputs.csv", sep=',', index=False)
    cl_0_zf_U_retreat_df.to_csv(dir_path_zf_U_retreat + "/cluster0/outputs.csv", sep=',', index=False)
    # cluster 1
    if not os.path.exists(dir_path_zf_U_retreat + "/cluster1"):
        os.mkdir(dir_path_zf_U_retreat + "/cluster1")
    cl_1_inputs_zf_U_retreat_df.to_csv(dir_path_zf_U_retreat + "/cluster1/inputs.csv", sep=',', index=False)
    cl_1_zf_U_retreat_df.to_csv(dir_path_zf_U_retreat + "/cluster1/outputs.csv", sep=',', index=False)
    # cluster 2
    if not os.path.exists(dir_path_zf_U_retreat + "/cluster2"):
        os.mkdir(dir_path_zf_U_retreat + "/cluster2")
    cl_2_inputs_zf_U_retreat_df.to_csv(dir_path_zf_U_retreat + "/cluster2/inputs.csv", sep=',', index=False)
    cl_2_zf_U_retreat_df.to_csv(dir_path_zf_U_retreat + "/cluster2/outputs.csv", sep=',', index=False)
    # cluster 3
    if not os.path.exists(dir_path_zf_U_retreat + "/cluster3"):
        os.mkdir(dir_path_zf_U_retreat + "/cluster3")
    cl_3_inputs_zf_U_retreat_df.to_csv(dir_path_zf_U_retreat + "/cluster3/inputs.csv", sep=',', index=False)
    cl_3_zf_U_retreat_df.to_csv(dir_path_zf_U_retreat + "/cluster3/outputs.csv", sep=',', index=False)
    # cluster 4
    if not os.path.exists(dir_path_zf_U_retreat + "/cluster4"):
        os.mkdir(dir_path_zf_U_retreat + "/cluster4")
    cl_4_inputs_zf_U_retreat_df.to_csv(dir_path_zf_U_retreat + "/cluster4/inputs.csv", sep=',', index=False)
    cl_4_zf_U_retreat_df.to_csv(dir_path_zf_U_retreat + "/cluster4/outputs.csv", sep=',', index=False)
    # cluster 5
    if not os.path.exists(dir_path_zf_U_retreat + "/cluster5"):
        os.mkdir(dir_path_zf_U_retreat + "/cluster5")
    cl_5_inputs_zf_U_retreat_df.to_csv(dir_path_zf_U_retreat + "/cluster5/inputs.csv", sep=',', index=False)
    cl_5_zf_U_retreat_df.to_csv(dir_path_zf_U_retreat + "/cluster5/outputs.csv", sep=',', index=False)

    if (print_en_zf_U_retreat):
        print("Cluster 0:")
        print(cl_0_inputs_zf_U_retreat_df.describe())
        print(cl_0_zf_U_retreat_df.describe())
        print("Cluster 1:")
        print(cl_1_inputs_zf_U_retreat_df.describe())
        print(cl_1_zf_U_retreat_df.describe())
        print("Cluster 2:")
        print(cl_2_inputs_zf_U_retreat_df.describe())
        print(cl_2_zf_U_retreat_df.describe())
        print("Cluster 3:")
        print(cl_3_inputs_zf_U_retreat_df.describe())
        print(cl_3_zf_U_retreat_df.describe())
        print("Cluster 4:")
        print(cl_4_inputs_zf_U_retreat_df.describe())
        print(cl_4_zf_U_retreat_df.describe())
        print("Cluster 5:")
        print(cl_5_inputs_zf_U_retreat_df.describe())
        print(cl_5_zf_U_retreat_df.describe())

    # ---------------------------------- Classifier training ------------------------------------------------------------#
    if (train_zf_U_retreat_class):

        if not os.path.exists(dir_path_zf_U_retreat + "/classification"):
            os.mkdir(dir_path_zf_U_retreat + "/classification")
        if not os.path.exists(dir_path_zf_U_retreat + "/classification/nn"):
            os.mkdir(dir_path_zf_U_retreat + "/classification/nn")
        if not os.path.exists(dir_path_zf_U_retreat + "/classification/svm"):
            os.mkdir(dir_path_zf_U_retreat + "/classification/svm")
        if not os.path.exists(dir_path_zf_U_retreat + "/classification/knn"):
            os.mkdir(dir_path_zf_U_retreat + "/classification/knn")
        ...
        # Choose the first 70% examples for training.
        training_examples_class = normalized_inputs.iloc[:train, :]
        training_targets_class = labels_zf_U_retreat_df.iloc[:train, :]

        # Choose the last 20%  examples for validation.
        validation_examples_class = normalized_inputs.iloc[train:val, :]
        validation_targets_class = labels_zf_U_retreat_df.iloc[train:val, :]

        # Choose the examples for test. 10%
        test_examples_class = normalized_inputs.iloc[val:, :]
        test_targets_class = labels_zf_U_retreat_df.iloc[val:, :]
        ...
        (nn_classifier, training_log_losses, validation_log_losses) = train_nn_classifier_model(
                                                                        ...
                                                                        periods=periods_zf_U_retreat_class,
                                                                        steps=steps_zf_U_retreat_class,
                                                                        batch_size=batch_size_zf_U_retreat_class,
        ...
        res_file = open(dir_path_zf_U_retreat + "/classification/nn/results.txt", "a")
        res_file.write("LogLoss (on test data): %0.3f\n" % test_log_loss)
        res_file.write("Average loss on the test set: %0.3f\n" % evaluation_metrics['average_loss'])
        res_file.write("Accuracy on the test set: %0.3f\n" % evaluation_metrics['accuracy'])
        res_file.close()
        ...
        # ---------- Support Vector Machine ---------- #
        (svm_classifier, scores) = train_svm_classifier_model(kernel = kernel_class_zf_U_retreat,
                                                              cv = n_cv_zf_U_retreat,
                                                              training_examples_class_list = training_examples_class_list,
                                                              training_targets_class_list = training_targets_class_list,
                                                              model_dir = dir_path_zf_U_retreat + "/classification/svm")

        test_targets_class_pred = svm_classifier.predict(test_examples_class_list)
        report = classification_report(test_targets_class_list, test_targets_class_pred)
        #print(report)
        classification_report_csv(report = report,model_dir = dir_path_zf_U_retreat + "/classification/svm")
        acc_test = accuracy_score(test_targets_class_list, test_targets_class_pred, normalize=True, sample_weight=None)
        print("Accuracy on the test set: %0.3f " % acc_test)

        res_file = open(dir_path_zf_U_retreat + "/classification/svm/results.txt", "a")
        res_file.write("Accuracy on the test set: %0.3f \n" % acc_test)
        res_file.close()

        # ---------- K-Nearest Neighbors ---------- #
        (knn_classifier, scores) = train_knn_classifier_model(n_neighbors = n_neighbors_class_zf_U_retreat,
                                                              cv = n_cv_zf_U_retreat,
                                                              weights = weights_class_zf_U_retreat ,
                                                              algorithm = algorithm_class_zf_U_retreat,
                                                              training_examples_class_list = training_examples_class_list,
                                                              training_targets_class_list = training_targets_class_list,
                                                              model_dir = dir_path_zf_U_retreat + "/classification/knn")


        test_targets_class_pred = knn_classifier.predict(test_examples_class_list)
        report = classification_report(test_targets_class_list, test_targets_class_pred)
        #print(report)
        classification_report_csv(report = report,model_dir = dir_path_zf_U_retreat + "/classification/knn")
        acc_test = accuracy_score(test_targets_class_list, test_targets_class_pred, normalize=True, sample_weight=None)
        print("Accuracy on the test set: %0.3f " % acc_test)

        res_file = open(dir_path_zf_U_retreat + "/classification/knn/results.txt", "a")
        res_file.write("Accuracy on the test set: %0.3f \n" % acc_test)
        res_file.close()

    if (train_zf_U_retreat):
        # ----------------------------------------------- PCA  and regression on each cluster --------------------------------------- #
        for i in range(0,n_clusters_zf_U_retreat):
            cl_in_zf_U_retreat_df = clusters_inputs_zf_U_retreat[i]
            cl_out_zf_U_retreat_df = clusters_outputs_zf_U_retreat[i]
            if (len(cl_out_zf_U_retreat_df.index) > min_cluster_size_zf_U_retreat):
                if (len(cl_out_zf_U_retreat_df.columns) > 4):
                    n_comps = 4  # at least 95% of the information with 3 components
                    Z_f_U_retreat = cl_out_zf_U_retreat_df.values
                    pca_zf_U_retreat = decomposition.PCA(n_components=n_comps)
                    pc = pca_zf_U_retreat.fit_transform(Z_f_U_retreat)
                    pc_df = pd.DataFrame(data=pc, columns=cols_zf_U_retreat[0:n_comps])
                    if (print_en_zf_U_retreat):
                        print(pca_zf_U_retreat.n_components_)
                        print(pca_zf_U_retreat.components_)
                        print(pc_df.describe())
                        print(pca_zf_U_retreat.explained_variance_ratio_)
                        print(pca_zf_U_retreat.explained_variance_ratio_.sum())
                        df = pd.DataFrame({'var': pca_zf_U_retreat.explained_variance_ratio_, 'PC': cols_zf_U_retreat[0:n_comps]})


                        pc_file = open(dir_path_zf_U_retreat+"/cluster"+repr(i)+"/p_comps.csv", "w")
                        pc_file.write("### Principal components ###\n")
                        pc_file.write(df.iloc[0, 0]+", ")
                        pc_file.write(df.iloc[1, 0] + ", ")
                        pc_file.write(df.iloc[2, 0] + ", ")
                        ...
                        fig_pc.savefig(dir_path_xf_retreat+"/cluster"+repr(i)+"/p_comps.pdf")
                        threedee_train = plt.figure().gca(projection='3d')
                        threedee_train.scatter(cl_in_zf_U_retreat_df["target_x_mm"], cl_in_zf_U_retreat_df["target_y_mm"], pc_df['zf_U_retreat_3'])
                        plt.clf()
                        #plt.show()
                else:
                    pc_df = cl_out_zf_U_retreat_df
                    n_comps = len(cl_out_zf_U_retreat_df.columns)

                # ---------------------------- regression --------------------------------- #
                size = len(cl_out_zf_U_retreat_df.index)
                inputs_df, inputs_df_max, inputs_df_min = normalize_linear_scale(cl_in_zf_U_retreat_df)
                outputs_df = pc_df

                if not os.path.exists(dir_path_zf_U_retreat + "/cluster"+repr(i)):
                    os.mkdir(dir_path_zf_U_retreat + "/cluster"+repr(i))
                if not os.path.exists(dir_path_zf_U_retreat + "/cluster"+repr(i)+"/nn"):
                    os.mkdir(dir_path_zf_U_retreat + "/cluster"+repr(i)+"/nn")
                if not os.path.exists(dir_path_zf_U_retreat + "/cluster"+repr(i)+"/svm"):
                    os.mkdir(dir_path_zf_U_retreat + "/cluster"+repr(i)+"/svm")
                if not os.path.exists(dir_path_zf_U_retreat + "/cluster"+repr(i)+"/knn"):
                    os.mkdir(dir_path_zf_U_retreat + "/cluster"+repr(i)+"/knn")
                ...
                test_examples = inputs_df.iloc[val:, :]
                # test_targets = outputs_df_0.iloc[val:, tar:tar_end]
                test_targets = cl_out_zf_U_retreat_df.iloc[val:, :]
                ...
                for j in range(0, dim):
                    if (math.sqrt(math.pow((training_targets.iloc[0:, j].quantile(0.25) - training_targets.iloc[0:, j].quantile(0.75)),2)) <= th_zf_U_retreat):
                        if (test_predictions_1.size == 0):
                            test_predictions_1 = np.full((test_targets.shape[0], 1),training_targets.iloc[0:, j].mean())
                        else:
                            test_predictions_1 = np.concatenate([test_predictions_1, np.full((test_targets.shape[0], 1),training_targets.iloc[0:,j].mean())], axis=1)
                ...
                if (ldim != 0):
                    ...
                    nn_regressor, training_losses, validation_losses = train_nn_regressor_model(
                                                                            my_optimizer=tf.train.AdamOptimizer(learning_rate=learning_rate),
                                                                            dimensions=ldim,
                                                                            periods=periods_zf_U_retreat,
                                                                            steps=steps_zf_U_retreat,
                                                                            batch_size=batch_size_zf_U_retreat,
                                                                            hidden_units=units_zf_U_retreat,
                                                                            training_examples=training_examples,
                                                                            training_targets=training_targets[train_col_names_1],
                                                                            validation_examples=validation_examples,
                                                                            validation_targets=validation_targets[train_col_names_1],
                                                                            model_dir=dir_path_zf_U_retreat+"/cluster"+repr(i)+"/nn")
                ...
                if (len(cl_out_zf_U_retreat_df.columns) > 4):
                    # test_predictions_df = denormalize_linear_scale(test_predictions_df, outputs_df_0_max,outputs_df_0_min)
                    test_predictions = test_predictions_df.values
                    test_predictions_proj = pca_zf_U_retreat.inverse_transform(test_predictions)
                    test_proj_df = pd.DataFrame(data=test_predictions_proj, columns=cols_zf_U_retreat)
                    denorm_test_predictions_df = denormalize_linear_scale(test_proj_df, outputs_zf_U_retreat_df_max, outputs_zf_U_retreat_df_min)
                else:
                ...
                denorm_test_targets = denormalize_linear_scale(test_targets, outputs_zf_U_retreat_df_max, outputs_zf_U_retreat_df_min)
                ...
                res_file = open(dir_path_zf_U_retreat+"/cluster"+repr(i)+"/nn/results.txt", "a")
                res_file.write("RMSE (on test data):   %0.3f\n" % test_root_mean_squared_error_proj)
                res_file.write("R^2 score (on projected test data): %0.3f\n" % r2score)
                res_file.close()
                ...
                fig = plt.figure()
                ax1 = fig.add_subplot(111)
                ax1.scatter(denorm_test_targets["zf_U_retreat_3"], denorm_test_targets["zf_U_retreat_5"], s=10, c='b', marker="s",label='test_targets')
                ax1.scatter(denorm_test_predictions_df["zf_U_retreat_3"], denorm_test_predictions_df["zf_U_retreat_5"], s=10, c='r', marker="o", label='test_predictions')
                plt.xlabel("zf_U_retreat_3")
                plt.ylabel("zf_U_retreat_5")
                plt.legend(loc='upper right')
                plt.savefig(dir_path_zf_U_retreat+"/cluster"+repr(i)+"/nn/zf_U_pred.pdf")
                plt.clf()
                #plt.show()
                ...
                if (ldim!=0):
                    # ---------- Support Vector Machine ---------------- #
                    (svm_regressor, r2) = train_svm_regressor_model(kernel=kernel_zf_U_retreat,
                                                                gamma=gamma_zf_U_retreat,
                                                                coeff=coeff_zf_U_retreat,
                                                                degree=degree_zf_U_retreat,
                                                                epsilon=epsilon_zf_U_retreat,
                                                                training_examples=training_examples,
                                                                training_targets=training_targets.iloc[:,0:ldim],
                                                                model_dir=dir_path_zf_U_retreat + "/cluster"+repr(i)+"/svm")
                ...
                res_file = open(dir_path_zf_U_retreat + "/cluster"+repr(i)+"/svm/results.txt", "a")
                res_file.write("Final RMSE (on projected test data): %0.3f\n" % test_root_mean_squared_error_proj)
                res_file.write("R^2 score (on projected test data): %0.3f\n" % r2score)
                res_file.close()
                ...
                plt.ylabel("zf_U_retreat_5")
                plt.legend(loc='upper right')
                plt.savefig(dir_path_zf_U_retreat+"/cluster"+repr(i)+"/svm/zf_U_pred.pdf")
                plt.clf()
                #plt.show()
                ...
                if (ldim!=0):
                    # ---------- K-Nearest Neighbors ---------------- #
                    (knn_regressor, r2) = train_knn_regressor_model(n_neighbors = n_neighbors_zf_U_retreat,
                                                                weights = weights_zf_U_retreat,
                                                                algorithm = algorithm_zf_U_retreat,
                                                                training_examples=training_examples,
                                                                training_targets=training_targets.iloc[:,0:ldim],
                                                                model_dir=dir_path_zf_U_retreat + "/cluster"+repr(i)+"/knn")
                ...
                res_file = open(dir_path_zf_U_retreat + "/cluster"+repr(i)+"/knn/results.txt", "a")
                res_file.write("Final RMSE (on projected test data): %0.3f\n" % test_root_mean_squared_error_proj)
                res_file.write("R^2 score (on projected test data): %0.3f\n" % r2score)
                res_file.close()
                ...
                plt.ylabel("zf_U_retreat_5")
                plt.legend(loc='upper right')
                plt.savefig(dir_path_zf_U_retreat+"/cluster"+repr(i)+"/knn/zf_U_pred.pdf")
                plt.clf()
                #plt.show()
...
if not outputs_dual_f_retreat_df.empty:
    # ------------------------- K-means clustering ---------------------------------------- #
    norm_outputs_dual_f_retreat_df, outputs_dual_f_retreat_df_max, outputs_dual_f_retreat_df_min = normalize_linear_scale(outputs_dual_f_retreat_df)

    if not os.path.exists(dir_path_dual_f_retreat):
        os.mkdir(dir_path_dual_f_retreat)
    outputs_dual_f_retreat_df_max.to_csv(dir_path_dual_f_retreat+"/dual_f_retreat_max.csv",sep=',')
    outputs_dual_f_retreat_df_min.to_csv(dir_path_dual_f_retreat +"/dual_f_retreat_min.csv",sep=',')

    dual_f_retreat = norm_outputs_dual_f_retreat_df.values

    kmeans = KMeans(n_clusters=n_clusters_dual_f_retreat, init='k-means++', max_iter=100, n_init=5, verbose=0, random_state=3425)
    # Fitting with inputs
    kmeans_dual_f_retreat = kmeans.fit(dual_f_retreat)
    # Predicting the clusters
    labels_dual_f_retreat = kmeans_dual_f_retreat.predict(dual_f_retreat)
    labels_dual_f_retreat_df = pd.DataFrame(data=labels_dual_f_retreat)

    # Getting the cluster centers
    C_dual_f_retreat = kmeans_dual_f_retreat.cluster_centers_
    if (print_en_dual_f_retreat):
        fig = plt.figure()
        ax_dual_f_retreat = fig.add_subplot(111)
        ax_dual_f_retreat.scatter(normalized_inputs['target_x_mm'],dual_f_retreat[:,0], s=10, c=labels_dual_f_retreat, marker="s")
        ax_dual_f_retreat.set_title('Clusters of the dual_f_retreat')
        ax_dual_f_retreat.set_xlabel('target_x_mm')
        ax_dual_f_retreat.set_ylabel('dual_f_retreat_1')
        plt.savefig(dir_path_dual_f_retreat + "/clusters.pdf")
        plt.clf()
        #plt.show()

    cl_0_inputs_list_dual_f_retreat = []
    cl_0_inputs_test_list_dual_f_retreat = []
    cl_0_list_dual_f_retreat = []
    cl_0_test_list_dual_f_retreat = []

    cl_1_inputs_list_dual_f_retreat = []
    cl_1_inputs_test_list_dual_f_retreat = []
    cl_1_list_dual_f_retreat = []
    cl_1_test_list_dual_f_retreat = []

    cl_2_inputs_list_dual_f_retreat = []
    cl_2_inputs_test_list_dual_f_retreat = []
    cl_2_list_dual_f_retreat = []
    cl_2_test_list_dual_f_retreat = []

    cl_3_inputs_list_dual_f_retreat = []
    cl_3_inputs_test_list_dual_f_retreat = []
    cl_3_list_dual_f_retreat = []
    cl_3_test_list_dual_f_retreat = []

    cl_4_inputs_list_dual_f_retreat = []
    cl_4_inputs_test_list_dual_f_retreat = []
    cl_4_list_dual_f_retreat = []
    cl_4_test_list_dual_f_retreat = []

    cl_5_inputs_list_dual_f_retreat = []
    cl_5_inputs_test_list_dual_f_retreat = []
    cl_5_list_dual_f_retreat = []
    cl_5_test_list_dual_f_retreat = []

    for i in range(len(labels_dual_f_retreat)):
        cl = labels_dual_f_retreat[i]
        if cl == 0:
            cl_0_list_dual_f_retreat.append(norm_outputs_dual_f_retreat_df.iloc[i])
            cl_0_inputs_list_dual_f_retreat.append(normalized_inputs.iloc[i])
        elif cl == 1:
            cl_1_list_dual_f_retreat.append(norm_outputs_dual_f_retreat_df.iloc[i])
            cl_1_inputs_list_dual_f_retreat.append(normalized_inputs.iloc[i])
        elif cl == 2:
            cl_2_list_dual_f_retreat.append(norm_outputs_dual_f_retreat_df.iloc[i])
            cl_2_inputs_list_dual_f_retreat.append(normalized_inputs.iloc[i])
        elif cl == 3:
            cl_3_list_dual_f_retreat.append(norm_outputs_dual_f_retreat_df.iloc[i])
            cl_3_inputs_list_dual_f_retreat.append(normalized_inputs.iloc[i])
        elif cl == 4:
            cl_4_list_dual_f_retreat.append(norm_outputs_dual_f_retreat_df.iloc[i])
            cl_4_inputs_list_dual_f_retreat.append(normalized_inputs.iloc[i])
        elif cl == 5:
            cl_5_list_dual_f_retreat.append(norm_outputs_dual_f_retreat_df.iloc[i])
            cl_5_inputs_list_dual_f_retreat.append(normalized_inputs.iloc[i])

    cl_0_inputs_dual_f_retreat_df = pd.DataFrame(cl_0_inputs_list_dual_f_retreat, columns=inputs_cols)
    cl_0_dual_f_retreat_df = pd.DataFrame(cl_0_list_dual_f_retreat, columns=cols_dual_f_retreat)
    cl_1_inputs_dual_f_retreat_df = pd.DataFrame(cl_1_inputs_list_dual_f_retreat, columns=inputs_cols)
    cl_1_dual_f_retreat_df = pd.DataFrame(cl_1_list_dual_f_retreat, columns=cols_dual_f_retreat)
    cl_2_inputs_dual_f_retreat_df = pd.DataFrame(cl_2_inputs_list_dual_f_retreat, columns=inputs_cols)
    cl_2_dual_f_retreat_df = pd.DataFrame(cl_2_list_dual_f_retreat, columns=cols_dual_f_retreat)
    cl_3_inputs_dual_f_retreat_df = pd.DataFrame(cl_3_inputs_list_dual_f_retreat, columns=inputs_cols)
    cl_3_dual_f_retreat_df = pd.DataFrame(cl_3_list_dual_f_retreat, columns=cols_dual_f_retreat)
    cl_4_inputs_dual_f_retreat_df = pd.DataFrame(cl_4_inputs_list_dual_f_retreat, columns=inputs_cols)
    cl_4_dual_f_retreat_df = pd.DataFrame(cl_4_list_dual_f_retreat, columns=cols_dual_f_retreat)
    cl_5_inputs_dual_f_retreat_df = pd.DataFrame(cl_5_inputs_list_dual_f_retreat, columns=inputs_cols)
    cl_5_dual_f_retreat_df = pd.DataFrame(cl_5_list_dual_f_retreat, columns=cols_dual_f_retreat)

    clusters_inputs_dual_f_retreat = [cl_0_inputs_dual_f_retreat_df,cl_1_inputs_dual_f_retreat_df,cl_2_inputs_dual_f_retreat_df,cl_3_inputs_dual_f_retreat_df,cl_4_inputs_dual_f_retreat_df,cl_5_inputs_dual_f_retreat_df]
    clusters_outputs_dual_f_retreat = [cl_0_dual_f_retreat_df,cl_1_dual_f_retreat_df,cl_2_dual_f_retreat_df,cl_3_dual_f_retreat_df,cl_4_dual_f_retreat_df,cl_5_dual_f_retreat_df]

    # save the dataframes of each cluster
    # cluster 0
    if not os.path.exists(dir_path_dual_f_retreat + "/cluster0"):
        os.mkdir(dir_path_dual_f_retreat + "/cluster0")
    cl_0_inputs_dual_f_retreat_df.to_csv(dir_path_dual_f_retreat + "/cluster0/inputs.csv", sep=',', index=False)
    cl_0_dual_f_retreat_df.to_csv(dir_path_dual_f_retreat + "/cluster0/outputs.csv", sep=',', index=False)
    # cluster 1
    if not os.path.exists(dir_path_dual_f_retreat + "/cluster1"):
        os.mkdir(dir_path_dual_f_retreat + "/cluster1")
    cl_1_inputs_dual_f_retreat_df.to_csv(dir_path_dual_f_retreat + "/cluster1/inputs.csv", sep=',', index=False)
    cl_1_dual_f_retreat_df.to_csv(dir_path_dual_f_retreat + "/cluster1/outputs.csv", sep=',', index=False)
    # cluster 2
    if not os.path.exists(dir_path_dual_f_retreat + "/cluster2"):
        os.mkdir(dir_path_dual_f_retreat + "/cluster2")
    cl_2_inputs_dual_f_retreat_df.to_csv(dir_path_dual_f_retreat + "/cluster2/inputs.csv", sep=',', index=False)
    cl_2_dual_f_retreat_df.to_csv(dir_path_dual_f_retreat + "/cluster2/outputs.csv", sep=',', index=False)
    # cluster 3
    if not os.path.exists(dir_path_dual_f_retreat + "/cluster3"):
        os.mkdir(dir_path_dual_f_retreat + "/cluster3")
    cl_3_inputs_dual_f_retreat_df.to_csv(dir_path_dual_f_retreat + "/cluster3/inputs.csv", sep=',', index=False)
    cl_3_dual_f_retreat_df.to_csv(dir_path_dual_f_retreat + "/cluster3/outputs.csv", sep=',', index=False)
    # cluster 4
    if not os.path.exists(dir_path_dual_f_retreat + "/cluster4"):
        os.mkdir(dir_path_dual_f_retreat + "/cluster4")
    cl_4_inputs_dual_f_retreat_df.to_csv(dir_path_dual_f_retreat + "/cluster4/inputs.csv", sep=',', index=False)
    cl_4_dual_f_retreat_df.to_csv(dir_path_dual_f_retreat + "/cluster4/outputs.csv", sep=',', index=False)
    # cluster 5
    if not os.path.exists(dir_path_dual_f_retreat + "/cluster5"):
        os.mkdir(dir_path_dual_f_retreat + "/cluster5")
    cl_5_inputs_dual_f_retreat_df.to_csv(dir_path_dual_f_retreat + "/cluster5/inputs.csv", sep=',', index=False)
    cl_5_dual_f_retreat_df.to_csv(dir_path_dual_f_retreat + "/cluster5/outputs.csv", sep=',', index=False)

    if (print_en_dual_f_retreat):
        print("Cluster 0:")
        print(cl_0_inputs_dual_f_retreat_df.describe())
        print(cl_0_dual_f_retreat_df.describe())
        print("Cluster 1:")
        print(cl_1_inputs_dual_f_retreat_df.describe())
        print(cl_1_dual_f_retreat_df.describe())
        print("Cluster 2:")
        print(cl_2_inputs_dual_f_retreat_df.describe())
        print(cl_2_dual_f_retreat_df.describe())
        print("Cluster 3:")
        print(cl_3_inputs_dual_f_retreat_df.describe())
        print(cl_3_dual_f_retreat_df.describe())
        print("Cluster 4:")
        print(cl_4_inputs_dual_f_retreat_df.describe())
        print(cl_4_dual_f_retreat_df.describe())
        print("Cluster 5:")
        print(cl_5_inputs_dual_f_retreat_df.describe())
        print(cl_5_dual_f_retreat_df.describe())

    # ---------------------------------- Classifier training ------------------------------------------------------------#
    if (train_dual_f_retreat_class):

        if not os.path.exists(dir_path_dual_f_retreat + "/classification"):
            os.mkdir(dir_path_dual_f_retreat + "/classification")
        if not os.path.exists(dir_path_dual_f_retreat + "/classification/nn"):
            os.mkdir(dir_path_dual_f_retreat + "/classification/nn")
        if not os.path.exists(dir_path_dual_f_retreat + "/classification/svm"):
            os.mkdir(dir_path_dual_f_retreat + "/classification/svm")
        if not os.path.exists(dir_path_dual_f_retreat + "/classification/knn"):
            os.mkdir(dir_path_dual_f_retreat + "/classification/knn")
        ...
        # Choose the first 70% examples for training.
        training_examples_class = normalized_inputs.iloc[:train, :]
        training_targets_class = labels_dual_f_retreat_df.iloc[:train, :]

        # Choose the last 20%  examples for validation.
        validation_examples_class = normalized_inputs.iloc[train:val, :]
        validation_targets_class = labels_dual_f_retreat_df.iloc[train:val, :]

        # Choose the examples for test. 10%
        test_examples_class = normalized_inputs.iloc[val:, :]
        test_targets_class = labels_dual_f_retreat_df.iloc[val:, :]
        ...
        (nn_classifier, training_log_losses, validation_log_losses) = train_nn_classifier_model(
                                                        ...
                                                        periods=periods_dual_f_retreat_class,
                                                        steps=steps_dual_f_retreat_class,
                                                        batch_size=batch_size_dual_f_retreat_class,
        ...
        res_file = open(dir_path_dual_f_retreat + "/classification/nn/results.txt", "a")
        res_file.write("LogLoss (on test data): %0.3f\n" % test_log_loss)
        res_file.write("Average loss on the test set: %0.3f\n" % evaluation_metrics['average_loss'])
        res_file.write("Accuracy on the test set: %0.3f\n" % evaluation_metrics['accuracy'])
        res_file.close()
        ...
        # ---------- Support Vector Machine ---------- #
        (svm_classifier, scores) = train_svm_classifier_model(kernel = kernel_class_dual_f_retreat,
                                                              cv = n_cv_dual_f_retreat,
                                                              training_examples_class_list = training_examples_class_list,
                                                              training_targets_class_list = training_targets_class_list,
                                                              model_dir = dir_path_dual_f_retreat + "/classification/svm")

        test_targets_class_pred = svm_classifier.predict(test_examples_class_list)
        report = classification_report(test_targets_class_list, test_targets_class_pred)
        #print(report)
        classification_report_csv(report = report,model_dir = dir_path_dual_f_retreat + "/classification/svm")
        acc_test = accuracy_score(test_targets_class_list, test_targets_class_pred, normalize=True, sample_weight=None)
        print("Accuracy on the test set: %0.3f " % acc_test)

        res_file = open(dir_path_dual_f_retreat + "/classification/svm/results.txt", "a")
        res_file.write("Accuracy on the test set: %0.3f \n" % acc_test)
        res_file.close()

        # ---------- K-Nearest Neighbors ---------- #
        (knn_classifier, scores) = train_knn_classifier_model(n_neighbors = n_neighbors_class_dual_f_retreat,
                                                              cv = n_cv_dual_f_retreat,
                                                              weights = weights_class_dual_f_retreat ,
                                                              algorithm = algorithm_class_dual_f_retreat,
                                                              training_examples_class_list = training_examples_class_list,
                                                              training_targets_class_list = training_targets_class_list,
                                                              model_dir = dir_path_dual_f_retreat + "/classification/knn")

        test_targets_class_pred = knn_classifier.predict(test_examples_class_list)
        report = classification_report(test_targets_class_list, test_targets_class_pred)
        #print(report)
        classification_report_csv(report = report,model_dir = dir_path_dual_f_retreat + "/classification/knn")
        acc_test = accuracy_score(test_targets_class_list, test_targets_class_pred, normalize=True, sample_weight=None)
        print("Accuracy on the test set: %0.3f " % acc_test)

        res_file = open(dir_path_dual_f_retreat + "/classification/knn/results.txt", "a")
        res_file.write("Accuracy on the test set: %0.3f \n" % acc_test)
        res_file.close()

    if (train_dual_f_retreat):
        # ----------------------------------------------- PCA  and regression on each cluster --------------------------------------- #
        for i in range(0,n_clusters_dual_f_retreat):
            cl_in_dual_f_retreat_df = clusters_inputs_dual_f_retreat[i]
            cl_out_dual_f_retreat_df = clusters_outputs_dual_f_retreat[i]
            if (len(cl_out_dual_f_retreat_df.index) > min_cluster_size_dual_f_retreat):
                if (len(cl_out_dual_f_retreat_df.columns) > 10):
                    n_comps = 10  # at least 95% of the information with 3 components
                    Dual_f_retreat = cl_out_dual_f_retreat_df.values
                    pca_dual_f_retreat = decomposition.PCA(n_components=n_comps)
                    pc = pca_dual_f_retreat.fit_transform(Dual_f_retreat)
                    pc_df = pd.DataFrame(data=pc, columns=cols_dual_f_retreat[0:n_comps])
                    if (print_en_dual_f_retreat):
                        print(pca_dual_f_retreat.n_components_)
                        print(pca_dual_f_retreat.components_)
                        print(pc_df.describe())
                        print(pca_dual_f_retreat.explained_variance_ratio_)
                        print(pca_dual_f_retreat.explained_variance_ratio_.sum())
                        df = pd.DataFrame({'var': pca_dual_f_retreat.explained_variance_ratio_, 'PC': cols_dual_f_retreat[0:n_comps]})

                        pc_file = open(dir_path_dual_f_retreat+"/cluster"+repr(i)+"/p_comps.csv", "w")
                        pc_file.write("### Principal components ###\n")
                        pc_file.write(df.iloc[0, 0]+", ")
                        pc_file.write(df.iloc[1, 0] + ", ")
                        pc_file.write(df.iloc[2, 0] + ", ")
                        ...
                        sns_plot = sns.barplot(x='PC', y="var", data=df, color="c")
                        fig_pc = sns_plot.get_figure()
                        fig_pc.savefig(dir_path_dual_f_retreat+"/cluster"+repr(i)+"/p_comps.pdf")
                        threedee_train = plt.figure().gca(projection='3d')
                        threedee_train.scatter(cl_in_dual_f_retreat_df["target_x_mm"], cl_in_dual_f_retreat_df["target_y_mm"], pc_df['dual_f_retreat_1'])
                        plt.clf()
                        #plt.show()
                else:
                    pc_df = cl_out_dual_f_retreat_df
                    n_comps = len(cl_out_dual_f_retreat_df.columns)

                # ---------------------------- regression --------------------------------- #

                size = len(cl_out_dual_f_retreat_df.index)
                inputs_df, inputs_df_max, inputs_df_min = normalize_linear_scale(cl_in_dual_f_retreat_df)
                outputs_df = pc_df

                if not os.path.exists(dir_path_dual_f_retreat + "/cluster"+repr(i)):
                    os.mkdir(dir_path_dual_f_retreat + "/cluster"+repr(i))
                if not os.path.exists(dir_path_dual_f_retreat + "/cluster"+repr(i)+"/nn"):
                    os.mkdir(dir_path_dual_f_retreat + "/cluster"+repr(i)+"/nn")
                if not os.path.exists(dir_path_dual_f_retreat + "/cluster"+repr(i)+"/svm"):
                    os.mkdir(dir_path_dual_f_retreat + "/cluster"+repr(i)+"/svm")
                if not os.path.exists(dir_path_dual_f_retreat + "/cluster"+repr(i)+"/knn"):
                    os.mkdir(dir_path_dual_f_retreat + "/cluster"+repr(i)+"/knn")
                ...
                test_examples = inputs_df.iloc[val:, :]
                # test_targets = outputs_df_0.iloc[val:, tar:tar_end]
                test_targets = cl_out_dual_f_retreat_df.iloc[val:, :]
                ...
                for j in range(0, dim):
                    if (math.sqrt(math.pow((training_targets.iloc[0:, j].quantile(0.25) - training_targets.iloc[0:, j].quantile(0.75)),2)) <= th_dual_f_retreat):
                        if (test_predictions_1.size == 0):
                            test_predictions_1 = np.full((test_targets.shape[0], 1),training_targets.iloc[0:, j].mean())
                        else:
                            test_predictions_1 = np.concatenate([test_predictions_1, np.full((test_targets.shape[0], 1),training_targets.iloc[0:,j].mean())], axis=1)
                ...
                if (ldim != 0):
                    ...
                    nn_regressor, training_losses, validation_losses = train_nn_regressor_model(
                                                                            my_optimizer=tf.train.AdamOptimizer(learning_rate=learning_rate),
                                                                            dimensions=ldim,
                                                                            periods=periods_dual_f_retreat,
                                                                            steps=steps_dual_f_retreat,
                                                                            batch_size=batch_size_dual_f_retreat,
                                                                            hidden_units=units_dual_f_retreat,
                                                                            training_examples=training_examples,
                                                                            training_targets=training_targets[train_col_names_1],
                                                                            validation_examples=validation_examples,
                                                                            validation_targets=validation_targets[train_col_names_1],
                                                                            model_dir=dir_path_dual_f_retreat+"/cluster"+repr(i)+"/nn")
                ...
                if (len(cl_out_dual_f_retreat_df.columns) > 10):
                    ...
                    denorm_test_predictions_df = denormalize_linear_scale(test_proj_df, outputs_dual_f_retreat_df_max, outputs_dual_f_retreat_df_min)
                else:
                ...
                denorm_test_targets = denormalize_linear_scale(test_targets, outputs_dual_f_retreat_df_max, outputs_dual_f_retreat_df_min)
                ...
                res_file = open(dir_path_dual_f_retreat+"/cluster"+repr(i)+"/nn/results.txt", "a")
                res_file.write("RMSE (on test data):   %0.3f\n" % test_root_mean_squared_error_proj)
                res_file.write("R^2 score (on projected test data): %0.3f\n" % r2score)
                res_file.close()
                ...
                fig = plt.figure()
                ax1 = fig.add_subplot(111)
                ax1.scatter(test_examples["target_x_mm"], denorm_test_targets["dual_f_retreat_1"], s=10, c='b', marker="s",label='test_targets')
                ax1.scatter(test_examples["target_x_mm"], denorm_test_predictions_df["dual_f_retreat_1"], s=10, c='r', marker="o", label='test_predictions')
                plt.xlabel("target_x_mm")
                plt.ylabel("dual_f_retreat_1")
                plt.legend(loc='upper right')
                plt.savefig(dir_path_dual_f_retreat+"/cluster"+repr(i)+"/nn/dual_f_retreat_pred.pdf")
                plt.clf()
                #plt.show()
                ...
                if (ldim!=0):
                    # ---------- Support Vector Machine ---------------- #
                    (svm_regressor, r2) = train_svm_regressor_model(kernel=kernel_dual_f_retreat,
                                                                    gamma=gamma_dual_f_retreat,
                                                                    coeff=coeff_dual_f_retreat,
                                                                    degree=degree_dual_f_retreat,
                                                                    epsilon=epsilon_dual_f_retreat,
                                                                    training_examples=training_examples,
                                                                    training_targets=training_targets.iloc[:,0:ldim],
                                                                    model_dir=dir_path_dual_f_retreat + "/cluster"+repr(i)+"/svm")
                ...
                res_file = open(dir_path_dual_f_retreat + "/cluster"+repr(i)+"/svm/results.txt", "a")
                res_file.write("Final RMSE (on projected test data): %0.3f\n" % test_root_mean_squared_error_proj)
                res_file.write("R^2 score (on projected test data): %0.3f\n" % r2score)
                res_file.close()
                ...
                plt.ylabel("dual_f_retreat_1")
                plt.legend(loc='upper right')
                plt.savefig(dir_path_dual_f_retreat+"/cluster"+repr(i)+"/svm/dual_f_retreat_pred.pdf")
                plt.clf()
                #plt.show()
                ...
                if (ldim!=0):
                    # ---------- K-Nearest Neighbors ---------------- #
                    (knn_regressor, r2) = train_knn_regressor_model(n_neighbors = n_neighbors_dual_f_retreat,
                                                                weights = weights_dual_f_retreat,
                                                                algorithm = algorithm_dual_f_retreat,
                                                                training_examples=training_examples,
                                                                training_targets=training_targets.iloc[:,0:ldim],
                                                                model_dir=dir_path_dual_f_retreat + "/cluster"+repr(i)+"/knn")
                ...
                res_file = open(dir_path_dual_f_retreat + "/cluster"+repr(i)+"/knn/results.txt", "a")
                res_file.write("Final RMSE (on projected test data): %0.3f\n" % test_root_mean_squared_error_proj)
                res_file.write("R^2 score (on projected test data): %0.3f\n" % r2score)
                res_file.close()
                ...
                plt.ylabel("dual_f_retreat_1")
                plt.legend(loc='upper right')
                plt.savefig(dir_path_dual_f_retreat+"/cluster"+repr(i)+"/knn/dual_f_retreat_pred.pdf")
                plt.clf()
                #plt.show()
...
if not outputs_zb_L_df.empty:
    ...
    # Getting the cluster centers
    C_zb_L = kmeans_zb_L.cluster_centers_
    if (print_en_zb_L):
        fig = plt.figure()
        ax_zb_L = fig.add_subplot(111)
        ax_zb_L.scatter(normalized_inputs["target_x_mm"],zb_L[:,0], s=10, c=labels_zb_L, marker="s")
        ax_zb_L.set_xlabel("target_x_mm")
        ax_zb_L.set_ylabel("zb_L_4")
            ...
            if (len(cl_out_dual_bounce_df.index) > min_cluster_size_dual_bounce):
                if (len(cl_out_dual_bounce_df.columns) > 10):
                    ...
                    if (print_en_dual_bounce):
                        ...
                        threedee_train = plt.figure().gca(projection='3d')
                        threedee_train.scatter(cl_in_dual_bounce_df["target_x_mm"], cl_in_dual_bounce_df["target_y_mm"], pc_df['dual_bounce_1'])
                        plt.clf()
                        #plt.show()
                else:
                ...
                fig = plt.figure()
                ax1 = fig.add_subplot(111)
                ax1.scatter(denorm_test_targets["dual_bounce_0"], denorm_test_targets["dual_bounce_1"], s=10, c='b', marker="s", label='test_targets')
                ax1.scatter(denorm_test_predictions_df["dual_bounce_0"], denorm_test_predictions_df["dual_bounce_1"], s=10, c='r', marker="o", label='test_predictions')
                plt.xlabel("dual_bounce_0")
                plt.ylabel("dual_bounce_1")
                plt.legend(loc='upper right')
