...
predictor = data_pred[0] # 0=Random, 1=Neural Network, 2=Support Vectors Machine, 3=K-Nearest Neighbors
rdm_predictor = predictor==0
nn_predictor = predictor==1
svm_predictor = predictor==2
knn_predictor = predictor==3

# Target info
#target_x = float(data_pred[1])
#target_y = float(data_pred[2])
#target_z = float(data_pred[3])
#target_roll = float(data_pred[4])
#target_pitch = float(data_pred[5])
#target_yaw = float(data_pred[6])
# Obstacle 1 info
#obstacle_1_x = float(data_pred[7])
#obstacle_1_y = float(data_pred[8])
#obstacle_1_z = float(data_pred[9])
#obstacle_1_roll = float(data_pred[10])
#obstacle_1_pitch = float(data_pred[11])
#obstacle_1_yaw = float(data_pred[12])
# and so on ...
